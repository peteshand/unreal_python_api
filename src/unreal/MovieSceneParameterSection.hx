...
@:pythonImport("unreal", "MovieSceneParameterSection") extern class MovieSceneParameterSection extends unreal.MovieSceneSection {
	/**
		...
		Args:
		    ...
		    value (bool):
	**/
	public function add_bool_parameter_key(parameter_name:unreal.Name, time:unreal.FrameNumber, value:Bool):Void;
	/**
		...
		Args:
		    ...
		    value (LinearColor):
	**/
	public function add_color_parameter_key(parameter_name:unreal.Name, time:unreal.FrameNumber, value:unreal.LinearColor):Void;
	/**
		...
		Args:
		    ...
		    value (float):
	**/
	public function add_scalar_parameter_key(parameter_name:unreal.Name, time:unreal.FrameNumber, value:Float):Void;
	/**
		...
		Args:
		    ...
		    value (Transform):
	**/
	public function add_transform_parameter_key(parameter_name:unreal.Name, time:unreal.FrameNumber, value:unreal.Transform):Void;
	/**
		...
		Args:
		    ...
		    value (Vector2D):
	**/
	public function add_vector2d_parameter_key(parameter_name:unreal.Name, time:unreal.FrameNumber, value:unreal.Vector2D):Void;
	/**
		...
		Args:
		    ...
		    value (Vector):
	**/
	public function add_vector_parameter_key(parameter_name:unreal.Name, time:unreal.FrameNumber, value:unreal.Vector):Void;
	/**
	...
	**/
	public function remove_bool_parameter(parameter_name:unreal.Name):Bool;
	/**
		...
		Returns:
		    bool: True if a parameter with that name was found and removed, otherwise false.
	**/
	public function remove_color_parameter(parameter_name:unreal.Name):Bool;
	/**
		...
		Returns:
		    bool: True if a parameter with that name was found and removed, otherwise false.
	**/
	public function remove_scalar_parameter(parameter_name:unreal.Name):Bool;
	/**
		...
		Returns:
		    bool: True if a parameter with that name was found and removed, otherwise false.
	**/
	public function remove_transform_parameter(parameter_name:unreal.Name):Bool;
	/**
		...
		Returns:
		    bool: True if a parameter with that name was found and removed, otherwise false.
	**/
	public function remove_vector2d_parameter(parameter_name:unreal.Name):Bool;
	/**
		...
		Returns:
		    bool: True if a parameter with that name was found and removed, otherwise false.
	**/
	public function remove_vector_parameter(parameter_name:unreal.Name):Bool;
}