...
@:pythonImport("unreal", "FunctionalTest") extern class FunctionalTest extends unreal.Actor {
	...
	**/
	...
	/**
		...
		Args:
		    message (str):
	**/
	public function add_error(message:Dynamic):Void;
	/**
		...
		Args:
		    reason (Name):
	**/
	public function add_rerun(reason:Dynamic):Void;
	/**
		...
		Args:
		    message (str):
	**/
	public function add_warning(message:Dynamic):Void;
	/**
		...
		Returns:
		    bool:
	**/
	public function assert_equal_bool(actual:Dynamic, expected:Dynamic, what:Dynamic, context_object:Dynamic):Bool;
	/**
		...
		Returns:
		    bool:
	**/
	public function assert_equal_float(actual:Dynamic, expected:Dynamic, what:Dynamic, tolerance:Dynamic, context_object:Dynamic):Bool;
	/**
		...
		Returns:
		    bool:
	**/
	public function assert_equal_int(actual:Dynamic, expected:Dynamic, what:Dynamic, context_object:Dynamic):Bool;
	/**
		...
		Returns:
		    bool:
	**/
	public function assert_equal_name(actual:Dynamic, expected:Dynamic, what:Dynamic, context_object:Dynamic):Bool;
	/**
		...
		Returns:
		    bool:
	**/
	public function assert_equal_object(actual:Dynamic, expected:Dynamic, what:Dynamic, context_object:Dynamic):Bool;
	/**
		...
		Returns:
		    bool:
	**/
	public function assert_equal_rotator(actual:Dynamic, expected:Dynamic, what:Dynamic, tolerance:Dynamic, context_object:Dynamic):Bool;
	/**
		...
		Returns:
		    bool:
	**/
	public function assert_equal_string(actual:Dynamic, expected:Dynamic, what:Dynamic, context_object:Dynamic):Bool;
	/**
		...
		Returns:
		    bool:
	**/
	public function assert_equal_trace_query_results(actual:Dynamic, expected:Dynamic, what:Dynamic, context_object:Dynamic):Bool;
	/**
		...
		Returns:
		    bool:
	**/
	public function assert_equal_transform(actual:Dynamic, expected:Dynamic, what:Dynamic, tolerance:Dynamic, context_object:Dynamic):Bool;
	/**
		...
		Returns:
		    bool:
	**/
	public function assert_equal_vector(actual:Dynamic, expected:Dynamic, what:Dynamic, tolerance:Dynamic, context_object:Dynamic):Bool;
	/**
		...
		Returns:
		    bool:
	**/
	public function assert_false(condition:Dynamic, message:Dynamic, context_object:Dynamic):Bool;
	/**
		...
		Returns:
		    bool:
	**/
	public function assert_is_valid(object:Dynamic, message:Dynamic, context_object:Dynamic):Bool;
	/**
		...
		Returns:
		    bool:
	**/
	public function assert_not_equal_rotator(actual:Dynamic, not_expected:Dynamic, what:Dynamic, context_object:Dynamic):Bool;
	/**
		...
		Returns:
		    bool:
	**/
	public function assert_not_equal_string(actual:Dynamic, not_expected:Dynamic, what:Dynamic, context_object:Dynamic):Bool;
	/**
		...
		Returns:
		    bool:
	**/
	public function assert_not_equal_transform(actual:Dynamic, not_expected:Dynamic, what:Dynamic, context_object:Dynamic):Bool;
	/**
		...
		Returns:
		    bool:
	**/
	public function assert_not_equal_vector(actual:Dynamic, not_expected:Dynamic, what:Dynamic, context_object:Dynamic):Bool;
	/**
		...
		Returns:
		    bool:
	**/
	public function assert_true(condition:Dynamic, message:Dynamic, context_object:Dynamic):Bool;
	/**
		...
		Returns:
		    bool:
	**/
	public function assert_value_date_time(actual:Dynamic, should_be:Dynamic, expected:Dynamic, what:Dynamic, context_object:Dynamic):Bool;
	/**
		...
		Returns:
		    bool:
	**/
	public function assert_value_float(actual:Dynamic, should_be:Dynamic, expected:Dynamic, what:Dynamic, context_object:Dynamic):Bool;
	/**
		...
		Returns:
		    bool:
	**/
	public function assert_value_int(actual:Dynamic, should_be:Dynamic, expected:Dynamic, what:Dynamic, context_object:Dynamic):Bool;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    Array(Actor):
	**/
	public function debug_gather_relevant_actors():Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Args:
		    ...
		    message (str):
	**/
	public function finish_test(test_result:Dynamic, message:Dynamic):Void;
	/**
	...
	**/
	...
	/**
		...
		Args:
		    message (str):
	**/
	public function log_message(message:Dynamic):Void;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    str:
	**/
	public function on_additional_test_finished_message_request(test_result:Dynamic):String;
	/**
	...
	**/
	public function register_auto_destroy_actor(actor_to_auto_destroy:Dynamic):Void;
	/**
	...
	**/
	public function set_time_limit(new_time_limit:Dynamic, result_when_time_runs_out:Dynamic):Void;
	/**
