	...
	**/
	...
	/**
		...
		Returns:
		    bool:
	**/
	public function assert_equal_float(actual:Float, expected:Float, what:String, tolerance:Float, context_object:unreal.Object):Bool;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    bool:
	**/
	public function assert_equal_rotator(actual:unreal.Rotator, expected:unreal.Rotator, what:String, tolerance:Float, context_object:unreal.Object):Bool;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    bool:
	**/
	public function assert_equal_transform(actual:unreal.Transform, expected:unreal.Transform, what:String, tolerance:Float, context_object:unreal.Object):Bool;
	/**
		...
		Returns:
		    bool:
	**/
	public function assert_equal_vector(actual:unreal.Vector, expected:unreal.Vector, what:String, tolerance:Float, context_object:unreal.Object):Bool;
	/**
