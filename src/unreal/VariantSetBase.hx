	...
	**/
	...
	/**
		...
		Args:
		    variant (Variant):
	**/
	public function add_variant(variant:unreal.Variant):Void;
	/**
	...
	**/
	...
	/**
		...
		Args:
		    variant (Variant):
	**/
	public function remove_variant(variant:unreal.Variant):Void;
	/**
		...
		Args:
		    variant_name (str):
	**/
	public function remove_variant_by_name(variant_name:String):Void;
	/**
