...
@:pythonImport("unreal", "PawnActionsComponent") extern class PawnActionsComponent extends unreal.ActorComponent {
	...
	**/
	public function abort_action(action_to_abort:Dynamic):unreal.PawnActionAbortState;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    PawnActionAbortState:
	**/
	public function force_abort_action(action_to_abort:Dynamic):unreal.PawnActionAbortState;
	/**
		...
		Returns:
		    bool:
	**/
	static public function perform_action(pawn:Dynamic, action:Dynamic, priority:Dynamic):Bool;
	/**
		...
		Returns:
		    bool:
	**/
	public function push_action(new_action:Dynamic, priority:Dynamic, instigator:Dynamic):Bool;
}