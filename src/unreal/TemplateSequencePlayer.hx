...
@:pythonImport("unreal", "TemplateSequencePlayer") extern class TemplateSequencePlayer extends unreal.MovieSceneSequencePlayer {
	...
	**/
	static public function create_template_sequence_player(world_context_object:Dynamic, template_sequence:Dynamic, settings:Dynamic):unreal.TemplateSequenceActor;
}