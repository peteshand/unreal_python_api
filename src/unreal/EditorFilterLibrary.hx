...
@:pythonImport("unreal", "EditorFilterLibrary") extern class EditorFilterLibrary extends unreal.BlueprintFunctionLibrary {
	...
	**/
	static public function by_actor_label(target_array:Array<Actor>, name_sub_string:String, ?string_match:unreal.EditorScriptingStringMatchType,
		?filter_type:unreal.EditorScriptingFilterType, ignore_case:Bool = true):Array<Actor>;
	...
	**/
	...
	/**
		...
		Returns:
			Array(Object): The filtered list.
	**/
	static public function by_id_name(target_array:Array<Object>, name_sub_string:String, ?string_match:unreal.EditorScriptingStringMatchType,
		?filter_type:unreal.EditorScriptingFilterType):Array<Object>;
