...
@:pythonImport("unreal", "MathLibrary") extern class MathLibrary extends unreal.BlueprintFunctionLibrary {
	...
	**/
	...
	/**
		...
		Returns:
		    float:
	**/
	static public function abs(a:Dynamic):Float;
	/**
		X.abs_int(a) -> int32
		Returns the absolute (positive) value of A
		...
		Returns:
		    int32:
	**/
	static public function abs_int(a:Dynamic):Int;
	/**
		X.abs_int64(a) -> int64
		Returns the absolute (positive) value of A
	...
	**/
	...
	/**
		...
		Returns:
		    float:
	**/
	static public function acos(a:Dynamic):Float;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    DateTime:
	**/
	static public function add_date_time_date_time(a:Dynamic, b:Dynamic):unreal.DateTime;
	/**
		...
		Returns:
		    DateTime:
	**/
	static public function add_date_time_timespan(a:Dynamic, b:Dynamic):unreal.DateTime;
	/**
		...
		Returns:
		    float:
	**/
	static public function add_float_float(a:Dynamic, b:Dynamic):Float;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    int32:
	**/
	static public function add_int_int(a:Dynamic, b:Dynamic):Int;
	/**
		...
		Returns:
		    IntPoint:
	**/
	static public function add_int_point_int(a:Dynamic, b:Dynamic):unreal.IntPoint;
	/**
		...
		Returns:
		    IntPoint:
	**/
	static public function add_int_point_int_point(a:Dynamic, b:Dynamic):unreal.IntPoint;
	/**
		...
		Returns:
		    LinearColor:
	**/
	static public function add_linear_color_linear_color(a:Dynamic, b:Dynamic):unreal.LinearColor;
	/**
	...
	**/
	static public function add_matrix_matrix(a:Dynamic, b:Dynamic):unreal.Matrix;
	/**
		...
		Returns:
		    Quat:
	**/
	static public function add_quat_quat(a:Dynamic, b:Dynamic):unreal.Quat;
	/**
		...
		Returns:
		    Timespan:
	**/
	static public function add_timespan_timespan(a:Dynamic, b:Dynamic):unreal.Timespan;
	/**
		...
		Returns:
		    Vector2D:
	**/
	static public function add_vector2d_float(a:Dynamic, b:Dynamic):unreal.Vector2D;
	/**
		...
		Returns:
		    Vector2D:
	**/
	static public function add_vector2d_vector2d(a:Dynamic, b:Dynamic):unreal.Vector2D;
	/**
		...
		Returns:
		    Vector4:
	**/
	static public function add_vector4_vector4(a:Dynamic, b:Dynamic):unreal.Vector4;
	/**
		...
		Returns:
		    Vector:
	**/
	static public function add_vector_float(a:Dynamic, b:Dynamic):unreal.Vector;
	/**
		...
		Returns:
		    Vector:
	**/
	static public function add_vector_int(a:Dynamic, b:Dynamic):unreal.Vector;
	/**
		...
		Returns:
		    Vector:
	**/
	static public function add_vector_vector(a:Dynamic, b:Dynamic):unreal.Vector;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    int32:
	**/
	static public function and_int_int(a:Dynamic, b:Dynamic):Int;
	/**
		X.asin(a) -> float
		...
		Returns:
		    float:
	**/
	static public function asin(a:Dynamic):Float;
	/**
		X.atan(a) -> float
		...
		Returns:
		    float:
	**/
	static public function atan(a:Dynamic):Float;
	/**
		X.atan2(y, x) -> float
		...
		Returns:
		    float:
	**/
	static public function atan2(y:Dynamic, x:Dynamic):Float;
	/**
		X.b_max(a, b) -> uint8
	...
	**/
	...
	/**
		...
		Returns:
		    bool:
	**/
	static public function boolean_and(a:Dynamic, b:Dynamic):Bool;
	/**
		...
		Returns:
		    bool:
	**/
	static public function boolean_nand(a:Dynamic, b:Dynamic):Bool;
	/**
		...
		Returns:
		    bool:
	**/
	static public function boolean_nor(a:Dynamic, b:Dynamic):Bool;
	/**
		...
		Returns:
		    bool:
	**/
	static public function boolean_or(a:Dynamic, b:Dynamic):Bool;
	/**
		...
		Returns:
		    bool:
	**/
	static public function boolean_xor(a:Dynamic, b:Dynamic):Bool;
	/**
		...
		Returns:
		    ...
		    a (float):
	**/
	static public function break_color(color:Dynamic):python.Tuple<Dynamic>;
	/**
		...
		Returns:
		    ...
		    z (Vector):
	**/
	static public function break_rot_into_axes(rot:Dynamic):python.Tuple<Dynamic>;
	/**
	...
	**/
	static public function c_interp_to(current:Dynamic, target:Dynamic, delta_time:Dynamic, interp_speed:Dynamic):unreal.LinearColor;
	/**
		...
		Returns:
		    int32:
	**/
	static public function clamp(value:Dynamic, min:Dynamic, max:Dynamic):Int;
	/**
	...
	**/
	static public function clamp_angle(angle_degrees:Dynamic, min_angle_degrees:Dynamic, max_angle_degrees:Dynamic):Float;
	/**
	...
	**/
	static public function clamp_axes2d(a:Dynamic, min_axis_val:Dynamic, max_axis_val:Dynamic):unreal.Vector2D;
	/**
	...
	**/
	static public function clamp_axis(angle:Dynamic):Float;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    Vector:
	**/
	static public function clamp_vector_size(a:Dynamic, min:Dynamic, max:Dynamic):unreal.Vector;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    Rotator:
	**/
	static public function compose_rotators(a:Dynamic, b:Dynamic):unreal.Rotator;
	/**
	...
	**/
	static public function compose_transforms(a:Dynamic, b:Dynamic):unreal.Transform;
	/**
		...
		Returns:
		    uint8:
	**/
	static public function conv_bool_to_byte(bool:Dynamic):Dynamic;
	/**
		...
		Returns:
		    float:
	**/
	static public function conv_bool_to_float(bool:Dynamic):Float;
	/**
		...
		Returns:
		    int32:
	**/
	static public function conv_bool_to_int(bool:Dynamic):Int;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    LinearColor:
	**/
	static public function conv_color_to_linear_color(color:Dynamic):unreal.LinearColor;
	/**
		...
		Returns:
		    LinearColor:
	**/
	static public function conv_float_to_linear_color(float:Dynamic):unreal.LinearColor;
	/**
		...
		Returns:
		    Vector:
	**/
	static public function conv_float_to_vector(float:Dynamic):unreal.Vector;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    Vector2D:
	**/
	static public function conv_int_point_to_vector2d(int_point:Dynamic):unreal.Vector2D;
	/**
		...
		Returns:
		    bool:
	**/
	static public function conv_int_to_bool(int:Dynamic):Bool;
	/**
		...
		Returns:
		    uint8:
	**/
	static public function conv_int_to_byte(int:Dynamic):Dynamic;
	/**
		...
		Returns:
		    float:
	**/
	static public function conv_int_to_float(int:Dynamic):Float;
	/**
		...
		Returns:
		    int64:
	**/
	static public function conv_int_to_int64(int:Dynamic):Dynamic;
	/**
		...
		Returns:
		    IntVector:
	**/
	static public function conv_int_to_int_vector(int:Dynamic):unreal.IntVector;
	/**
		...
		Returns:
		    Vector:
	**/
	static public function conv_int_vector_to_vector(int_vector:Dynamic):unreal.Vector;
	/**
		...
		Returns:
		    Color:
	**/
	static public function conv_linear_color_to_color(linear_color:Dynamic, use_srgb:Dynamic):unreal.Color;
	/**
		...
		Returns:
		    Vector:
	**/
	static public function conv_linear_color_to_vector(linear_color:Dynamic):unreal.Vector;
	/**
		...
		Returns:
		    Rotator:
	**/
	static public function conv_matrix_to_rotator(matrix:Dynamic):unreal.Rotator;
	/**
		...
		Returns:
		    Transform:
	**/
	static public function conv_matrix_to_transform(matrix:Dynamic):unreal.Transform;
	/**
		...
		Returns:
		    Transform:
	**/
	static public function conv_rotator_to_transform(rotator:Dynamic):unreal.Transform;
	/**
		...
		Returns:
		    Vector:
	**/
	static public function conv_rotator_to_vector(rot:Dynamic):unreal.Vector;
	/**
		...
		Returns:
		    Matrix:
	**/
	static public function conv_transform_to_matrix(transform:Dynamic):unreal.Matrix;
	/**
		...
		Returns:
		    IntPoint:
	**/
	static public function conv_vector2d_to_int_point(vector2d:Dynamic):unreal.IntPoint;
	/**
		...
		Returns:
		    Vector:
	**/
	static public function conv_vector2d_to_vector(vector2d:Dynamic, z:Dynamic):unreal.Vector;
	/**
	...
	**/
	static public function conv_vector4_to_quaternion(vec:Dynamic):unreal.Quat;
	/**
	...
	**/
	static public function conv_vector4_to_rotator(vec:Dynamic):unreal.Rotator;
	/**
		...
		Returns:
		    Vector:
	**/
	static public function conv_vector4_to_vector(vector4:Dynamic):unreal.Vector;
	/**
		...
		Returns:
		    LinearColor:
	**/
	static public function conv_vector_to_linear_color(vec:Dynamic):unreal.LinearColor;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    Quat: Quaternion from the Vector's direction, without any roll.
	**/
	static public function conv_vector_to_quaternion(vec:Dynamic):unreal.Quat;
	/**
		...
		Returns:
		    Rotator: FRotator from the Vector's direction, without any roll.
	**/
	static public function conv_vector_to_rotator(vec:Dynamic):unreal.Rotator;
	/**
		...
		Returns:
		    Transform:
	**/
	static public function conv_vector_to_transform(location:Dynamic):unreal.Transform;
	/**
		...
		Returns:
		    Vector2D:
	**/
	static public function conv_vector_to_vector2d(vector:Dynamic):unreal.Vector2D;
	/**
		...
		Returns:
		    Transform:
	**/
	static public function convert_transform_to_relative(transform:Dynamic, parent_transform:Dynamic):unreal.Transform;
	/**
		X.cos(a) -> float
		...
		Returns:
		    float:
	**/
	static public function cos(a:Dynamic):Float;
	/**
		...
		Returns:
		    Vector:
	**/
	static public function create_vector_from_yaw_pitch(yaw:Dynamic, pitch:Dynamic, length:Dynamic):unreal.Vector;
	/**
		...
		Returns:
		    float:
	**/
	static public function cross_product2d(a:Dynamic, b:Dynamic):Float;
	/**
		...
		Returns:
		    Vector:
	**/
	static public function cross_vector_vector(a:Dynamic, b:Dynamic):unreal.Vector;
	/**
		...
		Returns:
		    ...
		    result (DateTime):
	**/
	static public function date_time_from_iso_string(iso_string:Dynamic):Dynamic;
	/**
		...
		Returns:
		    ...
		    result (DateTime):
	**/
	static public function date_time_from_string(date_time_string:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    int32:
	**/
	static public function days_in_month(year:Dynamic, month:Dynamic):Int;
	/**
		...
		Returns:
		    int32:
	**/
	static public function days_in_year(year:Dynamic):Int;
	/**
		X.deg_acos(a) -> float
		...
		Returns:
		    float:
	**/
	static public function deg_acos(a:Dynamic):Float;
	/**
		X.deg_asin(a) -> float
		...
		Returns:
		    float:
	**/
	static public function deg_asin(a:Dynamic):Float;
	/**
		X.deg_atan(a) -> float
		...
		Returns:
		    float:
	**/
	static public function deg_atan(a:Dynamic):Float;
	/**
		...
		Returns:
		    float:
	**/
	static public function deg_atan2(y:Dynamic, x:Dynamic):Float;
	/**
		X.deg_cos(a) -> float
		...
		Returns:
		    float:
	**/
	static public function deg_cos(a:Dynamic):Float;
	/**
		X.deg_sin(a) -> float
		...
		Returns:
		    float:
	**/
	static public function deg_sin(a:Dynamic):Float;
	/**
		X.deg_tan(a) -> float
		...
		Returns:
		    float:
	**/
	static public function deg_tan(a:Dynamic):Float;
	/**
		...
		Returns:
		    float:
	**/
	static public function degrees_to_radians(a:Dynamic):Float;
	/**
	...
	**/
	static public function distance2d(v1:Dynamic, v2:Dynamic):Float;
	/**
	...
	**/
	static public function distance_squared2d(v1:Dynamic, v2:Dynamic):Float;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    int32:
	**/
	static public function divide_int_int(a:Dynamic, b:Dynamic):Int;
	/**
		...
		Returns:
		    IntPoint:
	**/
	static public function divide_int_point_int(a:Dynamic, b:Dynamic):unreal.IntPoint;
	/**
		...
		Returns:
		    IntPoint:
	**/
	static public function divide_int_point_int_point(a:Dynamic, b:Dynamic):unreal.IntPoint;
	/**
		...
		Returns:
		    LinearColor:
	**/
	static public function divide_linear_color_linear_color(a:Dynamic, b:Dynamic):unreal.LinearColor;
	/**
		...
		Returns:
		    Timespan:
	**/
	static public function divide_timespan_float(a:Dynamic, scalar:Dynamic):unreal.Timespan;
	/**
		...
		Returns:
		    Vector2D:
	**/
	static public function divide_vector2d_float(a:Dynamic, b:Dynamic):unreal.Vector2D;
	/**
		...
		Returns:
		    Vector2D:
	**/
	static public function divide_vector2d_vector2d(a:Dynamic, b:Dynamic):unreal.Vector2D;
	/**
		...
		Returns:
		    Vector4:
	**/
	static public function divide_vector4_vector4(a:Dynamic, b:Dynamic):unreal.Vector4;
	/**
		...
		Returns:
		    Vector:
	**/
	static public function divide_vector_float(a:Dynamic, b:Dynamic):unreal.Vector;
	/**
		...
		Returns:
		    Vector:
	**/
	static public function divide_vector_int(a:Dynamic, b:Dynamic):unreal.Vector;
	/**
		...
		Returns:
		    Vector:
	**/
	static public function divide_vector_vector(a:Dynamic, b:Dynamic):unreal.Vector;
	/**
		...
		Returns:
		    float:
	**/
	static public function dot_product2d(a:Dynamic, b:Dynamic):Float;
	/**
		...
		Returns:
		    float:
	**/
	static public function dot_vector_vector(a:Dynamic, b:Dynamic):Float;
	/**
	...
	**/
	static public function dynamic_weighted_moving_average_f_rotator(current_sample:Dynamic, previous_sample:Dynamic, max_distance:Dynamic, min_weight:Dynamic, max_weight:Dynamic):unreal.Rotator;
	/**
	...
	**/
	static public function dynamic_weighted_moving_average_f_vector(current_sample:Dynamic, previous_sample:Dynamic, max_distance:Dynamic, min_weight:Dynamic, max_weight:Dynamic):unreal.Vector;
	/**
	...
	**/
	static public function dynamic_weighted_moving_average_float(current_sample:Dynamic, previous_sample:Dynamic, max_distance:Dynamic, min_weight:Dynamic, max_weight:Dynamic):Float;
	/**
		...
		Returns:
		    bool:
	**/
	static public function equal_equal_bool_bool(a:Dynamic, b:Dynamic):Bool;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    bool:
	**/
	static public function equal_equal_date_time_date_time(a:Dynamic, b:Dynamic):Bool;
	/**
		...
		Returns:
		    bool:
	**/
	static public function equal_equal_float_float(a:Dynamic, b:Dynamic):Bool;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    bool:
	**/
	static public function equal_equal_int_int(a:Dynamic, b:Dynamic):Bool;
	/**
		...
		Returns:
		    bool:
	**/
	static public function equal_equal_linear_color_linear_color(a:Dynamic, b:Dynamic):Bool;
	/**
	...
	**/
	static public function equal_equal_matrix_matrix(a:Dynamic, b:Dynamic, tolerance:Dynamic):Bool;
	/**
		...
		Returns:
		    bool:
	**/
	static public function equal_equal_name_name(a:Dynamic, b:Dynamic):Bool;
	/**
		...
		Returns:
		    bool:
	**/
	static public function equal_equal_object_object(a:Dynamic, b:Dynamic):Bool;
	/**
		...
		Returns:
		    bool:
	**/
	static public function equal_equal_quat_quat(a:Dynamic, b:Dynamic, tolerance:Dynamic):Bool;
	/**
		...
		Returns:
		    bool:
	**/
	static public function equal_equal_rotator_rotator(a:Dynamic, b:Dynamic, error_tolerance:Dynamic):Bool;
	/**
		...
		Returns:
		    bool:
	**/
	static public function equal_equal_timespan_timespan(a:Dynamic, b:Dynamic):Bool;
	/**
		...
		Returns:
		    bool:
	**/
	static public function equal_equal_transform_transform(a:Dynamic, b:Dynamic):Bool;
	/**
		...
		Returns:
		    bool:
	**/
	static public function equal_equal_vector2d_vector2d(a:Dynamic, b:Dynamic, error_tolerance:Dynamic):Bool;
	/**
		...
		Returns:
		    bool:
	**/
	static public function equal_equal_vector4_vector4(a:Dynamic, b:Dynamic, error_tolerance:Dynamic):Bool;
	/**
		...
		Returns:
		    bool:
	**/
	static public function equal_equal_vector_vector(a:Dynamic, b:Dynamic, error_tolerance:Dynamic):Bool;
	/**
		...
		Returns:
		    bool:
	**/
	static public function equal_exactly_vector2d_vector2d(a:Dynamic, b:Dynamic):Bool;
	/**
		...
		Returns:
		    bool:
	**/
	static public function equal_exactly_vector4_vector4(a:Dynamic, b:Dynamic):Bool;
	/**
		...
		Returns:
		    bool:
	**/
	static public function equal_exactly_vector_vector(a:Dynamic, b:Dynamic):Bool;
	/**
		...
		Returns:
		    bool:
	**/
	static public function equal_int_point_int_point(a:Dynamic, b:Dynamic):Bool;
	/**
		X.exp(a) -> float
		...
		Returns:
		    float:
	**/
	static public function exp(a:Dynamic):Float;
	/**
		X.f_ceil(a) -> int32
		...
		Returns:
		    int32:
	**/
	static public function f_ceil(a:Dynamic):Int;
	/**
		X.f_ceil64(a) -> int64
		Rounds A up towards positive infinity / up to the next integer (e.g., -1.6 becomes -1 and 1.6 becomes 2)
		...
		Returns:
		    int64:
	**/
	static public function f_ceil64(a:Dynamic):Dynamic;
	/**
		...
		Returns:
		    float:
	**/
	static public function f_clamp(value:Dynamic, min:Dynamic, max:Dynamic):Float;
	/**
		X.f_floor(a) -> int32
		...
		Returns:
		    int32:
	**/
	static public function f_floor(a:Dynamic):Int;
	/**
		X.f_floor64(a) -> int64
		Rounds A down towards negative infinity / down to the previous integer (e.g., -1.6 becomes -2 and 1.6 becomes 1)
		...
		Returns:
		    int64:
	**/
	static public function f_floor64(a:Dynamic):Dynamic;
	/**
		...
		Returns:
		    float:
	**/
	static public function f_interp_ease_in_out(a:Dynamic, b:Dynamic, alpha:Dynamic, exponent:Dynamic):Float;
	/**
	...
	**/
	static public function f_interp_to(current:Dynamic, target:Dynamic, delta_time:Dynamic, interp_speed:Dynamic):Float;
	/**
		...
		Returns:
		    float: New interpolated position
	**/
	static public function f_interp_to_constant(current:Dynamic, target:Dynamic, delta_time:Dynamic, interp_speed:Dynamic):Float;
	/**
		X.f_max(a, b) -> float
		Returns the maximum value of A and B
		...
		Returns:
		    float:
	**/
	static public function f_max(a:Dynamic, b:Dynamic):Float;
	/**
		X.f_min(a, b) -> float
		Returns the minimum value of A and B
		...
		Returns:
		    float:
	**/
	static public function f_min(a:Dynamic, b:Dynamic):Float;
	/**
		...
		Returns:
		    ...
		    remainder (float):
	**/
	static public function f_mod(dividend:Dynamic, divisor:Dynamic):Float;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    int32:
	**/
	static public function f_trunc(a:Dynamic):Int;
	/**
		X.f_trunc64(a) -> int64
		Rounds A towards zero, truncating the fractional part (e.g., -1.6 becomes -1 and 1.6 becomes 1)
		...
		Returns:
		    int64:
	**/
	static public function f_trunc64(a:Dynamic):Dynamic;
	/**
		...
		Returns:
		    IntVector:
	**/
	static public function f_trunc_vector(vector:Dynamic):unreal.IntVector;
	/**
		...
		Returns:
		    float:
	**/
	static public function f_wrap(value:Dynamic, min:Dynamic, max:Dynamic):Float;
	/**
	...
	**/
	static public function find_closest_point_on_line(point:Dynamic, line_origin:Dynamic, line_direction:Dynamic):unreal.Vector;
	/**
	...
	**/
	static public function find_closest_point_on_segment(point:Dynamic, segment_start:Dynamic, segment_end:Dynamic):unreal.Vector;
	/**
		...
		Returns:
		    Rotator:
	**/
	static public function find_look_at_rotation(start:Dynamic, target:Dynamic):unreal.Rotator;
	/**
	...
	**/
	static public function find_nearest_points_on_line_segments(segment1_start:Dynamic, segment1_end:Dynamic, segment2_start:Dynamic, segment2_end:Dynamic):python.Tuple<Dynamic>;
	/**
	...
	**/
	static public function fixed_turn(current:Dynamic, desired:Dynamic, delta_rate:Dynamic):Float;
	/**
	...
	**/
	static public function float_spring_interp(current:Dynamic, target:Dynamic, spring_state:Dynamic, stiffness:Dynamic, critical_damping_factor:Dynamic, delta_time:Dynamic, mass:Dynamic):unreal.FloatSpringState;
	/**
		X.fraction(a) -> float
		...
		Returns:
		    float:
	**/
	static public function fraction(a:Dynamic):Float;
	/**
		...
		Returns:
		    Timespan:
	**/
	static public function from_days(days:Dynamic):unreal.Timespan;
	/**
		...
		Returns:
		    Timespan:
	**/
	static public function from_hours(hours:Dynamic):unreal.Timespan;
	/**
		...
		Returns:
		    Timespan:
	**/
	static public function from_milliseconds(milliseconds:Dynamic):unreal.Timespan;
	/**
		...
		Returns:
		    Timespan:
	**/
	static public function from_minutes(minutes:Dynamic):unreal.Timespan;
	/**
		...
		Returns:
		    Timespan:
	**/
	static public function from_seconds(seconds:Dynamic):unreal.Timespan;
	/**
	...
	**/
	static public function get_abs2d(a:Dynamic):unreal.Vector2D;
	/**
	...
	**/
	static public function get_abs_max2d(a:Dynamic):Float;
	/**
		...
		Returns:
		    ...
		    z (Vector):
	**/
	static public function get_axes(a:Dynamic):python.Tuple<Dynamic>;
	/**
		...
		Returns:
		    DateTime:
	**/
	static public function get_date(a:Dynamic):unreal.DateTime;
	/**
		X.get_day(a) -> int32
		...
		Returns:
		    int32:
	**/
	static public function get_day(a:Dynamic):Int;
	/**
		...
		Returns:
		    int32:
	**/
	static public function get_day_of_year(a:Dynamic):Int;
	/**
		X.get_days(a) -> int32
		...
		Returns:
		    int32:
	**/
	static public function get_days(a:Dynamic):Int;
	/**
		...
		Returns:
		    Vector:
	**/
	static public function get_direction_unit_vector(from_:Dynamic, to:Dynamic):unreal.Vector;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    Timespan:
	**/
	static public function get_duration(a:Dynamic):unreal.Timespan;
	/**
		...
		Returns:
		    Vector:
	**/
	static public function get_forward_vector(rot:Dynamic):unreal.Vector;
	/**
		X.get_hour(a) -> int32
		...
		Returns:
		    int32:
	**/
	static public function get_hour(a:Dynamic):Int;
	/**
		...
		Returns:
		    int32:
	**/
	static public function get_hour12(a:Dynamic):Int;
	/**
		X.get_hours(a) -> int32
		...
		Returns:
		    int32:
	**/
	static public function get_hours(a:Dynamic):Int;
	/**
		X.get_max2d(a) -> float
	...
	**/
	static public function get_max2d(a:Dynamic):Float;
	/**
		...
		Returns:
		    float:
	**/
	static public function get_max_element(a:Dynamic):Float;
	/**
		...
		Returns:
		    int32:
	**/
	static public function get_millisecond(a:Dynamic):Int;
	/**
		...
		Returns:
		    int32:
	**/
	static public function get_milliseconds(a:Dynamic):Int;
	/**
		X.get_min2d(a) -> float
	...
	**/
	static public function get_min2d(a:Dynamic):Float;
	/**
		...
		Returns:
		    float:
	**/
	static public function get_min_element(a:Dynamic):Float;
	/**
		...
		Returns:
		    int32:
	**/
	static public function get_minute(a:Dynamic):Int;
	/**
		...
		Returns:
		    int32:
	**/
	static public function get_minutes(a:Dynamic):Int;
	/**
		X.get_month(a) -> int32
		...
		Returns:
		    int32:
	**/
	static public function get_month(a:Dynamic):Int;
	/**
		X.get_pi() -> float
	...
	**/
	static public function get_point_distance_to_line(point:Dynamic, line_origin:Dynamic, line_direction:Dynamic):Float;
	/**
	...
	**/
	static public function get_point_distance_to_segment(point:Dynamic, segment_start:Dynamic, segment_end:Dynamic):Float;
	/**
	...
	**/
	static public function get_reflection_vector(direction:Dynamic, surface_normal:Dynamic):unreal.Vector;
	/**
		...
		Returns:
		    Vector:
	**/
	static public function get_right_vector(rot:Dynamic):unreal.Vector;
	/**
	...
	**/
	static public function get_rotated2d(a:Dynamic, angle_deg:Dynamic):unreal.Vector2D;
	/**
		...
		Returns:
		    int32:
	**/
	static public function get_second(a:Dynamic):Int;
	/**
		...
		Returns:
		    int32:
	**/
	static public function get_seconds(a:Dynamic):Int;
	/**
	...
	**/
	static public function get_slope_degree_angles(my_right_y_axis:Dynamic, floor_normal:Dynamic, up_vector:Dynamic):python.Tuple<Dynamic>;
	/**
		X.get_tau() -> float
	...
	**/
	...
	/**
		...
		Returns:
		    Timespan:
	**/
	static public function get_time_of_day(a:Dynamic):unreal.Timespan;
	/**
		...
		Returns:
		    float:
	**/
	static public function get_total_days(a:Dynamic):Float;
	/**
		...
		Returns:
		    float:
	**/
	static public function get_total_hours(a:Dynamic):Float;
	/**
		...
		Returns:
		    float:
	**/
	static public function get_total_milliseconds(a:Dynamic):Float;
	/**
		...
		Returns:
		    float:
	**/
	static public function get_total_minutes(a:Dynamic):Float;
	/**
		...
		Returns:
		    float:
	**/
	static public function get_total_seconds(a:Dynamic):Float;
	/**
		...
		Returns:
		    Vector:
	**/
	static public function get_up_vector(rot:Dynamic):unreal.Vector;
	/**
		...
		Returns:
		    Vector:
	**/
	static public function get_vector_array_average(vectors:Dynamic):unreal.Vector;
	/**
		X.get_year(a) -> int32
		...
		Returns:
		    int32:
	**/
	static public function get_year(a:Dynamic):Int;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    bool:
	**/
	static public function greater_date_time_date_time(a:Dynamic, b:Dynamic):Bool;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    bool:
	**/
	static public function greater_equal_date_time_date_time(a:Dynamic, b:Dynamic):Bool;
	/**
		...
		Returns:
		    bool:
	**/
	static public function greater_equal_float_float(a:Dynamic, b:Dynamic):Bool;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    bool:
	**/
	static public function greater_equal_int_int(a:Dynamic, b:Dynamic):Bool;
	/**
		...
		Returns:
		    bool:
	**/
	static public function greater_equal_timespan_timespan(a:Dynamic, b:Dynamic):Bool;
	/**
		...
		Returns:
		    bool:
	**/
	static public function greater_float_float(a:Dynamic, b:Dynamic):Bool;
	/**
		...
		Returns:
		    Vector:
	**/
	static public function greater_greater_vector_rotator(a:Dynamic, b:Dynamic):unreal.Vector;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    bool:
	**/
	static public function greater_int_int(a:Dynamic, b:Dynamic):Bool;
	/**
		...
		Returns:
		    bool:
	**/
	static public function greater_timespan_timespan(a:Dynamic, b:Dynamic):Bool;
	/**
		...
		Returns:
		    float:
	**/
	static public function grid_snap_float(location:Dynamic, grid_size:Dynamic):Float;
	/**
		...
		Returns:
		    LinearColor:
	**/
	static public function hsv_to_rgb(h:Dynamic, s:Dynamic, v:Dynamic, a:Dynamic):unreal.LinearColor;
	/**
		...
		Returns:
		    LinearColor:
	**/
	static public function hsv_to_rgb_linear(hsv:Dynamic):unreal.LinearColor;
	/**
		...
		Returns:
		    ...
		    rgb (LinearColor):
	**/
	static public function hsv_to_rgb_vector(hsv:Dynamic):unreal.LinearColor;
	/**
		...
		Returns:
		    float:
	**/
	static public function hypotenuse(width:Dynamic, height:Dynamic):Float;
	/**
		...
		Returns:
		    bool:
	**/
	static public function in_range_float_float(value:Dynamic, min:Dynamic, max:Dynamic, inclusive_min:Dynamic, inclusive_max:Dynamic):Bool;
	/**
		...
		Returns:
		    bool:
	**/
	static public function in_range_int64_int64(value:Dynamic, min:Dynamic, max:Dynamic, inclusive_min:Dynamic, inclusive_max:Dynamic):Bool;
	/**
		...
		Returns:
		    bool:
	**/
	static public function in_range_int_int(value:Dynamic, min:Dynamic, max:Dynamic, inclusive_min:Dynamic, inclusive_max:Dynamic):Bool;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    Vector:
	**/
	static public function inverse_transform_direction(t:Dynamic, direction:Dynamic):unreal.Vector;
	/**
		...
		Returns:
		    Vector:
	**/
	static public function inverse_transform_location(t:Dynamic, location:Dynamic):unreal.Vector;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    Rotator:
	**/
	static public function inverse_transform_rotation(t:Dynamic, rotation:Dynamic):unreal.Rotator;
	/**
	...
	**/
	static public function invert_transform(t:Dynamic):unreal.Transform;
	/**
		...
		Returns:
		    bool:
	**/
	static public function is_afternoon(a:Dynamic):Bool;
	/**
		...
		Returns:
		    bool:
	**/
	static public function is_leap_year(year:Dynamic):Bool;
	/**
		X.is_morning(a) -> bool
		...
		Returns:
		    bool:
	**/
	static public function is_morning(a:Dynamic):Bool;
	/**
	...
	**/
	static public function is_nearly_zero2d(a:Dynamic, tolerance:Dynamic):Bool;
	/**
	...
	**/
	static public function is_point_in_box(point:Dynamic, box_origin:Dynamic, box_extent:Dynamic):Bool;
	/**
		...
		Returns:
		    bool: Whether the point is in the box.
	**/
	static public function is_point_in_box_with_transform(point:Dynamic, box_world_transform:Dynamic, box_extent:Dynamic):Bool;
	/**
		X.is_zero2d(a) -> bool
	...
	**/
	static public function is_zero2d(a:Dynamic):Bool;
	/**
		...
		Returns:
		    float:
	**/
	static public function lerp(a:Dynamic, b:Dynamic, alpha:Dynamic):Float;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    bool:
	**/
	static public function less_date_time_date_time(a:Dynamic, b:Dynamic):Bool;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    bool:
	**/
	static public function less_equal_date_time_date_time(a:Dynamic, b:Dynamic):Bool;
	/**
		...
		Returns:
		    bool:
	**/
	static public function less_equal_float_float(a:Dynamic, b:Dynamic):Bool;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    bool:
	**/
	static public function less_equal_int_int(a:Dynamic, b:Dynamic):Bool;
	/**
		...
		Returns:
		    bool:
	**/
	static public function less_equal_timespan_timespan(a:Dynamic, b:Dynamic):Bool;
	/**
		...
		Returns:
		    bool:
	**/
	static public function less_float_float(a:Dynamic, b:Dynamic):Bool;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    bool:
	**/
	static public function less_int_int(a:Dynamic, b:Dynamic):Bool;
	/**
		...
		Returns:
		    Vector:
	**/
	static public function less_less_vector_rotator(a:Dynamic, b:Dynamic):unreal.Vector;
	/**
		...
		Returns:
		    bool:
	**/
	static public function less_timespan_timespan(a:Dynamic, b:Dynamic):Bool;
	/**
	...
	**/
	static public function line_plane_intersection(line_start:Dynamic, line_end:Dynamic, a_plane:Dynamic):Dynamic;
	/**
		...
		Returns:
		    ...
		    intersection (Vector): The point of intersection between the line and the plane
	**/
	static public function line_plane_intersection_origin_normal(line_start:Dynamic, line_end:Dynamic, plane_origin:Dynamic, plane_normal:Dynamic):Dynamic;
	/**
	...
	**/
	static public function linear_color_desaturated(color:Dynamic, desaturation:Dynamic):unreal.LinearColor;
	/**
		...
		Returns:
		    float:
	**/
	static public function linear_color_distance(c1:Dynamic, c2:Dynamic):Float;
	/**
		...
		Returns:
		    float:
	**/
	static public function linear_color_get_luminance(color:Dynamic):Float;
	/**
	...
	**/
	static public function linear_color_get_max(color:Dynamic):Float;
	/**
	...
	**/
	static public function linear_color_get_min(color:Dynamic):Float;
	/**
		...
		Returns:
		    bool:
	**/
	static public function linear_color_is_near_equal(a:Dynamic, b:Dynamic, tolerance:Dynamic):Bool;
	/**
		...
		Returns:
		    LinearColor:
	**/
	static public function linear_color_lerp(a:Dynamic, b:Dynamic, alpha:Dynamic):unreal.LinearColor;
	/**
	...
	**/
	static public function linear_color_lerp_using_hsv(a:Dynamic, b:Dynamic, alpha:Dynamic):unreal.LinearColor;
	/**
		...
		Returns:
		    Color:
	**/
	static public function linear_color_quantize(color:Dynamic):unreal.Color;
	/**
		...
		Returns:
		    Color:
	**/
	static public function linear_color_quantize_round(color:Dynamic):unreal.Color;
	/**
		...
		Returns:
		    ...
		    out_color (LinearColor):
	**/
	static public function linear_color_set(out_color:Dynamic, color:Dynamic):unreal.LinearColor;
	/**
		...
		Returns:
		    ...
		    out_color (LinearColor):
	**/
	static public function linear_color_set_from_hsv(out_color:Dynamic, h:Dynamic, s:Dynamic, v:Dynamic, a:Dynamic):unreal.LinearColor;
	/**
		...
		Returns:
		    ...
		    out_color (LinearColor):
	**/
	static public function linear_color_set_from_pow22(out_color:Dynamic, color:Dynamic):unreal.LinearColor;
	/**
		...
		Returns:
		    ...
		    out_color (LinearColor):
	**/
	static public function linear_color_set_from_srgb(out_color:Dynamic, srgb:Dynamic):unreal.LinearColor;
	/**
		...
		Returns:
		    ...
		    out_color (LinearColor):
	**/
	static public function linear_color_set_random_hue(out_color:Dynamic):unreal.LinearColor;
	/**
		...
		Returns:
		    ...
		    out_color (LinearColor):
	**/
	static public function linear_color_set_rgba(out_color:Dynamic, r:Dynamic, g:Dynamic, b:Dynamic, a:Dynamic):unreal.LinearColor;
	/**
		...
		Returns:
		    ...
		    out_color (LinearColor):
	**/
	static public function linear_color_set_temperature(out_color:Dynamic, temperature:Dynamic):unreal.LinearColor;
	/**
		...
		Returns:
		    LinearColor:
	**/
	static public function linear_color_to_new_opacity(color:Dynamic, opacity:Dynamic):unreal.LinearColor;
	/**
		...
		Returns:
		    Color:
	**/
	static public function linear_color_to_rgbe(linear_color:Dynamic):unreal.Color;
	/**
		...
		Returns:
		    float:
	**/
	static public function log(a:Dynamic, base:Dynamic):Float;
	/**
		X.loge(a) -> float
		...
		Returns:
		    float:
	**/
	static public function loge(a:Dynamic):Float;
	/**
	...
	**/
	static public function make_plane_from_point_and_normal(point:Dynamic, normal:Dynamic):unreal.Plane;
	/**
	...
	**/
	static public function make_pulsating_value(current_time:Dynamic, pulses_per_second:Dynamic, phase:Dynamic):Float;
	/**
	...
	**/
	static public function make_relative_transform(a:Dynamic, relative_to:Dynamic):unreal.Transform;
	/**
		...
		Returns:
		    Rotator:
	**/
	static public function make_rot_from_x(x:Dynamic):unreal.Rotator;
	/**
		...
		Returns:
		    Rotator:
	**/
	static public function make_rot_from_xy(x:Dynamic, y:Dynamic):unreal.Rotator;
	/**
		...
		Returns:
		    Rotator:
	**/
	static public function make_rot_from_xz(x:Dynamic, z:Dynamic):unreal.Rotator;
	/**
		...
		Returns:
		    Rotator:
	**/
	static public function make_rot_from_y(y:Dynamic):unreal.Rotator;
	/**
		...
		Returns:
		    Rotator:
	**/
	static public function make_rot_from_yx(y:Dynamic, x:Dynamic):unreal.Rotator;
	/**
		...
		Returns:
		    Rotator:
	**/
	static public function make_rot_from_yz(y:Dynamic, z:Dynamic):unreal.Rotator;
	/**
		...
		Returns:
		    Rotator:
	**/
	static public function make_rot_from_z(z:Dynamic):unreal.Rotator;
	/**
		...
		Returns:
		    Rotator:
	**/
	static public function make_rot_from_zx(z:Dynamic, x:Dynamic):unreal.Rotator;
	/**
		...
		Returns:
		    Rotator:
	**/
	static public function make_rot_from_zy(z:Dynamic, y:Dynamic):unreal.Rotator;
	/**
		...
		Returns:
		    Rotator:
	**/
	static public function make_rotation_from_axes(forward:Dynamic, right:Dynamic, up:Dynamic):unreal.Rotator;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    float:
	**/
	static public function map_range_clamped(value:Dynamic, range_a:Dynamic, range_b:Dynamic, out_range_a:Dynamic, out_range_b:Dynamic):Float;
	/**
		...
		Returns:
		    float:
	**/
	static public function map_range_unclamped(value:Dynamic, range_a:Dynamic, range_b:Dynamic, out_range_a:Dynamic, out_range_b:Dynamic):Float;
	/**
		...
		Returns:
		    Matrix:
	**/
	static public function matrix_apply_scale(m:Dynamic, scale:Dynamic):unreal.Matrix;
	/**
		...
		Returns:
		    Matrix:
	**/
	static public function matrix_concatenate_translation(m:Dynamic, translation:Dynamic):unreal.Matrix;
	/**
		...
		Returns:
		    bool:
	**/
	static public function matrix_contains_na_n(m:Dynamic):Bool;
	/**
	...
	**/
	static public function matrix_get_column(m:Dynamic, column:Dynamic):unreal.Vector;
	/**
	...
	**/
	static public function matrix_get_determinant(m:Dynamic):Float;
	/**
	...
	**/
	static public function matrix_get_frustum_bottom_plane(m:Dynamic):Dynamic;
	/**
	...
	**/
	static public function matrix_get_frustum_far_plane(m:Dynamic):Dynamic;
	/**
	...
	**/
	static public function matrix_get_frustum_left_plane(m:Dynamic):Dynamic;
	/**
	...
	**/
	static public function matrix_get_frustum_near_plane(m:Dynamic):Dynamic;
	/**
	...
	**/
	static public function matrix_get_frustum_right_plane(m:Dynamic):Dynamic;
	/**
	...
	**/
	static public function matrix_get_frustum_top_plane(m:Dynamic):Dynamic;
	/**
		...
		Returns:
		    Matrix:
	**/
	static public function matrix_get_inverse(m:Dynamic):unreal.Matrix;
	/**
		...
		Returns:
		    Matrix:
	**/
	static public function matrix_get_matrix_without_scale(m:Dynamic, tolerance:Dynamic):unreal.Matrix;
	/**
	...
	**/
	static public function matrix_get_maximum_axis_scale(m:Dynamic):Float;
	/**
	...
	**/
	static public function matrix_get_origin(matrix:Dynamic):unreal.Vector;
	/**
	...
	**/
	static public function matrix_get_rot_determinant(m:Dynamic):Float;
	/**
	...
	**/
	static public function matrix_get_rotator(m:Dynamic):unreal.Rotator;
	/**
		...
		Returns:
		    Vector:
	**/
	static public function matrix_get_scale_vector(m:Dynamic, tolerance:Dynamic):unreal.Vector;
	/**
	...
	**/
	static public function matrix_get_scaled_axes(m:Dynamic):python.Tuple<Dynamic>;
	/**
	...
	**/
	static public function matrix_get_scaled_axis(m:Dynamic, axis:Dynamic):unreal.Vector;
	/**
		...
		Returns:
		    Matrix:
	**/
	static public function matrix_get_transpose_adjoint(m:Dynamic):unreal.Matrix;
	/**
		...
		Returns:
		    Matrix:
	**/
	static public function matrix_get_transposed(m:Dynamic):unreal.Matrix;
	/**
		...
		Returns:
		    ...
		    z (Vector): axes returned to this param
	**/
	static public function matrix_get_unit_axes(m:Dynamic):python.Tuple<Dynamic>;
	/**
		...
		Returns:
		    Vector: vector of the axis
	**/
	static public function matrix_get_unit_axis(m:Dynamic, axis:Dynamic):unreal.Vector;
	/**
		...
		Returns:
		    Vector:
	**/
	static public function matrix_inverse_transform_position(m:Dynamic, v:Dynamic):unreal.Vector;
	/**
		...
		Returns:
		    Vector:
	**/
	static public function matrix_inverse_transform_vector(m:Dynamic, v:Dynamic):unreal.Vector;
	/**
		...
		Returns:
		    Matrix:
	**/
	static public function matrix_mirror(m:Dynamic, mirror_axis:Dynamic, flip_axis:Dynamic):unreal.Matrix;
	/**
		...
		Returns:
		    ...
		    m (Matrix):
	**/
	static public function matrix_remove_scaling(m:Dynamic, tolerance:Dynamic):unreal.Matrix;
	/**
		...
		Returns:
		    Matrix:
	**/
	static public function matrix_remove_translation(m:Dynamic):unreal.Matrix;
	/**
		...
		Returns:
		    Matrix:
	**/
	static public function matrix_scale_translation(m:Dynamic, scale3d:Dynamic):unreal.Matrix;
	/**
		...
		Returns:
		    ...
		    m (Matrix):
	**/
	static public function matrix_set_axis(m:Dynamic, axis:Dynamic, axis_vector:Dynamic):unreal.Matrix;
	/**
		...
		Returns:
		    ...
		    m (Matrix):
	**/
	static public function matrix_set_column(m:Dynamic, column:Dynamic, value:Dynamic):unreal.Matrix;
	/**
		...
		Returns:
		    ...
		    m (Matrix):
	**/
	static public function matrix_set_origin(m:Dynamic, new_origin:Dynamic):unreal.Matrix;
	/**
		...
		Returns:
		    Quat:
	**/
	static public function matrix_to_quat(m:Dynamic):unreal.Quat;
	/**
		...
		Returns:
		    Vector4:
	**/
	static public function matrix_transform_position(m:Dynamic, v:Dynamic):unreal.Vector4;
	/**
		...
		Returns:
		    Vector4:
	**/
	static public function matrix_transform_vector(m:Dynamic, v:Dynamic):unreal.Vector4;
	/**
		...
		Returns:
		    Vector4:
	**/
	static public function matrix_transform_vector4(m:Dynamic, v:Dynamic):unreal.Vector4;
	/**
		X.max(a, b) -> int32
		Returns the maximum value of A and B
		...
		Returns:
		    int32:
	**/
	static public function max(a:Dynamic, b:Dynamic):Int;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    ...
		    max_value (uint8):
	**/
	static public function max_of_byte_array(byte_array:Dynamic):python.Tuple<Dynamic>;
	/**
		...
		Returns:
		    ...
		    max_value (float):
	**/
	static public function max_of_float_array(float_array:Dynamic):python.Tuple<Dynamic>;
	/**
		...
		Returns:
		    ...
		    max_value (int32):
	**/
	static public function max_of_int_array(int_array:Dynamic):python.Tuple<Dynamic>;
	/**
		X.min(a, b) -> int32
		Returns the minimum value of A and B
		...
		Returns:
		    int32:
	**/
	static public function min(a:Dynamic, b:Dynamic):Int;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    ...
		    min_value (uint8):
	**/
	static public function min_of_byte_array(byte_array:Dynamic):python.Tuple<Dynamic>;
	/**
		...
		Returns:
		    ...
		    min_value (float):
	**/
	static public function min_of_float_array(float_array:Dynamic):python.Tuple<Dynamic>;
	/**
		...
		Returns:
		    ...
		    min_value (int32):
	**/
	static public function min_of_int_array(int_array:Dynamic):python.Tuple<Dynamic>;
	/**
	...
	**/
	static public function minimum_area_rectangle(world_context_object:Dynamic, verts:Dynamic, sample_surface_normal:Dynamic, debug_draw:Dynamic):python.Tuple<Dynamic>;
	/**
		...
		Returns:
		    Vector: Reflected vector.
	**/
	static public function mirror_vector_by_normal(vect:Dynamic, normal:Dynamic):unreal.Vector;
	/**
		...
		Returns:
		    float:
	**/
	static public function multiply_by_pi(value:Dynamic):Float;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    float:
	**/
	static public function multiply_float_float(a:Dynamic, b:Dynamic):Float;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    float:
	**/
	static public function multiply_int_float(a:Dynamic, b:Dynamic):Float;
	/**
		...
		Returns:
		    int32:
	**/
	static public function multiply_int_int(a:Dynamic, b:Dynamic):Int;
	/**
		...
		Returns:
		    IntPoint:
	**/
	static public function multiply_int_point_int(a:Dynamic, b:Dynamic):unreal.IntPoint;
	/**
		...
		Returns:
		    IntPoint:
	**/
	static public function multiply_int_point_int_point(a:Dynamic, b:Dynamic):unreal.IntPoint;
	/**
		...
		Returns:
		    LinearColor:
	**/
	static public function multiply_linear_color_float(a:Dynamic, b:Dynamic):unreal.LinearColor;
	/**
		...
		Returns:
		    LinearColor:
	**/
	static public function multiply_linear_color_linear_color(a:Dynamic, b:Dynamic):unreal.LinearColor;
	/**
		...
		Returns:
		    Matrix:
	**/
	static public function multiply_matrix_float(a:Dynamic, b:Dynamic):unreal.Matrix;
	/**
	...
	**/
	static public function multiply_matrix_matrix(a:Dynamic, b:Dynamic):unreal.Matrix;
	/**
		...
		Returns:
		    float:
	**/
	static public function multiply_multiply_float_float(base:Dynamic, exp:Dynamic):Float;
	/**
	...
	**/
	static public function multiply_quat_quat(a:Dynamic, b:Dynamic):unreal.Quat;
	/**
		...
		Returns:
		    Rotator:
	**/
	static public function multiply_rotator_float(a:Dynamic, b:Dynamic):unreal.Rotator;
	/**
		...
		Returns:
		    Rotator:
	**/
	static public function multiply_rotator_int(a:Dynamic, b:Dynamic):unreal.Rotator;
	/**
		...
		Returns:
		    Timespan:
	**/
	static public function multiply_timespan_float(a:Dynamic, scalar:Dynamic):unreal.Timespan;
	/**
		...
		Returns:
		    Vector2D:
	**/
	static public function multiply_vector2d_float(a:Dynamic, b:Dynamic):unreal.Vector2D;
	/**
		...
		Returns:
		    Vector2D:
	**/
	static public function multiply_vector2d_vector2d(a:Dynamic, b:Dynamic):unreal.Vector2D;
	/**
		...
		Returns:
		    Vector4:
	**/
	static public function multiply_vector4_vector4(a:Dynamic, b:Dynamic):unreal.Vector4;
	/**
		...
		Returns:
		    Vector:
	**/
	static public function multiply_vector_float(a:Dynamic, b:Dynamic):unreal.Vector;
	/**
		...
		Returns:
		    Vector:
	**/
	static public function multiply_vector_int(a:Dynamic, b:Dynamic):unreal.Vector;
	/**
		...
		Returns:
		    Vector:
	**/
	static public function multiply_vector_vector(a:Dynamic, b:Dynamic):unreal.Vector;
	/**
		...
		Returns:
		    bool:
	**/
	static public function nearly_equal_float_float(a:Dynamic, b:Dynamic, error_tolerance:Dynamic):Bool;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    bool:
	**/
	static public function nearly_equal_transform_transform(a:Dynamic, b:Dynamic, location_tolerance:Dynamic, rotation_tolerance:Dynamic, scale3d_tolerance:Dynamic):Bool;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    Rotator:
	**/
	static public function negate_rotator(a:Dynamic):unreal.Rotator;
	/**
		...
		Returns:
		    Vector:
	**/
	static public function negate_vector(a:Dynamic):unreal.Vector;
	/**
		...
		Returns:
		    Vector2D:
	**/
	static public function negated2d(a:Dynamic):unreal.Vector2D;
	/**
	...
	**/
	static public function normal(a:Dynamic, tolerance:Dynamic):unreal.Vector;
	/**
		...
		Returns:
		    Vector2D:
	**/
	static public function normal2d(a:Dynamic):unreal.Vector2D;
	/**
	...
	**/
	static public function normal_safe2d(a:Dynamic, tolerance:Dynamic):unreal.Vector2D;
	/**
		...
		Returns:
		    ...
		    a (Vector2D):
	**/
	static public function normalize2d(a:Dynamic, tolerance:Dynamic):unreal.Vector2D;
	/**
		...
		Returns:
		    float: The clamped angle.
	**/
	static public function normalize_axis(angle:Dynamic):Float;
	/**
		...
		Returns:
		    float:
	**/
	static public function normalize_to_range(value:Dynamic, range_min:Dynamic, range_max:Dynamic):Float;
	/**
		...
		Returns:
		    Rotator:
	**/
	static public function normalized_delta_rotator(a:Dynamic, b:Dynamic):unreal.Rotator;
	/**
		...
		Returns:
		    bool:
	**/
	static public function not_equal_bool_bool(a:Dynamic, b:Dynamic):Bool;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    bool:
	**/
	static public function not_equal_date_time_date_time(a:Dynamic, b:Dynamic):Bool;
	/**
		...
		Returns:
		    bool:
	**/
	static public function not_equal_exactly_vector2d_vector2d(a:Dynamic, b:Dynamic):Bool;
	/**
		...
		Returns:
		    bool:
	**/
	static public function not_equal_exactly_vector4_vector4(a:Dynamic, b:Dynamic):Bool;
	/**
		...
		Returns:
		    bool:
	**/
	static public function not_equal_exactly_vector_vector(a:Dynamic, b:Dynamic):Bool;
	/**
		...
		Returns:
		    bool:
	**/
	static public function not_equal_float_float(a:Dynamic, b:Dynamic):Bool;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    bool:
	**/
	static public function not_equal_int_int(a:Dynamic, b:Dynamic):Bool;
	/**
		...
		Returns:
		    bool:
	**/
	static public function not_equal_int_point_int_point(a:Dynamic, b:Dynamic):Bool;
	/**
		...
		Returns:
		    bool:
	**/
	static public function not_equal_linear_color_linear_color(a:Dynamic, b:Dynamic):Bool;
	/**
	...
	**/
	static public function not_equal_matrix_matrix(a:Dynamic, b:Dynamic, tolerance:Dynamic):Bool;
	/**
		...
		Returns:
		    bool:
	**/
	static public function not_equal_name_name(a:Dynamic, b:Dynamic):Bool;
	/**
		...
		Returns:
		    bool:
	**/
	static public function not_equal_object_object(a:Dynamic, b:Dynamic):Bool;
	/**
		...
		Returns:
		    bool:
	**/
	static public function not_equal_quat_quat(a:Dynamic, b:Dynamic, error_tolerance:Dynamic):Bool;
	/**
		...
		Returns:
		    bool:
	**/
	static public function not_equal_rotator_rotator(a:Dynamic, b:Dynamic, error_tolerance:Dynamic):Bool;
	/**
		...
		Returns:
		    bool:
	**/
	static public function not_equal_timespan_timespan(a:Dynamic, b:Dynamic):Bool;
	/**
		...
		Returns:
		    bool:
	**/
	static public function not_equal_vector2d_vector2d(a:Dynamic, b:Dynamic, error_tolerance:Dynamic):Bool;
	/**
		...
		Returns:
		    bool:
	**/
	static public function not_equal_vector4_vector4(a:Dynamic, b:Dynamic, error_tolerance:Dynamic):Bool;
	/**
		...
		Returns:
		    bool:
	**/
	static public function not_equal_vector_vector(a:Dynamic, b:Dynamic, error_tolerance:Dynamic):Bool;
	/**
		X.not_int(a) -> int32
		Bitwise NOT (~A)
		...
		Returns:
		    int32:
	**/
	static public function not_int(a:Dynamic):Int;
	/**
		X.not_int64(a) -> int64
		Bitwise NOT (~A)
	...
	**/
	...
	/**
		...
		Returns:
		    bool:
	**/
	static public function not_pre_bool(a:Dynamic):Bool;
	/**
		X.now() -> DateTime
	...
	**/
	...
	/**
		...
		Returns:
		    int32:
	**/
	static public function or_int_int(a:Dynamic, b:Dynamic):Int;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    int32:
	**/
	static public function percent_int_int(a:Dynamic, b:Dynamic):Int;
	/**
	...
	**/
	static public function perlin_noise1d(value:Dynamic):Float;
	/**
	...
	**/
	static public function points_are_coplanar(points:Dynamic, tolerance:Dynamic):Bool;
	/**
	...
	**/
	static public function project_point_on_to_plane(point:Dynamic, plane_base:Dynamic, plane_normal:Dynamic):unreal.Vector;
	/**
	...
	**/
	static public function project_vector_on_to_plane(v:Dynamic, plane_normal:Dynamic):unreal.Vector;
	/**
	...
	**/
	static public function project_vector_on_to_vector(v:Dynamic, target:Dynamic):unreal.Vector;
	/**
	...
	**/
	static public function quat_angular_distance(a:Dynamic, b:Dynamic):Float;
	/**
		...
		Returns:
		    ...
		    a (Quat):
	**/
	static public function quat_enforce_shortest_arc_with(a:Dynamic, b:Dynamic):unreal.Quat;
	/**
		...
		Returns:
		    Vector:
	**/
	static public function quat_euler(q:Dynamic):unreal.Vector;
	/**
		X.quat_exp(q) -> Quat
		...
		Returns:
		    Quat:
	**/
	static public function quat_exp(q:Dynamic):unreal.Quat;
	/**
		...
		Returns:
		    float:
	**/
	static public function quat_get_angle(q:Dynamic):Float;
	/**
		...
		Returns:
		    Vector:
	**/
	static public function quat_get_axis_x(q:Dynamic):unreal.Vector;
	/**
		...
		Returns:
		    Vector:
	**/
	static public function quat_get_axis_y(q:Dynamic):unreal.Vector;
	/**
		...
		Returns:
		    Vector:
	**/
	static public function quat_get_axis_z(q:Dynamic):unreal.Vector;
	/**
		...
		Returns:
		    Vector:
	**/
	static public function quat_get_rotation_axis(q:Dynamic):unreal.Vector;
	/**
		...
		Returns:
		    Quat:
	**/
	static public function quat_inversed(q:Dynamic):unreal.Quat;
	/**
		...
		Returns:
		    bool:
	**/
	static public function quat_is_finite(q:Dynamic):Bool;
	/**
	...
	**/
	static public function quat_is_identity(q:Dynamic, tolerance:Dynamic):Bool;
	/**
		...
		Returns:
		    bool:
	**/
	static public function quat_is_non_finite(q:Dynamic):Bool;
	/**
		...
		Returns:
		    bool:
	**/
	static public function quat_is_normalized(q:Dynamic):Bool;
	/**
		X.quat_log(q) -> Quat
		...
		Returns:
		    Quat:
	**/
	static public function quat_log(q:Dynamic):unreal.Quat;
	/**
	...
	**/
	static public function quat_make_from_euler(euler:Dynamic):unreal.Quat;
	/**
		...
		Returns:
		    ...
		    q (Quat):
	**/
	static public function quat_normalize(q:Dynamic, tolerance:Dynamic):unreal.Quat;
	/**
		...
		Returns:
		    Quat:
	**/
	static public function quat_normalized(q:Dynamic, tolerance:Dynamic):unreal.Quat;
	/**
	...
	**/
	static public function quat_rotate_vector(q:Dynamic, v:Dynamic):unreal.Vector;
	/**
		...
		Returns:
		    Rotator:
	**/
	static public function quat_rotator(q:Dynamic):unreal.Rotator;
	/**
		...
		Returns:
		    ...
		    q (Quat):
	**/
	static public function quat_set_components(q:Dynamic, x:Dynamic, y:Dynamic, z:Dynamic, w:Dynamic):unreal.Quat;
	/**
		...
		Returns:
		    ...
		    q (Quat):
	**/
	static public function quat_set_from_euler(q:Dynamic, euler:Dynamic):unreal.Quat;
	/**
		X.quat_size(q) -> float
	...
	**/
	static public function quat_size(q:Dynamic):Float;
	/**
	...
	**/
	static public function quat_size_squared(q:Dynamic):Float;
	/**
	...
	**/
	static public function quat_unrotate_vector(q:Dynamic, v:Dynamic):unreal.Vector;
	/**
		...
		Returns:
		    Vector:
	**/
	static public function quat_vector_forward(q:Dynamic):unreal.Vector;
	/**
		...
		Returns:
		    Vector:
	**/
	static public function quat_vector_right(q:Dynamic):unreal.Vector;
	/**
		...
		Returns:
		    Vector:
	**/
	static public function quat_vector_up(q:Dynamic):unreal.Vector;
	/**
	...
	**/
	static public function r_interp_to(current:Dynamic, target:Dynamic, delta_time:Dynamic, interp_speed:Dynamic):unreal.Rotator;
	/**
		...
		Returns:
		    Rotator: New interpolated position
	**/
	static public function r_interp_to_constant(current:Dynamic, target:Dynamic, delta_time:Dynamic, interp_speed:Dynamic):unreal.Rotator;
	/**
		...
		Returns:
		    Rotator:
	**/
	static public function r_lerp(a:Dynamic, b:Dynamic, alpha:Dynamic, shortest_path:Dynamic):unreal.Rotator;
	/**
		...
		Returns:
		    float:
	**/
	static public function radians_to_degrees(a:Dynamic):Float;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    bool:
	**/
	static public function random_bool_from_stream(stream:Dynamic):Bool;
	/**
		...
		Returns:
		    bool:
	**/
	static public function random_bool_with_weight(weight:Dynamic):Bool;
	/**
		...
		Returns:
		    bool:
	**/
	static public function random_bool_with_weight_from_stream(weight:Dynamic, random_stream:Dynamic):Bool;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    float:
	**/
	static public function random_float_from_stream(stream:Dynamic):Float;
	/**
		...
		Returns:
		    float:
	**/
	static public function random_float_in_range(min:Dynamic, max:Dynamic):Float;
	/**
		...
		Returns:
		    float:
	**/
	static public function random_float_in_range_from_stream(min:Dynamic, max:Dynamic, stream:Dynamic):Float;
	/**
		...
		Returns:
		    int32:
	**/
	static public function random_integer(max:Dynamic):Int;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    int32:
	**/
	static public function random_integer_from_stream(max:Dynamic, stream:Dynamic):Int;
	/**
		...
		Returns:
		    int32:
	**/
	static public function random_integer_in_range(min:Dynamic, max:Dynamic):Int;
	/**
		...
		Returns:
		    int32:
	**/
	static public function random_integer_in_range_from_stream(min:Dynamic, max:Dynamic, stream:Dynamic):Int;
	/**
		...
		Returns:
		    Vector:
	**/
	static public function random_point_in_bounding_box(origin:Dynamic, box_extent:Dynamic):unreal.Vector;
	/**
		...
		Returns:
		    Rotator:
	**/
	static public function random_rotator(roll:Dynamic):unreal.Rotator;
	/**
		...
		Returns:
		    Rotator:
	**/
	static public function random_rotator_from_stream(roll:Dynamic, stream:Dynamic):unreal.Rotator;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    Vector:
	**/
	static public function random_unit_vector_from_stream(stream:Dynamic):unreal.Vector;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    Vector:
	**/
	static public function random_unit_vector_in_cone_in_degrees(cone_dir:Dynamic, cone_half_angle_in_degrees:Dynamic):unreal.Vector;
	/**
		...
		Returns:
		    Vector:
	**/
	static public function random_unit_vector_in_cone_in_degrees_from_stream(cone_dir:Dynamic, cone_half_angle_in_degrees:Dynamic, stream:Dynamic):unreal.Vector;
	/**
		...
		Returns:
		    Vector:
	**/
	static public function random_unit_vector_in_cone_in_radians(cone_dir:Dynamic, cone_half_angle_in_radians:Dynamic):unreal.Vector;
	/**
		...
		Returns:
		    Vector:
	**/
	static public function random_unit_vector_in_cone_in_radians_from_stream(cone_dir:Dynamic, cone_half_angle_in_radians:Dynamic, stream:Dynamic):unreal.Vector;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    Vector:
	**/
	static public function random_unit_vector_in_elliptical_cone_in_degrees(cone_dir:Dynamic, max_yaw_in_degrees:Dynamic, max_pitch_in_degrees:Dynamic):unreal.Vector;
	/**
		...
		Returns:
		    Vector:
	**/
	static public function random_unit_vector_in_elliptical_cone_in_degrees_from_stream(cone_dir:Dynamic, max_yaw_in_degrees:Dynamic, max_pitch_in_degrees:Dynamic, stream:Dynamic):unreal.Vector;
	/**
		...
		Returns:
		    Vector:
	**/
	static public function random_unit_vector_in_elliptical_cone_in_radians(cone_dir:Dynamic, max_yaw_in_radians:Dynamic, max_pitch_in_radians:Dynamic):unreal.Vector;
	/**
		...
		Returns:
		    Vector:
	**/
	static public function random_unit_vector_in_elliptical_cone_in_radians_from_stream(cone_dir:Dynamic, max_yaw_in_radians:Dynamic, max_pitch_in_radians:Dynamic, stream:Dynamic):unreal.Vector;
	/**
		...
		Returns:
		    ...
		    spring_state (FloatSpringState):
	**/
	static public function reset_float_spring_state(spring_state:Dynamic):unreal.FloatSpringState;
	/**
		...
		Args:
		    stream (RandomStream):
	**/
	static public function reset_random_stream(stream:Dynamic):Void;
	/**
		...
		Returns:
		    ...
		    spring_state (VectorSpringState):
	**/
	static public function reset_vector_spring_state(spring_state:Dynamic):unreal.VectorSpringState;
	/**
		...
		Returns:
		    LinearColor:
	**/
	static public function rgb_linear_to_hsv(rgb:Dynamic):unreal.LinearColor;
	/**
		...
		Returns:
		    ...
		    a (float):
	**/
	static public function rgb_to_hsv(color:Dynamic):python.Tuple<Dynamic>;
	/**
		...
		Returns:
		    ...
		    hsv (LinearColor):
	**/
	static public function rgb_to_hsv_vector(rgb:Dynamic):unreal.LinearColor;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    Vector:
	**/
	static public function rotate_angle_axis(vect:Dynamic, angle_deg:Dynamic, axis:Dynamic):unreal.Vector;
	/**
		...
		Returns:
		    Rotator:
	**/
	static public function rotator_from_axis_and_angle(axis:Dynamic, angle:Dynamic):unreal.Rotator;
	/**
		X.round(a) -> int32
		...
		Returns:
		    int32:
	**/
	static public function round(a:Dynamic):Int;
	/**
		X.round64(a) -> int64
		Rounds A to the nearest integer (e.g., -1.6 becomes -2 and 1.6 becomes 2)
		...
		Returns:
		    int64:
	**/
	static public function round64(a:Dynamic):Dynamic;
	/**
		...
		Returns:
		    float:
	**/
	static public function safe_divide(a:Dynamic, b:Dynamic):Float;
	/**
		...
		Returns:
		    ...
		    stream (RandomStream):
	**/
	static public function seed_random_stream(stream:Dynamic):unreal.RandomStream;
	/**
		...
		Returns:
		    type(Class):
	**/
	static public function select_class(a:Dynamic, b:Dynamic, select_a:Dynamic):Dynamic;
	/**
		...
		Returns:
		    LinearColor:
	**/
	static public function select_color(a:Dynamic, b:Dynamic, pick_a:Dynamic):unreal.LinearColor;
	/**
		...
		Returns:
		    float:
	**/
	static public function select_float(a:Dynamic, b:Dynamic, pick_a:Dynamic):Float;
	/**
		...
		Returns:
		    int32:
	**/
	static public function select_int(a:Dynamic, b:Dynamic, pick_a:Dynamic):Int;
	/**
		...
		Returns:
		    Object:
	**/
	static public function select_object(a:Dynamic, b:Dynamic, select_a:Dynamic):unreal.Object;
	/**
		...
		Returns:
		    Rotator:
	**/
	static public function select_rotator(a:Dynamic, b:Dynamic, pick_a:Dynamic):unreal.Rotator;
	/**
		...
		Returns:
		    str:
	**/
	static public function select_string(a:Dynamic, b:Dynamic, pick_a:Dynamic):String;
	/**
		...
		Returns:
		    Transform:
	**/
	static public function select_transform(a:Dynamic, b:Dynamic, pick_a:Dynamic):unreal.Transform;
	/**
		...
		Returns:
		    Vector:
	**/
	static public function select_vector(a:Dynamic, b:Dynamic, pick_a:Dynamic):unreal.Vector;
	/**
		...
		Returns:
		    ...
		    a (Vector2D):
	**/
	static public function set2d(a:Dynamic, x:Dynamic, y:Dynamic):unreal.Vector2D;
	/**
		...
		Returns:
		    ...
		    stream (RandomStream):
	**/
	static public function set_random_stream_seed(stream:Dynamic, new_seed:Dynamic):unreal.RandomStream;
	/**
		...
		Returns:
		    float:
	**/
	static public function sign_of_float(a:Dynamic):Float;
	/**
		...
		Returns:
		    int32:
	**/
	static public function sign_of_integer(a:Dynamic):Int;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    float:
	**/
	static public function sin(a:Dynamic):Float;
	/**
		...
		Returns:
		    Vector:
	**/
	static public function spherical2d_to_unit_cartesian(a:Dynamic):unreal.Vector;
	/**
		X.sqrt(a) -> float
		...
		Returns:
		    float:
	**/
	static public function sqrt(a:Dynamic):Float;
	/**
		X.square(a) -> float
		...
		Returns:
		    float:
	**/
	static public function square(a:Dynamic):Float;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    Timespan:
	**/
	static public function subtract_date_time_date_time(a:Dynamic, b:Dynamic):unreal.Timespan;
	/**
		...
		Returns:
		    DateTime:
	**/
	static public function subtract_date_time_timespan(a:Dynamic, b:Dynamic):unreal.DateTime;
	/**
		...
		Returns:
		    float:
	**/
	static public function subtract_float_float(a:Dynamic, b:Dynamic):Float;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    int32:
	**/
	static public function subtract_int_int(a:Dynamic, b:Dynamic):Int;
	/**
		...
		Returns:
		    IntPoint:
	**/
	static public function subtract_int_point_int(a:Dynamic, b:Dynamic):unreal.IntPoint;
	/**
		...
		Returns:
		    IntPoint:
	**/
	static public function subtract_int_point_int_point(a:Dynamic, b:Dynamic):unreal.IntPoint;
	/**
		...
		Returns:
		    LinearColor:
	**/
	static public function subtract_linear_color_linear_color(a:Dynamic, b:Dynamic):unreal.LinearColor;
	/**
		...
		Returns:
		    Quat:
	**/
	static public function subtract_quat_quat(a:Dynamic, b:Dynamic):unreal.Quat;
	/**
		...
		Returns:
		    Timespan:
	**/
	static public function subtract_timespan_timespan(a:Dynamic, b:Dynamic):unreal.Timespan;
	/**
		...
		Returns:
		    Vector2D:
	**/
	static public function subtract_vector2d_float(a:Dynamic, b:Dynamic):unreal.Vector2D;
	/**
		...
		Returns:
		    Vector2D:
	**/
	static public function subtract_vector2d_vector2d(a:Dynamic, b:Dynamic):unreal.Vector2D;
	/**
		...
		Returns:
		    Vector4:
	**/
	static public function subtract_vector4_vector4(a:Dynamic, b:Dynamic):unreal.Vector4;
	/**
		...
		Returns:
		    Vector:
	**/
	static public function subtract_vector_float(a:Dynamic, b:Dynamic):unreal.Vector;
	/**
		...
		Returns:
		    Vector:
	**/
	static public function subtract_vector_int(a:Dynamic, b:Dynamic):unreal.Vector;
	/**
		...
		Returns:
		    Vector:
	**/
	static public function subtract_vector_vector(a:Dynamic, b:Dynamic):unreal.Vector;
	/**
	...
	**/
	static public function t_interp_to(current:Dynamic, target:Dynamic, delta_time:Dynamic, interp_speed:Dynamic):unreal.Transform;
	/**
		...
		Returns:
		    Transform:
	**/
	static public function t_lerp(a:Dynamic, b:Dynamic, alpha:Dynamic, interp_mode:Dynamic):unreal.Transform;
	/**
		X.tan(a) -> float
		...
		Returns:
		    float:
	**/
	static public function tan(a:Dynamic):Float;
	/**
		...
		Returns:
		    ...
		    result (Timespan):
	**/
	static public function timespan_from_string(timespan_string:Dynamic):Dynamic;
	/**
		...
		Returns:
		    float:
	**/
	static public function timespan_ratio(a:Dynamic, b:Dynamic):Float;
	/**
	...
	**/
	static public function to_direction_and_length2d(a:Dynamic):python.Tuple<Dynamic>;
	/**
	...
	**/
	static public function to_rounded2d(a:Dynamic):unreal.Vector2D;
	/**
	...
	**/
	static public function to_sign2d(a:Dynamic):unreal.Vector2D;
	/**
		X.today() -> DateTime
	...
	**/
	...
	/**
		...
		Returns:
		    float:
	**/
	static public function transform_determinant(transform:Dynamic):Float;
	/**
		...
		Returns:
		    Vector:
	**/
	static public function transform_direction(t:Dynamic, direction:Dynamic):unreal.Vector;
	/**
		...
		Returns:
		    Vector:
	**/
	static public function transform_location(t:Dynamic, location:Dynamic):unreal.Vector;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    Rotator:
	**/
	static public function transform_rotation(t:Dynamic, rotation:Dynamic):unreal.Rotator;
	/**
	...
	**/
	static public function transform_vector4(matrix:Dynamic, vec4:Dynamic):unreal.Vector4;
	/**
		X.utc_now() -> DateTime
	...
	**/
	static public function v_interp_to(current:Dynamic, target:Dynamic, delta_time:Dynamic, interp_speed:Dynamic):unreal.Vector;
	/**
		...
		Returns:
		    Vector: New interpolated position
	**/
	static public function v_interp_to_constant(current:Dynamic, target:Dynamic, delta_time:Dynamic, interp_speed:Dynamic):unreal.Vector;
	/**
		...
		Returns:
		    Vector:
	**/
	static public function v_lerp(a:Dynamic, b:Dynamic, alpha:Dynamic):unreal.Vector;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    float:
	**/
	static public function v_size(a:Dynamic):Float;
	/**
		X.v_size2d(a) -> float
		...
		Returns:
		    float:
	**/
	static public function v_size2d(a:Dynamic):Float;
	/**
		...
		Returns:
		    float:
	**/
	static public function v_size2d_squared(a:Dynamic):Float;
	/**
		...
		Returns:
		    float:
	**/
	static public function v_size_squared(a:Dynamic):Float;
	/**
		X.v_size_xy(a) -> float
		...
		Returns:
		    float:
	**/
	static public function v_size_xy(a:Dynamic):Float;
	/**
		...
		Returns:
		    float:
	**/
	static public function v_size_xy_squared(a:Dynamic):Float;
	/**
	...
	**/
	static public function vector2d_interp_to(current:Dynamic, target:Dynamic, delta_time:Dynamic, interp_speed:Dynamic):unreal.Vector2D;
	/**
		...
		Returns:
		    Vector2D: New interpolated position
	**/
	static public function vector2d_interp_to_constant(current:Dynamic, target:Dynamic, delta_time:Dynamic, interp_speed:Dynamic):unreal.Vector2D;
	/**
		...
		Returns:
		    ...
		    a (Vector4):
	**/
	static public function vector4_assign(a:Dynamic, vector:Dynamic):unreal.Vector4;
	/**
		...
		Returns:
		    Vector4:
	**/
	static public function vector4_cross_product3(a:Dynamic, b:Dynamic):unreal.Vector4;
	/**
		...
		Returns:
		    float:
	**/
	static public function vector4_dot_product(a:Dynamic, b:Dynamic):Float;
	/**
		...
		Returns:
		    float:
	**/
	static public function vector4_dot_product3(a:Dynamic, b:Dynamic):Float;
	/**
	...
	**/
	static public function vector4_is_nan(a:Dynamic):Bool;
	/**
		...
		Returns:
		    bool: true if vector is in tolerance to zero, otherwise false.
	**/
	static public function vector4_is_nearly_zero3(a:Dynamic, tolerance:Dynamic):Bool;
	/**
	...
	**/
	static public function vector4_is_normal3(a:Dynamic):Bool;
	/**
	...
	**/
	static public function vector4_is_unit3(a:Dynamic, squared_lenth_tolerance:Dynamic):Bool;
	/**
		...
		Returns:
		    bool: true if vector is exactly zero, otherwise false.
	**/
	static public function vector4_is_zero(a:Dynamic):Bool;
	/**
	...
	**/
	static public function vector4_mirror_by_vector3(direction:Dynamic, surface_normal:Dynamic):unreal.Vector4;
	/**
		...
		Returns:
		    Vector4:
	**/
	static public function vector4_negated(a:Dynamic):unreal.Vector4;
	/**
	...
	**/
	static public function vector4_normal3(a:Dynamic, tolerance:Dynamic):unreal.Vector4;
	/**
	...
	**/
	static public function vector4_normal_unsafe3(a:Dynamic):unreal.Vector4;
	/**
		...
		Returns:
		    ...
		    a (Vector4):
	**/
	static public function vector4_normalize3(a:Dynamic, tolerance:Dynamic):unreal.Vector4;
	/**
		...
		Returns:
		    ...
		    a (Vector4):
	**/
	static public function vector4_set(a:Dynamic, x:Dynamic, y:Dynamic, z:Dynamic, w:Dynamic):unreal.Vector4;
	/**
		...
		Returns:
		    float:
	**/
	static public function vector4_size(a:Dynamic):Float;
	/**
		...
		Returns:
		    float:
	**/
	static public function vector4_size3(a:Dynamic):Float;
	/**
		...
		Returns:
		    float:
	**/
	static public function vector4_size_squared(a:Dynamic):Float;
	/**
		...
		Returns:
		    float:
	**/
	static public function vector4_size_squared3(a:Dynamic):Float;
	/**
		...
		Returns:
		    ...
		    a (Vector):
	**/
	static public function vector_add_bounded(a:Dynamic, add_vect:Dynamic, radius:Dynamic):unreal.Vector;
	/**
		...
		Returns:
		    ...
		    a (Vector):
	**/
	static public function vector_assign(a:Dynamic, vector:Dynamic):unreal.Vector;
	/**
		...
		Returns:
		    Vector:
	**/
	static public function vector_bounded_to_box(vect:Dynamic, box_min:Dynamic, box_max:Dynamic):unreal.Vector;
	/**
	...
	**/
	static public function vector_bounded_to_cube(vect:Dynamic, radius:Dynamic):unreal.Vector;
	/**
		...
		Returns:
		    Vector:
	**/
	static public function vector_clamp_size2d(a:Dynamic, min:Dynamic, max:Dynamic):unreal.Vector;
	/**
		...
		Returns:
		    Vector:
	**/
	static public function vector_clamp_size_max(a:Dynamic, max:Dynamic):unreal.Vector;
	/**
		...
		Returns:
		    Vector:
	**/
	static public function vector_clamp_size_max2d(a:Dynamic, max:Dynamic):unreal.Vector;
	/**
		...
		Returns:
		    Vector:
	**/
	static public function vector_component_max(a:Dynamic, b:Dynamic):unreal.Vector;
	/**
		...
		Returns:
		    Vector:
	**/
	static public function vector_component_min(a:Dynamic, b:Dynamic):unreal.Vector;
	/**
		...
		Returns:
		    float: The cosine.
	**/
	static public function vector_cosine_angle2d(a:Dynamic, b:Dynamic):Float;
	/**
	...
	**/
	static public function vector_distance(v1:Dynamic, v2:Dynamic):Float;
	/**
	...
	**/
	static public function vector_distance2d(v1:Dynamic, v2:Dynamic):Float;
	/**
		...
		Returns:
		    float: The distance between two points in the XY plane.
	**/
	static public function vector_distance2d_squared(v1:Dynamic, v2:Dynamic):Float;
	/**
	...
	**/
	static public function vector_distance_squared(v1:Dynamic, v2:Dynamic):Float;
	/**
	...
	**/
	static public function vector_get_abs(a:Dynamic):unreal.Vector;
	/**
		...
		Returns:
		    float:
	**/
	static public function vector_get_abs_max(a:Dynamic):Float;
	/**
		...
		Returns:
		    float:
	**/
	static public function vector_get_abs_min(a:Dynamic):Float;
	/**
	...
	**/
	static public function vector_get_projection(a:Dynamic):unreal.Vector;
	/**
		...
		Returns:
		    Vector:
	**/
	static public function vector_get_sign_vector(a:Dynamic):unreal.Vector;
	/**
	...
	**/
	static public function vector_heading_angle(a:Dynamic):Float;
	/**
		...
		Returns:
		    bool: true if one or more components is NAN, otherwise false.
	**/
	static public function vector_is_nan(a:Dynamic):Bool;
	/**
		...
		Returns:
		    bool: true if vector is in tolerance to zero, otherwise false.
	**/
	static public function vector_is_nearly_zero(a:Dynamic, tolerance:Dynamic):Bool;
	/**
		...
		Returns:
		    bool: true if normalized, false otherwise.
	**/
	static public function vector_is_normal(a:Dynamic):Bool;
	/**
	...
	**/
	static public function vector_is_uniform(a:Dynamic, tolerance:Dynamic):Bool;
	/**
		...
		Returns:
		    bool: true if unit, false otherwise.
	**/
	static public function vector_is_unit(a:Dynamic, squared_lenth_tolerance:Dynamic):Bool;
	/**
		...
		Returns:
		    bool: true if vector is exactly zero, otherwise false.
	**/
	static public function vector_is_zero(a:Dynamic):Bool;
	/**
	...
	**/
	static public function vector_mirror_by_plane(a:Dynamic, plane:Dynamic):unreal.Vector;
	/**
	...
	**/
	static public function vector_normal2d(a:Dynamic, tolerance:Dynamic):unreal.Vector;
	/**
	...
	**/
	static public function vector_normal_unsafe(a:Dynamic):unreal.Vector;
	/**
		...
		Returns:
		    ...
		    a (Vector):
	**/
	static public function vector_normalize(a:Dynamic, tolerance:Dynamic):unreal.Vector;
	/**
	...
	**/
	static public function vector_project_on_to_normal(v:Dynamic, normal:Dynamic):unreal.Vector;
	/**
	...
	**/
	static public function vector_reciprocal(a:Dynamic):unreal.Vector;
	/**
		...
		Returns:
		    ...
		    a (Vector):
	**/
	static public function vector_set(a:Dynamic, x:Dynamic, y:Dynamic, z:Dynamic):unreal.Vector;
	/**
	...
	**/
	static public function vector_snapped_to_grid(vect:Dynamic, grid_size:Dynamic):unreal.Vector;
	/**
		...
		Returns:
		    ...
		    spring_state (VectorSpringState):
	**/
	static public function vector_spring_interp(current:Dynamic, target:Dynamic, spring_state:Dynamic, stiffness:Dynamic, critical_damping_factor:Dynamic, delta_time:Dynamic, mass:Dynamic):unreal.VectorSpringState;
	/**
	...
	**/
	static public function vector_to_degrees(a:Dynamic):unreal.Vector;
	/**
	...
	**/
	static public function vector_to_radians(a:Dynamic):unreal.Vector;
	/**
	...
	**/
	static public function vector_unit_cartesian_to_spherical(a:Dynamic):unreal.Vector2D;
	/**
		...
		Returns:
		    ...
		    a (Vector):
	**/
	static public function vector_unwind_euler(a:Dynamic):unreal.Vector;
	/**
		...
		Returns:
		    Rotator: the next value in the series
	**/
	static public function weighted_moving_average_f_rotator(current_sample:Dynamic, previous_sample:Dynamic, weight:Dynamic):unreal.Rotator;
	/**
		...
		Returns:
		    Vector: the next value in the series
	**/
	static public function weighted_moving_average_f_vector(current_sample:Dynamic, previous_sample:Dynamic, weight:Dynamic):unreal.Vector;
	/**
		...
		Returns:
		    float: the next value in the series
	**/
	static public function weighted_moving_average_float(current_sample:Dynamic, previous_sample:Dynamic, weight:Dynamic):Float;
	/**
		...
		Returns:
		    int32:
	**/
	static public function wrap(value:Dynamic, min:Dynamic, max:Dynamic):Int;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    int32:
	**/
	static public function xor_int_int(a:Dynamic, b:Dynamic):Int;
}