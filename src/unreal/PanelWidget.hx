...
@:pythonImport("unreal", "PanelWidget") extern class PanelWidget extends unreal.Widget {
	...
	**/
	...
	/**
		...
		Returns:
		    PanelSlot:
	**/
	public function add_child(content:Dynamic):unreal.PanelSlot;
	/**
	...
	**/
	public function get_child_at(index:Dynamic):unreal.Widget;
	/**
		...
		Returns:
		    int32:
	**/
	public function get_child_index(content:Dynamic):Int;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    bool:
	**/
	public function has_child(content:Dynamic):Bool;
	/**
	...
	**/
	public function remove_child(content:Dynamic):Bool;
	/**
		...
		Returns:
		    bool:
	**/
	public function remove_child_at(index:Dynamic):Bool;
}