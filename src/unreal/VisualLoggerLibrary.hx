...
@:pythonImport("unreal", "VisualLoggerLibrary") extern class VisualLoggerLibrary extends unreal.BlueprintFunctionLibrary {
	...
	**/
	static public function log_box(world_context_object:unreal.Object, box_shape:unreal.Box, text:String, ?object_color:unreal.LinearColor, ?log_category:unreal.Name, add_to_message_log:Bool = false):Void;
	/**
		...
		Args:
		    ...
		    add_to_message_log (bool):
	**/
	static public function log_location(world_context_object:unreal.Object, location:unreal.Vector, text:String, ?object_color:unreal.LinearColor, radius:Float = 10.000000, ?log_category:unreal.Name, add_to_message_log:Bool = false):Void;
	/**
		...
		Args:
		    ...
		    add_to_message_log (bool):
	**/
	static public function log_segment(world_context_object:unreal.Object, segment_start:unreal.Vector, segment_end:unreal.Vector, text:String, ?object_color:unreal.LinearColor, thickness:Float = 0.000000, ?category_name:unreal.Name, add_to_message_log:Bool = false):Void;
	/**
		...
		Args:
		    ...
		    add_to_message_log (bool):
	**/
	static public function log_text(world_context_object:unreal.Object, text:String, ?log_category:unreal.Name, add_to_message_log:Bool = false):Void;
	/**
