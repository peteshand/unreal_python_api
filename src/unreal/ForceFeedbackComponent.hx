...
@:pythonImport("unreal", "ForceFeedbackComponent") extern class ForceFeedbackComponent extends unreal.SceneComponent {
	...
	**/
	public function adjust_attenuation(attenuation_settings:unreal.ForceFeedbackAttenuationSettings):Void;
	/**
	...
	**/
	public function set_force_feedback_effect(new_force_feedback_effect:unreal.ForceFeedbackEffect):Void;
	/**
	...
	**/
	public function set_intensity_multiplier(new_intensity_multiplier:Float):Void;
	/**
		x.stop() -> None
