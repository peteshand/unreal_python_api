...
@:pythonImport("unreal", "MovieSceneFolder") extern class MovieSceneFolder extends unreal.Object {
	...
	**/
	public function add_child_folder(folder_to_add:Dynamic):Bool;
	/**
		...
		Returns:
		    bool: True if the addition is successful
	**/
	public function add_child_master_track(master_track:Dynamic):Bool;
	/**
		...
		Returns:
		    bool: True if the addition is successful
	**/
	public function add_child_object_binding(object_binding:Dynamic):Bool;
	/**
	...
	**/
	public function get_child_folders():Dynamic;
	/**
	...
	**/
	public function get_child_master_tracks():Dynamic;
	/**
	...
	**/
	public function get_child_object_bindings():Dynamic;
	/**
	...
	**/
	public function remove_child_folder(folder_to_remove:Dynamic):Bool;
	/**
		...
		Returns:
		    bool: True if the removal succeeds
	**/
	public function remove_child_master_track(master_track:Dynamic):Bool;
	/**
	...
	**/
	public function remove_child_object_binding(object_binding:Dynamic):Bool;
	/**
	...
	**/
	public function set_folder_color(folder_color:Dynamic):Bool;
	/**
	...
	**/
	public function set_folder_name(folder_name:Dynamic):Bool;
}