...
@:pythonImport("unreal", "GameplayTask_ClaimResource") extern class GameplayTask_ClaimResource extends unreal.GameplayTask {
	...
	**/
	static public function claim_resource(task_owner:Dynamic, resource_class:Class<Dynamic>, priority:UInt = 192, task_instance_name:unreal.Name = "\"None\""):unreal.GameplayTask_ClaimResource;
	/**
		...
		Returns:
		    GameplayTask_ClaimResource:
	**/
	static public function claim_resources(task_owner:Dynamic, resource_classes:Array<Dynamic>, priority:UInt = 192, task_instance_name:unreal.Name = "\"None\""):unreal.GameplayTask_ClaimResource;
}