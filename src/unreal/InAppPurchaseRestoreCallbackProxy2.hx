...
@:pythonImport("unreal", "InAppPurchaseRestoreCallbackProxy2") extern class InAppPurchaseRestoreCallbackProxy2 extends unreal.Object {
	...
	**/
	static public function create_proxy_object_for_in_app_purchase_restore(consumable_product_flags:Dynamic, player_controller:Dynamic):unreal.InAppPurchaseRestoreCallbackProxy2;
	/**
