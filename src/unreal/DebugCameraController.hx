...
@:pythonImport("unreal", "DebugCameraController") extern class DebugCameraController extends unreal.PlayerController {
	...
	**/
	public function receive_on_activate(original_pc:unreal.PlayerController):Void;
	/**
		...
		Args:
		    ...
		    hit (HitResult):
	**/
	public function receive_on_actor_selected(new_selected_actor:unreal.Actor, select_hit_location:unreal.Vector, select_hit_normal:unreal.Vector, hit:unreal.HitResult):Void;
	/**
	...
	**/
	public function receive_on_deactivate(restored_pc:unreal.PlayerController):Void;
	/**
	...
	**/
	public function set_pawn_movement_speed_scale(new_speed_scale:Float):Void;
	/**
