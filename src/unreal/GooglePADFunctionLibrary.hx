...
@:pythonImport("unreal", "GooglePADFunctionLibrary") extern class GooglePADFunctionLibrary extends unreal.BlueprintFunctionLibrary {
	/**
		...
		Returns:
		    GooglePADErrorCode:
	**/
	static public function cancel_download(asset_packs:unreal.Array):unreal.GooglePADErrorCode;
	/**
		...
		Returns:
		    ...
		    location (int32):
	**/
	static public function get_asset_pack_location(name:String):Int;
	/**
		...
		Returns:
		    str:
	**/
	static public function get_assets_path(location:Int):String;
	/**
		...
		Returns:
		    int32:
	**/
	static public function get_bytes_downloaded(state:Int):Int;
	/**
		...
		Returns:
		    ...
		    state (int32):
	**/
	static public function get_download_state(name:String):Int;
	/**
	...
	**/
	static public function get_download_status(state:Int):unreal.GooglePADDownloadStatus;
	/**
	...
	**/
	static public function get_storage_method(location:Int):unreal.GooglePADStorageMethod;
	/**
		...
		Returns:
		    int32:
	**/
	static public function get_total_bytes_to_download(state:Int):Int;
	/**
		...
		Args:
		    location (int32):
	**/
	static public function release_asset_pack_location(location:Int):Void;
	/**
		...
		Args:
		    state (int32):
	**/
	static public function release_download_state(state:Int):Void;
	/**
		...
		Returns:
		    GooglePADErrorCode:
	**/
	static public function request_download(asset_packs:unreal.Array):unreal.GooglePADErrorCode;
	/**
		...
		Returns:
		    GooglePADErrorCode:
	**/
	static public function request_info(asset_packs:unreal.Array):unreal.GooglePADErrorCode;
	/**
		...
		Returns:
		    GooglePADErrorCode:
	**/
	static public function request_removal(name:String):unreal.GooglePADErrorCode;
	/**
