...
@:pythonImport("unreal", "AutomationUtilsBlueprintLibrary") extern class AutomationUtilsBlueprintLibrary extends unreal.BlueprintFunctionLibrary {
	...
	**/
	static public function take_gameplay_automation_screenshot(screenshot_name:Dynamic, max_global_error:Dynamic, max_local_error:Dynamic, map_name_override:Dynamic):Void;
}