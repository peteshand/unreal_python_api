...
package unreal;
@:pythonImport("unreal", "ControllerAnalogStick") extern class ControllerAnalogStick {
	static public var CAS_LEFT_STICK : Dynamic;
	static public var CAS_RIGHT_STICK : Dynamic;
	/**
