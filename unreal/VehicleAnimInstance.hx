...
package unreal;
@:pythonImport("unreal", "VehicleAnimInstance") extern class VehicleAnimInstance {
	...
	**/
	...
	/**
		x.get_vehicle() -> WheeledVehicle
		Makes a montage jump to the end of a named section.
		
		Returns:
		    WheeledVehicle:
	**/
	public function get_vehicle(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
