...
package unreal;
@:pythonImport("unreal", "RayTracingGlobalIlluminationType") extern class RayTracingGlobalIlluminationType {
	static public var BRUTE_FORCE : Dynamic;
	static public var DISABLED : Dynamic;
	static public var FINAL_GATHER : Dynamic;
	/**
