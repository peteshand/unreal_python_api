...
package unreal;
@:pythonImport("unreal", "ProceduralFoliageVolume") extern class ProceduralFoliageVolume {
	...
	**/
	...
	/**
		(ProceduralFoliageComponent):  [Read-Only] Procedural Component
	**/
	public var procedural_component : Dynamic;
	/**
