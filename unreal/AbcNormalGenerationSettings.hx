...
package unreal;
@:pythonImport("unreal", "AbcNormalGenerationSettings") extern class AbcNormalGenerationSettings {
	/**
		Return self+value.
	**/
	...
	**/
	public var force_one_smoothing_group_per_object : Dynamic;
	/**
	...
	**/
	public var skip_computing_tangents : Dynamic;
	/**
