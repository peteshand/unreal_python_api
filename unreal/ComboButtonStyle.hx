...
package unreal;
@:pythonImport("unreal", "ComboButtonStyle") extern class ComboButtonStyle {
	/**
		Return self+value.
	**/
	...
	**/
	public var button_style : Dynamic;
	/**
	...
	**/
	public var down_arrow_image : Dynamic;
	/**
