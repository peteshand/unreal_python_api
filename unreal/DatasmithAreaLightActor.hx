...
package unreal;
@:pythonImport("unreal", "DatasmithAreaLightActor") extern class DatasmithAreaLightActor {
	...
	**/
	public var light_shape : Dynamic;
	/**
		(DatasmithAreaLightActorType):  [Read-Write] Light Type
	**/
	public var light_type : Dynamic;
	/**
	...
	**/
	public var spotlight_inner_angle : Dynamic;
	/**
		(float):  [Read-Write] Spotlight Outer Angle
	**/
	public var spotlight_outer_angle : Dynamic;
	/**
