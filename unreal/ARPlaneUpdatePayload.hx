...
package unreal;
@:pythonImport("unreal", "ARPlaneUpdatePayload") extern class ARPlaneUpdatePayload {
	/**
		Return self+value.
	**/
	...
	**/
	public var boundary_vertices : Dynamic;
	/**
	...
	**/
	public var object_classification : Dynamic;
	/**
