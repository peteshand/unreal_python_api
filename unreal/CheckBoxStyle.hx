...
package unreal;
@:pythonImport("unreal", "CheckBoxStyle") extern class CheckBoxStyle {
	/**
		Return self+value.
	**/
	...
	**/
	public var border_background_color : Dynamic;
	/**
	...
	**/
	public var hovered_slate_sound : Dynamic;
	/**
