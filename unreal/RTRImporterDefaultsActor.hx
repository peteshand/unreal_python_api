...
package unreal;
@:pythonImport("unreal", "RTRImporterDefaultsActor") extern class RTRImporterDefaultsActor {
	...
	**/
	...
	/**
		x.call_static_mesh_defaults(signifiers) -> RTRStaticMeshDefaults
		Call Static Mesh Defaults
		
		Args:
		    signifiers (Map(str, str)): 
		
		Returns:
		    RTRStaticMeshDefaults:
	**/
	public function call_static_mesh_defaults(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		x.create_static_mesh_defaults() -> RTRStaticMeshDefaults
		Create Static Mesh Defaults
		
		Returns:
		    RTRStaticMeshDefaults:
	**/
	public function create_static_mesh_defaults(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		(RTRStaticMeshDefaults):  [Read-Write] M Static Mesh Defaults
	**/
	public var m_static_mesh_defaults : Dynamic;
	/**
	...
	**/
	...
	/**
		x.set_lighting_channel(channel0, channel1, channel2) -> LightingChannels
		Set Lighting Channel
		...
		Returns:
		    LightingChannels:
	**/
	public function set_lighting_channel(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		x.static_mesh_defaults(signifiers) -> RTRStaticMeshDefaults
		...
		Returns:
		    RTRStaticMeshDefaults:
	**/
	public function static_mesh_defaults(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
