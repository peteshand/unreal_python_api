...
package unreal;
@:pythonImport("unreal", "ChangeVertexInstancesForPolygon") extern class ChangeVertexInstancesForPolygon {
	/**
		Return self+value.
	**/
	...
	**/
	public var perimeter_vertex_indices_and_instance_i_ds : Dynamic;
	/**
		(PolygonID):  [Read-Write] The polygon to set vertex instances on
	**/
	public var polygon_id : Dynamic;
	/**
	...
	**/
	public var vertex_indices_and_instance_i_ds_for_each_hole : Dynamic;
}