...
package unreal;
@:pythonImport("unreal", "XRMotionControllerData") extern class XRMotionControllerData {
	/**
		Return self+value.
	**/
	...
	**/
	public var aim_position : Dynamic;
	/**
		(Quat):  [Read-Only] Aim Rotation
	**/
	public var aim_rotation : Dynamic;
	/**
		(Guid):  [Read-Only] Application Instance ID
	**/
	public var application_instance_id : Dynamic;
	/**
	...
	**/
	public var device_visual_type : Dynamic;
	/**
	...
	**/
	public var grip_position : Dynamic;
	/**
		(Quat):  [Read-Only] Grip Rotation
	**/
	public var grip_rotation : Dynamic;
	/**
		(ControllerHand):  [Read-Only] Hand Index
	**/
	public var hand_index : Dynamic;
	/**
		(Array(Vector)):  [Read-Only] Hand Key Positions
	**/
	public var hand_key_positions : Dynamic;
	/**
		(Array(float)):  [Read-Only] Hand Key Radii
	**/
	public var hand_key_radii : Dynamic;
	/**
		(Array(Quat)):  [Read-Only] Hand Key Rotations
	**/
	public var hand_key_rotations : Dynamic;
	/**
		(bool):  [Read-Only] Is Grasped
	**/
	public var is_grasped : Dynamic;
	/**
	...
	**/
	public var tracking_status : Dynamic;
	/**
