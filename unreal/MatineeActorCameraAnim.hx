...
package unreal;
@:pythonImport("unreal", "MatineeActorCameraAnim") extern class MatineeActorCameraAnim {
	...
	**/
	public var client_side_only : Dynamic;
	/**
	...
	**/
	public var disable_look_at_input : Dynamic;
	/**
		(bool):  [Read-Write] Disable Input from player during play
	**/
	public var disable_movement_input : Dynamic;
	/**
		(bool):  [Read-Write] If true, disables the realtime radio effect
	**/
	public var disable_radio_filter : Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Args:
		    ...
		    enable (bool):
	**/
	public function enable_group_by_name(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public var hide_hud : Dynamic;
	/**
		(bool):  [Read-Write] Hide Player Pawn during play
	**/
	public var hide_player : Dynamic;
	/**
	...
	**/
	public var interp_position : Dynamic;
	/**
	...
	**/
	public var is_skippable : Dynamic;
	/**
	...
	**/
	public var matinee_data : Dynamic;
	/**
	...
	**/
	public var no_reset_on_rewind : Dynamic;
	/**
	...
	**/
	public var play_on_level_load : Dynamic;
	/**
		(float):  [Read-Write] Time multiplier for playback.
	**/
	public var play_rate : Dynamic;
	/**
	...
	**/
	public var preferred_split_screen_num : Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Args:
		    new_looping (bool):
	**/
	public function set_looping_state(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public var skip_update_if_not_visible : Dynamic;
	/**
