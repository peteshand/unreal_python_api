...
package unreal;
@:pythonImport("unreal", "ReimportCurveTableFactory") extern class ReimportCurveTableFactory {
	...
	**/
	...
	/**
		(CSVImportSettings):  [Read-Write] Automated Import Settings
	**/
	public var automated_import_settings : Dynamic;
	/**
