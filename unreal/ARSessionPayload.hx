...
package unreal;
@:pythonImport("unreal", "ARSessionPayload") extern class ARSessionPayload {
	/**
		Return self+value.
	**/
	...
	**/
	public var config_flags : Dynamic;
	/**
	...
	**/
	public var default_mesh_material : Dynamic;
	/**
		(MaterialInterface):  [Read-Only] Default Wireframe Mesh Material
	**/
	public var default_wireframe_mesh_material : Dynamic;
	/**
