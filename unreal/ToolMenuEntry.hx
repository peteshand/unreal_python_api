...
package unreal;
@:pythonImport("unreal", "ToolMenuEntry") extern class ToolMenuEntry {
	/**
		Return self+value.
	**/
	...
	**/
	public var insert_position : Dynamic;
	/**
	...
	**/
	public var script_object : Dynamic;
	/**
	...
	**/
	public function set_icon(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Args:
		    label (Text):
	**/
	public function set_label(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Args:
		    ...
		    string (str):
	**/
	public function set_string_command(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public var user_interface_action_type : Dynamic;
}