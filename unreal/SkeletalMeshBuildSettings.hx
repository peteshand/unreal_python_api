...
package unreal;
@:pythonImport("unreal", "SkeletalMeshBuildSettings") extern class SkeletalMeshBuildSettings {
	/**
		Return self+value.
	**/
	...
	**/
	public var morph_threshold_position : Dynamic;
	/**
