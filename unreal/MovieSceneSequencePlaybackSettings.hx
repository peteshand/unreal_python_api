...
package unreal;
@:pythonImport("unreal", "MovieSceneSequencePlaybackSettings") extern class MovieSceneSequencePlaybackSettings {
	/**
		Return self+value.
	**/
	...
	**/
	public var disable_camera_cuts : Dynamic;
	/**
