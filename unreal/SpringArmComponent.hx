...
package unreal;
@:pythonImport("unreal", "SpringArmComponent") extern class SpringArmComponent {
	...
	**/
	public var camera_lag_max_distance : Dynamic;
	/**
		(float):  [Read-Write] Max time step used when sub-stepping camera lag.
	**/
	public var camera_lag_max_time_step : Dynamic;
	/**
	...
	**/
	public var camera_lag_speed : Dynamic;
	/**
	...
	**/
	public var camera_rotation_lag_speed : Dynamic;
	/**
	...
	**/
	public var do_collision_test : Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    Rotator:
	**/
	public function get_target_rotation(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    Vector:
	**/
	public function get_unfixed_camera_position(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    bool:
	**/
	public function is_collision_fix_applied(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public var socket_offset : Dynamic;
	/**
	...
	**/
	public var target_arm_length : Dynamic;
	/**
	...
	**/
	public var target_offset : Dynamic;
	/**
	...
	**/
	public var use_camera_lag_substepping : Dynamic;
	/**
		...
		GetTargetRotation(), APawn::GetViewRotation():
	**/
