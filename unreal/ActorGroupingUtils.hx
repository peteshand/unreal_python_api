...
package unreal;
@:pythonImport("unreal", "ActorGroupingUtils") extern class ActorGroupingUtils {
	...
	**/
	public function add_selected_to_group(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    ActorGroupingUtils:
	**/
	static public function get(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function group_actors(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function group_selected(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Returns:
		    bool:
	**/
	static public function is_grouping_active(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		x.lock_selected_groups() -> None
		Locks any groups in the current selection
	**/
	public function lock_selected_groups(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function remove_selected_from_group(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	static public function set_grouping_active(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function ungroup_actors(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		x.ungroup_selected() -> None
		Disbands any groups in the current selection, does not attempt to maintain any hierarchy
	**/
	public function ungroup_selected(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		x.unlock_selected_groups() -> None
		Unlocks any groups in the current selection
	**/
	public function unlock_selected_groups(args:haxe.extern.Rest<Dynamic>):Dynamic;
}