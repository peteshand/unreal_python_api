...
package unreal;
@:pythonImport("unreal", "AnimNode_MultiWayBlend") extern class AnimNode_MultiWayBlend {
	/**
		Return self+value.
	**/
	...
	**/
	public var additive_node : Dynamic;
	/**
	...
	**/
	public var desired_alphas : Dynamic;
	/**
	...
	**/
	public var normalize_alpha : Dynamic;
	/**
		(Array(PoseLink)):  [Read-Write] Poses
	**/
	public var poses : Dynamic;
	/**
