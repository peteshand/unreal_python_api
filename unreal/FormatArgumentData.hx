...
package unreal;
@:pythonImport("unreal", "FormatArgumentData") extern class FormatArgumentData {
	/**
		Return self+value.
	**/
	...
	**/
	public var argument_name : Dynamic;
	/**
		(Text):  [Read-Write] Argument Value
	**/
	public var argument_value : Dynamic;
	/**
		(float):  [Read-Write] Argument Value Float
	**/
	public var argument_value_float : Dynamic;
	/**
		(TextGender):  [Read-Write] Argument Value Gender
	**/
	public var argument_value_gender : Dynamic;
	/**
		(int32):  [Read-Write] Argument Value Int
	**/
	public var argument_value_int : Dynamic;
	/**
		(FormatArgumentType):  [Read-Write] Argument Value Type
	**/
	public var argument_value_type : Dynamic;
	/**
