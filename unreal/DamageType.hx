...
package unreal;
@:pythonImport("unreal", "DamageType") extern class DamageType {
	...
	**/
	public var radial_damage_vel_change : Dynamic;
	/**
	...
	**/
	public var scale_momentum_by_mass : Dynamic;
	/**
