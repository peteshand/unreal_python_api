...
package unreal;
@:pythonImport("unreal", "MovieSceneMediaSection") extern class MovieSceneMediaSection {
	...
	**/
	public var external_media_player : Dynamic;
	/**
	...
	**/
	public var use_external_media_player : Dynamic;
}