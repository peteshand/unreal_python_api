...
package unreal;
@:pythonImport("unreal", "ContentBrowserDataObjectFilter") extern class ContentBrowserDataObjectFilter {
	/**
		Return self+value.
	**/
