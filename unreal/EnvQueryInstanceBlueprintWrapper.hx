...
package unreal;
@:pythonImport("unreal", "EnvQueryInstanceBlueprintWrapper") extern class EnvQueryInstanceBlueprintWrapper {
	...
	**/
	...
	/**
		...
		Returns:
		    float:
	**/
	public function get_item_score(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function get_query_results_as_actors(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function get_query_results_as_locations(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Returns:
		    Array(Actor):
	**/
	public function get_results_as_actors(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Returns:
		    Array(Vector):
	**/
	public function get_results_as_locations(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public var on_query_finished_event : Dynamic;
	/**
		(int32):  [Read-Only] index of query option, that generated items
	**/
	public var option_index : Dynamic;
	/**
		(int32):  [Read-Only] Query ID
	**/
	public var query_id : Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Args:
		    ...
		    value (float):
	**/
	public function set_named_param(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
