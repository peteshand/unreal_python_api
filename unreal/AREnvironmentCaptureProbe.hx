...
package unreal;
@:pythonImport("unreal", "AREnvironmentCaptureProbe") extern class AREnvironmentCaptureProbe {
	...
	**/
	public function get_environment_capture_texture(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		x.get_extent() -> Vector
