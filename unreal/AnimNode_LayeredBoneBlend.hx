...
package unreal;
@:pythonImport("unreal", "AnimNode_LayeredBoneBlend") extern class AnimNode_LayeredBoneBlend {
	/**
		Return self+value.
	**/
	...
	**/
	public var blend_poses : Dynamic;
	/**
		(Array(float)):  [Read-Write] The weights of each layer
	**/
	public var blend_weights : Dynamic;
	/**
	...
	**/
	public var curve_blend_option : Dynamic;
	/**
	...
	**/
	public var mesh_space_rotation_blend : Dynamic;
	/**
		(bool):  [Read-Write] Whether to blend bone scales in mesh space or in local space
	**/
	public var mesh_space_scale_blend : Dynamic;
	/**
