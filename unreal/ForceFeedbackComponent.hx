...
package unreal;
@:pythonImport("unreal", "ForceFeedbackComponent") extern class ForceFeedbackComponent {
	...
	**/
	public var force_feedback_effect : Dynamic;
	/**
	...
	**/
	public var on_force_feedback_finished : Dynamic;
	/**
	...
	**/
	public function set_force_feedback_effect(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function set_intensity_multiplier(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
