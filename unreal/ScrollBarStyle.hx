...
package unreal;
@:pythonImport("unreal", "ScrollBarStyle") extern class ScrollBarStyle {
	/**
		Return self+value.
	**/
	...
	**/
	public var dragged_thumb_image : Dynamic;
	/**
	...
	**/
	public var horizontal_background_image : Dynamic;
	/**
	...
	**/
	public var horizontal_bottom_slot_image : Dynamic;
	/**
