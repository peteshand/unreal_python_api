...
package unreal;
@:pythonImport("unreal", "CheatManager") extern class CheatManager {
	...
	**/
	...
	/**
		...
		Args:
		    f (float):
	**/
	public function change_size(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Args:
		    damage_amount (float):
	**/
	public function damage_target(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function destroy_target(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		x.disable_debug_camera() -> None
		Switch controller from debug camera back to normal controller
	**/
	public function disable_debug_camera(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function enable_debug_camera(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		x.fly() -> None
		Pawn can fly.
	**/
	public function fly(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Args:
		    delay (float):
	**/
	public function freeze_frame(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function ghost(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		x.god() -> None
		Invulnerability cheat.
	**/
	public function god(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function players_only(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function receive_init_cheat_manager(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function slomo(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function walk(args:haxe.extern.Rest<Dynamic>):Dynamic;
}