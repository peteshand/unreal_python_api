...
package unreal;
@:pythonImport("unreal", "SkeletalMaterial") extern class SkeletalMaterial {
	/**
		Return self+value.
	**/
	...
	**/
	public var material_interface : Dynamic;
	/**
	...
	**/
	public var material_slot_name : Dynamic;
	/**
	...
	**/
	public var uv_channel_data : Dynamic;
}