...
package unreal;
@:pythonImport("unreal", "CameraLookatTrackingSettings") extern class CameraLookatTrackingSettings {
	/**
		Return self+value.
	**/
	...
	**/
	public var draw_debug_look_at_tracking_position : Dynamic;
	/**
		(bool):  [Read-Write] True to enable lookat tracking, false otherwise.
	**/
	public var enable_look_at_tracking : Dynamic;
	/**
	...
	**/
	public var look_at_tracking_interp_speed : Dynamic;
	/**
	...
	**/
	public var relative_offset : Dynamic;
	/**
