...
package unreal;
@:pythonImport("unreal", "NiagaraRendererSourceDataMode") extern class NiagaraRendererSourceDataMode {
	static public var EMITTER : Dynamic;
	static public var PARTICLES : Dynamic;
	/**
