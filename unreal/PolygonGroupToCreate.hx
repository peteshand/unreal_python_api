...
package unreal;
@:pythonImport("unreal", "PolygonGroupToCreate") extern class PolygonGroupToCreate {
	/**
		Return self+value.
	**/
	...
	**/
	public var original_polygon_group_id : Dynamic;
	/**
		(MeshElementAttributeList):  [Read-Write] Attributes of this polygon group
	**/
	public var polygon_group_attributes : Dynamic;
	/**
