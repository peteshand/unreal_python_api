...
package unreal;
@:pythonImport("unreal", "FunctionalTestingManager") extern class FunctionalTestingManager {
	...
	**/
	static public function run_all_functional_tests(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
