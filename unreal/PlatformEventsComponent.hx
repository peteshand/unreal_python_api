...
package unreal;
@:pythonImport("unreal", "PlatformEventsComponent") extern class PlatformEventsComponent {
	...
	**/
	public function is_in_laptop_mode(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function is_in_tablet_mode(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public var platform_changed_to_laptop_mode_delegate : Dynamic;
	/**
		(PlatformEventDelegate):  [Read-Write] This is called when a convertible laptop changed into tablet mode.
	**/
	public var platform_changed_to_tablet_mode_delegate : Dynamic;
	/**
	...
	**/
	public function supports_convertible_laptops(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
