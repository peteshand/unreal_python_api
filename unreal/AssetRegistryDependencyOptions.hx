...
package unreal;
@:pythonImport("unreal", "AssetRegistryDependencyOptions") extern class AssetRegistryDependencyOptions {
	/**
		Return self+value.
	**/
	...
	**/
	public var include_hard_management_references : Dynamic;
	/**
	...
	**/
	public var include_hard_package_references : Dynamic;
	/**
		(bool):  [Read-Write] References to specific SearchableNames inside a package
	**/
	public var include_searchable_names : Dynamic;
	/**
