...
package unreal;
@:pythonImport("unreal", "VOIPTalker") extern class VOIPTalker {
	...
	**/
	public function bp_on_talking_begin(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		x.bp_on_talking_end() -> None
		Blueprint native event for when this player stops speaking.
	**/
	public function bp_on_talking_end(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    VOIPTalker:
	**/
	static public function create_talker_for_player(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		x.deactivate() -> None
	...
	**/
	...
	/**
		...
		Returns:
		    float:
	**/
	public function get_voice_level(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Args:
		    owning_state (PlayerState):
	**/
	public function register_with_player_state(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
