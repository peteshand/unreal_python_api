...
package unreal;
@:pythonImport("unreal", "MeshInstancingReplacementMethod") extern class MeshInstancingReplacementMethod {
	static public var KEEP_ORIGINAL_ACTORS_AS_EDITOR_ONLY : Dynamic;
	static public var REMOVE_ORIGINAL_ACTORS : Dynamic;
	/**
