...
package unreal;
@:pythonImport("unreal", "RadialIntMask") extern class RadialIntMask {
	...
	**/
	public var exterior_value : Dynamic;
	/**
	...
	**/
	public var interior_value : Dynamic;
	/**
		x.is_active() -> bool
	...
	**/
	public var set_mask_condition : Dynamic;
	/**
		...
		Returns:
		    RadialIntMask:
	**/
	public function set_radial_int_mask(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
