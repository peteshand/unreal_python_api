...
package unreal;
@:pythonImport("unreal", "SwitchActor") extern class SwitchActor {
	...
	**/
	...
	/**
		...
		Returns:
		    Array(Actor):
	**/
	public function get_options(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Args:
		    option_index (int32):
	**/
	public function select_option(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
