...
package unreal;
@:pythonImport("unreal", "PlanarReflection") extern class PlanarReflection {
	...
	**/
	...
	/**
		...
		Args:
		    enable (bool):
	**/
	public function on_interp_toggle(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public var planar_reflection_component : Dynamic;
	/**
