...
package unreal;
@:pythonImport("unreal", "CompositionGraphCaptureProtocol") extern class CompositionGraphCaptureProtocol {
	...
	**/
	public var capture_frames_in_hdr : Dynamic;
	/**
	...
	**/
	public var capture_gamut : Dynamic;
	/**
	...
	**/
	public var disable_screen_percentage : Dynamic;
	/**
	...
	**/
	public var hdr_compression_quality : Dynamic;
	/**
	...
	**/
	public var include_render_passes : Dynamic;
	/**
		x.is_capturing() -> bool
	...
	**/
	public var post_processing_material : Dynamic;
	/**
