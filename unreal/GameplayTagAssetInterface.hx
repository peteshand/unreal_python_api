...
package unreal;
@:pythonImport("unreal", "GameplayTagAssetInterface") extern class GameplayTagAssetInterface {
	...
	**/
	public function get_owned_gameplay_tags(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function has_all_matching_gameplay_tags(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function has_any_matching_gameplay_tags(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function has_matching_gameplay_tag(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
