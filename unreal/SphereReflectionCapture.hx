...
package unreal;
@:pythonImport("unreal", "SphereReflectionCapture") extern class SphereReflectionCapture {
	...
	**/
	...
	/**
		(ReflectionCaptureComponent):  [Read-Only] Reflection capture component.
	**/
	public var capture_component : Dynamic;
	/**
