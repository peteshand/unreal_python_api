...
package unreal;
@:pythonImport("unreal", "NavDataConfig") extern class NavDataConfig {
	/**
		Return self+value.
	**/
	...
	**/
	public var default_query_extent : Dynamic;
	/**
	...
	**/
	public var preferred_nav_data : Dynamic;
	/**
