...
package unreal;
@:pythonImport("unreal", "ContentBrowserDataClassFilter") extern class ContentBrowserDataClassFilter {
	/**
		Return self+value.
	**/
	...
	**/
	public var class_names_to_exclude : Dynamic;
	/**
		(Array(Name)):  [Read-Write] Array of class names that should be included in this query
	**/
	public var class_names_to_include : Dynamic;
	/**
	...
	**/
	public var recursive_class_names_to_exclude : Dynamic;
	/**
		(bool):  [Read-Write] Whether we should include inclusive sub-classes in this query
	**/
	public var recursive_class_names_to_include : Dynamic;
	/**
