...
package unreal;
@:pythonImport("unreal", "DatasmithImportedSequencesActor") extern class DatasmithImportedSequencesActor {
	...
	**/
	public var imported_sequences : Dynamic;
	/**
	...
	**/
	public function play_level_sequence(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
