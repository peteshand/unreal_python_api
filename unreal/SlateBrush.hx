...
package unreal;
@:pythonImport("unreal", "SlateBrush") extern class SlateBrush {
	/**
		Return self+value.
	**/
	...
	**/
	public var resource_object : Dynamic;
	/**
	...
	**/
	public var tiling : Dynamic;
	/**
		(SlateColor):  [Read-Write] Tinting applied to the image.
	**/
	public var tint_color : Dynamic;
	/**
