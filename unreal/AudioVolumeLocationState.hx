...
package unreal;
@:pythonImport("unreal", "AudioVolumeLocationState") extern class AudioVolumeLocationState {
	static public var INSIDE_THE_VOLUME : Dynamic;
	static public var OUTSIDE_THE_VOLUME : Dynamic;
	/**
