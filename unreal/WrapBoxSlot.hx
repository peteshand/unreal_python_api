...
package unreal;
@:pythonImport("unreal", "WrapBoxSlot") extern class WrapBoxSlot {
	...
	**/
	public var fill_empty_space : Dynamic;
	/**
	...
	**/
	public var fill_span_when_less_than : Dynamic;
	/**
	...
	**/
	public function set_fill_empty_space(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function set_fill_span_when_less_than(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
