...
package unreal;
@:pythonImport("unreal", "SubdividedQuadVertex") extern class SubdividedQuadVertex {
	/**
		Return self+value.
	**/
	...
	**/
	public var texture_coordinate0 : Dynamic;
	/**
		(Vector2D):  [Read-Write] Texture Coordinate 1
	**/
	public var texture_coordinate1 : Dynamic;
	/**
	...
	**/
	public var vertex_binormal_sign : Dynamic;
	/**
	...
	**/
	public var vertex_normal : Dynamic;
	/**
	...
	**/
	public var vertex_position_index : Dynamic;
	/**
		(Vector):  [Read-Write] Quad vertex tangent
	**/
	public var vertex_tangent : Dynamic;
}