...
package unreal;
@:pythonImport("unreal", "MovieSceneCameraShakeSourceTrigger") extern class MovieSceneCameraShakeSourceTrigger {
	/**
		Return self+value.
	**/
	...
	**/
	public var play_scale : Dynamic;
	/**
		(CameraShakePlaySpace):  [Read-Write] Play Space
	**/
	public var play_space : Dynamic;
	/**
	...
	**/
	public var user_defined_play_space : Dynamic;
}