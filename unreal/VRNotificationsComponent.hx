...
package unreal;
@:pythonImport("unreal", "VRNotificationsComponent") extern class VRNotificationsComponent {
	...
	**/
	public var hmd_removed_from_head_delegate : Dynamic;
	/**
	...
	**/
	public var hmd_tracking_initialized_delegate : Dynamic;
	/**
	...
	**/
	public var hmd_tracking_initializing_and_needs_hmd_to_be_tracked_delegate : Dynamic;
	/**
		x.is_active() -> bool
	...
	**/
	public var vr_controller_recentered_delegate : Dynamic;
}