...
package unreal;
@:pythonImport("unreal", "PolygonToCreate") extern class PolygonToCreate {
	/**
		Return self+value.
	**/
	...
	**/
	public var original_polygon_id : Dynamic;
	/**
