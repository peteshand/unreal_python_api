...
package unreal;
@:pythonImport("unreal", "NiagaraDataInterfaceGrid2DCollection") extern class NiagaraDataInterfaceGrid2DCollection {
	...
	**/
	...
	/**
		...
		Returns:
		    ...
		    tiles_y (int32):
	**/
	public function fill_raw_texture2d(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Returns:
		    bool:
	**/
	public function fill_texture2d(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
