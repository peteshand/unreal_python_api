...
package unreal;
@:pythonImport("unreal", "ContentBrowserDataPackageFilter") extern class ContentBrowserDataPackageFilter {
	/**
		Return self+value.
	**/
