...
package unreal;
@:pythonImport("unreal", "ArchVisCharMovementComponent") extern class ArchVisCharMovementComponent {
	...
	**/
	public var max_pitch : Dynamic;
	/**
		(Rotator):  [Read-Only] Fastest possible turn rate
	**/
	public var max_rotational_velocity : Dynamic;
	/**
	...
	**/
	public var walking_acceleration : Dynamic;
	/**
		(float):  [Read-Only] Controls walking deceleration.
	**/
	public var walking_friction : Dynamic;
	/**
		(float):  [Read-Only] How fast the character can walk.
	**/
	public var walking_speed : Dynamic;
	/**
