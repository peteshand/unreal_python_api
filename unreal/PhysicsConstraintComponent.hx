...
@:pythonImport("unreal", "PhysicsConstraintComponent") extern class PhysicsConstraintComponent extends unreal.SceneComponent {
	...
	**/
	public function set_angular_breakable(angular_breakable:Dynamic, angular_break_threshold:Dynamic):Void;
	/**
	...
	**/
	public function set_angular_drive_mode(drive_mode:Dynamic):Void;
	/**
	...
	**/
	public function set_angular_drive_params(position_strength:Dynamic, velocity_strength:Dynamic, force_limit:Dynamic):Void;
	/**
	...
	**/
	public function set_angular_orientation_drive(enable_swing_drive:Dynamic, enable_twist_drive:Dynamic):Void;
	/**
	...
	**/
	public function set_angular_orientation_target(pos_target:Dynamic):Void;
	/**
	...
	**/
	public function set_angular_swing1_limit(motion_type:Dynamic, swing1_limit_angle:Dynamic):Void;
	/**
	...
	**/
	public function set_angular_swing2_limit(motion_type:Dynamic, swing2_limit_angle:Dynamic):Void;
	/**
	...
	**/
	public function set_angular_twist_limit(constraint_type:Dynamic, twist_limit_angle:Dynamic):Void;
	/**
	...
	**/
	public function set_angular_velocity_drive(enable_swing_drive:Dynamic, enable_twist_drive:Dynamic):Void;
	/**
	...
	**/
	public function set_angular_velocity_drive_slerp(enable_slerp:Dynamic):Void;
	/**
		...
		Args:
		    ...
		    enable_swing_drive (bool): Indicates whether the drive for the swing axis should be enabled. Only relevant if the AngularDriveMode is set to Twist and Swing
	**/
	public function set_angular_velocity_drive_twist_and_swing(enable_twist_drive:Dynamic, enable_swing_drive:Dynamic):Void;
	/**
	...
	**/
	public function set_angular_velocity_target(vel_target:Dynamic):Void;
	/**
		...
		Args:
		    ...
		    bone_name2 (Name):
	**/
	public function set_constrained_components(component1:Dynamic, bone_name1:Dynamic, component2:Dynamic, bone_name2:Dynamic):Void;
	/**
		...
		Args:
		    ...
		    ref_frame (Transform):
	**/
	public function set_constraint_reference_frame(frame:Dynamic, ref_frame:Dynamic):Void;
	/**
		...
		Args:
		    ...
		    sec_axis (Vector):
	**/
	public function set_constraint_reference_orientation(frame:Dynamic, pri_axis:Dynamic, sec_axis:Dynamic):Void;
	/**
		...
		Args:
		    ...
		    ref_position (Vector):
	**/
	public function set_constraint_reference_position(frame:Dynamic, ref_position:Dynamic):Void;
	/**
	...
	**/
	public function set_disable_collision(disable_collision:Dynamic):Void;
	/**
	...
	**/
	public function set_linear_breakable(linear_breakable:Dynamic, linear_break_threshold:Dynamic):Void;
	/**
		...
		Args:
		    ...
		    force_limit (float): Max force applied by the drive
	**/
	public function set_linear_drive_params(position_strength:Dynamic, velocity_strength:Dynamic, force_limit:Dynamic):Void;
	/**
	...
	**/
	public function set_linear_position_drive(enable_drive_x:Dynamic, enable_drive_y:Dynamic, enable_drive_z:Dynamic):Void;
	/**
	...
	**/
	public function set_linear_position_target(pos_target:Dynamic):Void;
	/**
		...
		Args:
		    ...
		    enable_drive_z (bool): Indicates whether the drive for the Z-Axis should be enabled
	**/
	public function set_linear_velocity_drive(enable_drive_x:Dynamic, enable_drive_y:Dynamic, enable_drive_z:Dynamic):Void;
	/**
		...
		Args:
		    vel_target (Vector): Target velocity
	**/
	public function set_linear_velocity_target(vel_target:Dynamic):Void;
	/**
	...
	**/
	public function set_linear_x_limit(constraint_type:Dynamic, limit_size:Dynamic):Void;
	/**
		...
		Args:
		    ...
		    limit_size (float): Size of limit
	**/
	public function set_linear_y_limit(constraint_type:Dynamic, limit_size:Dynamic):Void;
	/**
		...
		Args:
		    ...
		    limit_size (float): Size of limit
	**/
	public function set_linear_z_limit(constraint_type:Dynamic, limit_size:Dynamic):Void;
	/**
		...
		Args:
		    enable_slerp (bool): Indicates whether the SLERP drive should be enabled. Only relevant if the AngularDriveMode is set to SLERP
	**/
	public function set_orientation_drive_slerp(enable_slerp:Dynamic):Void;
	/**
		...
		Args:
		    ...
		    enable_swing_drive (bool): Indicates whether the drive for the swing axis should be enabled. Only relevant if the AngularDriveMode is set to Twist and Swing
	**/
	public function set_orientation_drive_twist_and_swing(enable_twist_drive:Dynamic, enable_swing_drive:Dynamic):Void;
}