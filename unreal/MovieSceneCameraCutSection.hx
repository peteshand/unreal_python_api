...
package unreal;
@:pythonImport("unreal", "MovieSceneCameraCutSection") extern class MovieSceneCameraCutSection {
	...
	**/
	public function get_camera_binding_id(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function set_camera_binding_id(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
