...
package unreal;
@:pythonImport("unreal", "ButtonStyle") extern class ButtonStyle {
	/**
		Return self+value.
	**/
	...
	**/
	public var normal_padding : Dynamic;
	/**
	...
	**/
	public var pressed_padding : Dynamic;
	/**
		(SlateSound):  [Read-Write] The sound the button should play when pressed
	**/
	public var pressed_slate_sound : Dynamic;
	/**
