...
@:pythonImport("unreal", "MeshVertexPainterLibrary") extern class MeshVertexPainterLibrary {
	...
	**/
	public function paint_vertices_lerp_along_axis(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Args:
		    ...
		    convert_to_srgb (bool):
	**/
	public function paint_vertices_single_color(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Args:
		    static_mesh_component (StaticMeshComponent):
	**/
	public function remove_painted_vertices(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
