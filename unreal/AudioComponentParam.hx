...
package unreal;
@:pythonImport("unreal", "AudioComponentParam") extern class AudioComponentParam {
	/**
		Return self+value.
	**/
	...
	**/
	public var float_param : Dynamic;
	/**
	...
	**/
	public var int_param : Dynamic;
	/**
		(Name):  [Read-Write] Name of the parameter
	**/
	public var param_name : Dynamic;
	/**
	...
	**/
	public var sound_wave_param : Dynamic;
	/**
