...
package unreal;
@:pythonImport("unreal", "AnimSharingTransitionInstance") extern class AnimSharingTransitionInstance {
	...
	**/
	public var from_component : Dynamic;
	/**
	...
	**/
	public var to_component : Dynamic;
	/**
