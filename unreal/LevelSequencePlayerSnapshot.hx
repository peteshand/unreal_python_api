...
package unreal;
@:pythonImport("unreal", "LevelSequencePlayerSnapshot") extern class LevelSequencePlayerSnapshot {
	/**
		Return self+value.
	**/
	...
	**/
	public var active_shot : Dynamic;
	/**
	...
	**/
	public var camera_component : Dynamic;
	/**
	...
	**/
	public var current_shot_local_time : Dynamic;
	/**
		(str):  [Read-Only] Current Shot Name
	**/
	public var current_shot_name : Dynamic;
	/**
		(QualifiedTime):  [Read-Only] Current Shot Source Time
	**/
	public var current_shot_source_time : Dynamic;
	/**
	...
	**/
	public var master_name : Dynamic;
	/**
		(QualifiedTime):  [Read-Only] Master Time
	**/
	public var master_time : Dynamic;
	/**
	...
	**/
	public var source_time : Dynamic;
	/**
		(str):  [Read-Only] Source Timecode
	**/
	public var source_timecode : Dynamic;
	/**
