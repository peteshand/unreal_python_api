...
package unreal;
@:pythonImport("unreal", "FieldCullingOperationType") extern class FieldCullingOperationType {
	static public var FIELD_CULLING_INSIDE : Dynamic;
	static public var FIELD_CULLING_OUTSIDE : Dynamic;
	/**
