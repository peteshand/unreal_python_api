...
package unreal;
@:pythonImport("unreal", "MatineeCameraShake") extern class MatineeCameraShake {
	...
	**/
	public function blueprint_update_camera_shake(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public var fov_oscillation : Dynamic;
	/**
	...
	**/
	public var loc_oscillation : Dynamic;
	/**
	...
	**/
	public var oscillator_time_remaining : Dynamic;
	/**
		...
		Returns:
		    bool:
	**/
	public function receive_is_finished(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Args:
		    scale (float):
	**/
	public function receive_play_shake(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Args:
		    immediately (bool):
	**/
	public function receive_stop_shake(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public var rot_oscillation : Dynamic;
	/**
	...
	**/
	public var shake_scale : Dynamic;
	/**
