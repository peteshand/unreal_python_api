...
package unreal;
@:pythonImport("unreal", "PaperTileSet") extern class PaperTileSet {
	...
	**/
	public var border_margin : Dynamic;
	/**
	...
	**/
	public var drawing_offset : Dynamic;
	/**
	...
	**/
	public var per_tile_spacing : Dynamic;
	/**
