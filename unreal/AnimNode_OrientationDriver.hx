...
package unreal;
@:pythonImport("unreal", "AnimNode_OrientationDriver") extern class AnimNode_OrientationDriver {
	/**
		Return self+value.
	**/
	...
	**/
	public var source_pose : Dynamic;
	/**
