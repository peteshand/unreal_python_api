...
package unreal;
@:pythonImport("unreal", "NiagaraActor") extern class NiagaraActor {
	...
	**/
	public var niagara_component : Dynamic;
	/**
	...
	**/
	public function set_destroy_on_system_finish(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
