...
package unreal;
@:pythonImport("unreal", "MovieScene3DAttachSection") extern class MovieScene3DAttachSection {
	...
	**/
	public var attach_component_name : Dynamic;
	/**
		(Name):  [Read-Write] Attach Socket Name
	**/
	public var attach_socket_name : Dynamic;
	/**
		(AttachmentRule):  [Read-Write] Attachment Location Rule
	**/
	public var attachment_location_rule : Dynamic;
	/**
		(AttachmentRule):  [Read-Write] Attachment Rotation Rule
	**/
	public var attachment_rotation_rule : Dynamic;
	/**
		(AttachmentRule):  [Read-Write] Attachment Scale Rule
	**/
	public var attachment_scale_rule : Dynamic;
	/**
	...
	**/
	public var detachment_location_rule : Dynamic;
	/**
		(DetachmentRule):  [Read-Write] Detachment Rotation Rule
	**/
	public var detachment_rotation_rule : Dynamic;
	/**
		(DetachmentRule):  [Read-Write] Detachment Scale Rule
	**/
	public var detachment_scale_rule : Dynamic;
	/**
	...
	**/
	public function get_constraint_binding_id(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function set_constraint_binding_id(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
