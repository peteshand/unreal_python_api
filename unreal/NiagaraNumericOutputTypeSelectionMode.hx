...
package unreal;
@:pythonImport("unreal", "NiagaraNumericOutputTypeSelectionMode") extern class NiagaraNumericOutputTypeSelectionMode {
	static public var LARGEST : Dynamic;
	static public var SCALAR : Dynamic;
	static public var SMALLEST : Dynamic;
	/**
