...
package unreal;
@:pythonImport("unreal", "LevelVisibilityDirtyMode") extern class LevelVisibilityDirtyMode {
	static public var DONT_MODIFY : Dynamic;
	static public var MODIFY_ON_CHANGE : Dynamic;
	/**
