...
package unreal;
@:pythonImport("unreal", "UniformGridPanel") extern class UniformGridPanel {
	...
	**/
	...
	/**
		...
		Returns:
		    UniformGridSlot:
	**/
	public function add_child_to_uniform_grid(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public var min_desired_slot_height : Dynamic;
	/**
		(float):  [Read-Only] The minimum desired width of the slots
	**/
	public var min_desired_slot_width : Dynamic;
	/**
	...
	**/
	public function set_min_desired_slot_height(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function set_min_desired_slot_width(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Args:
		    slot_padding (Margin):
	**/
	public function set_slot_padding(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public var slot_padding : Dynamic;
	/**
