...
package unreal;
@:pythonImport("unreal", "DecalComponent") extern class DecalComponent {
	...
	**/
	public function create_mid_for_decal(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		x.deactivate() -> None
	...
	**/
	public var decal_material : Dynamic;
	/**
	...
	**/
	public var destroy_owner_after_fade : Dynamic;
	/**
	...
	**/
	public var fade_duration : Dynamic;
	/**
		(float):  [Read-Only] Fade in Duration
	**/
	public var fade_in_duration : Dynamic;
	/**
		(float):  [Read-Only] Fade in Start Delay
	**/
	public var fade_in_start_delay : Dynamic;
	/**
		(float):  [Read-Only] Fade Screen Size
	**/
	public var fade_screen_size : Dynamic;
	/**
	...
	**/
	public var fade_start_delay : Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    MaterialInterface:
	**/
	public function get_decal_material(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    float:
	**/
	public function get_fade_duration(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Returns:
		    float:
	**/
	public function get_fade_in_duration(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Returns:
		    float:
	**/
	public function get_fade_in_start_delay(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Returns:
		    float:
	**/
	public function get_fade_start_delay(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function set_decal_material(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Args:
		    ...
		    duaration (float):
	**/
	public function set_fade_in(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function set_fade_out(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function set_fade_screen_size(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Args:
		    value (int32):
	**/
	public function set_sort_order(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
