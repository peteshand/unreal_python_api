...
package unreal;
@:pythonImport("unreal", "NiagaraSpawnInfo") extern class NiagaraSpawnInfo {
	/**
		Return self+value.
	**/
	...
	**/
	public var interp_start_dt : Dynamic;
	/**
		(float):  [Read-Write] The sub frame delta time between each particle.
	**/
	public var interval_dt : Dynamic;
	/**
	...
	**/
	public var spawn_group : Dynamic;
	/**
