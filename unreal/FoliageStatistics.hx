...
package unreal;
@:pythonImport("unreal", "FoliageStatistics") extern class FoliageStatistics {
	...
	**/
	...
	/**
		...
		Returns:
		    int32:
	**/
	static public function foliage_overlapping_box_count(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Returns:
		    int32:
	**/
	static public function foliage_overlapping_sphere_count(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
