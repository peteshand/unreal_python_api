...
package unreal;
@:pythonImport("unreal", "PainCausingVolume") extern class PainCausingVolume {
	...
	**/
	public var damage_per_sec : Dynamic;
	/**
	...
	**/
	public var fluid_friction : Dynamic;
	/**
	...
	**/
	public var physics_on_contact : Dynamic;
	/**
	...
	**/
	public var terminal_velocity : Dynamic;
	/**
	...
	**/
	public var water_volume : Dynamic;
}