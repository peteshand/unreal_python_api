...
package unreal;
@:pythonImport("unreal", "FindFloorResult") extern class FindFloorResult {
	/**
		Return self+value.
	**/
	...
	**/
	public var blocking_hit : Dynamic;
	/**
	...
	**/
	public var walkable_floor : Dynamic;
}