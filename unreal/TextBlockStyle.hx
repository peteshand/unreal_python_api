...
package unreal;
@:pythonImport("unreal", "TextBlockStyle") extern class TextBlockStyle {
	/**
		Return self+value.
	**/
	...
	**/
	public var highlight_color : Dynamic;
	/**
		(SlateBrush):  [Read-Write] The shape of highlighted text
	**/
	public var highlight_shape : Dynamic;
	/**
	...
	**/
	public var underline_brush : Dynamic;
}