...
package unreal;
@:pythonImport("unreal", "VirtualKeyboardTrigger") extern class VirtualKeyboardTrigger {
	static public var ON_ALL_FOCUS_EVENTS : Dynamic;
	static public var ON_FOCUS_BY_POINTER : Dynamic;
	/**
