...
package unreal;
@:pythonImport("unreal", "DownloadProgressStruct") extern class DownloadProgressStruct {
	/**
		Return self+value.
	**/
	...
	**/
	public var current_download : Dynamic;
	/**
		(float):  [Read-Only] Download Speed
	**/
	public var download_speed : Dynamic;
	/**
	...
	**/
	public var total_download : Dynamic;
}