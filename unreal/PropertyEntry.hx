...
package unreal;
@:pythonImport("unreal", "PropertyEntry") extern class PropertyEntry {
	/**
		Return self+value.
	**/
	...
	**/
	public var custom_size : Dynamic;
	/**
