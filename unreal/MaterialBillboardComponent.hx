...
package unreal;
@:pythonImport("unreal", "MaterialBillboardComponent") extern class MaterialBillboardComponent {
	...
	**/
	public function add_element(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function set_elements(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
