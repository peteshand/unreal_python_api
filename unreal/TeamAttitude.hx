...
package unreal;
@:pythonImport("unreal", "TeamAttitude") extern class TeamAttitude {
	static public var FRIENDLY : Dynamic;
	static public var HOSTILE : Dynamic;
	static public var NEUTRAL : Dynamic;
	/**
