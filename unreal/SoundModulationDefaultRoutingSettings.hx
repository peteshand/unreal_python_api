...
package unreal;
@:pythonImport("unreal", "SoundModulationDefaultRoutingSettings") extern class SoundModulationDefaultRoutingSettings {
	/**
		Return self+value.
	**/
	...
	**/
	public var volume_modulation_destination : Dynamic;
	/**
		(ModulationRouting):  [Read-Write] What volume modulation settings to use
	**/
	public var volume_routing : Dynamic;
}