...
package unreal;
@:pythonImport("unreal", "SafeZoneSlot") extern class SafeZoneSlot {
	...
	**/
	public var h_align : Dynamic;
	/**
		(bool):  [Read-Only] Is Title Safe
	**/
	public var is_title_safe : Dynamic;
	/**
	...
	**/
	public var safe_area_scale : Dynamic;
	/**
