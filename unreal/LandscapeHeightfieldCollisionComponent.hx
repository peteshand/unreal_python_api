...
package unreal;
@:pythonImport("unreal", "LandscapeHeightfieldCollisionComponent") extern class LandscapeHeightfieldCollisionComponent {
	...
	**/
	...
	/**
		...
		Returns:
		    LandscapeComponent:
	**/
	public function get_render_component(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
