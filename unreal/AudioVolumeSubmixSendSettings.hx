...
package unreal;
@:pythonImport("unreal", "AudioVolumeSubmixSendSettings") extern class AudioVolumeSubmixSendSettings {
	/**
		Return self+value.
	**/
	...
	**/
	public var listener_location_state : Dynamic;
	/**
	...
	**/
	public var submix_sends : Dynamic;
	/**
