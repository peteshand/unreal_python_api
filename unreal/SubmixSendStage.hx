...
package unreal;
@:pythonImport("unreal", "SubmixSendStage") extern class SubmixSendStage {
	static public var POST_DISTANCE_ATTENUATION : Dynamic;
	static public var PRE_DISTANCE_ATTENUATION : Dynamic;
	/**
