...
package unreal;
@:pythonImport("unreal", "ARGeoAnchorComponent") extern class ARGeoAnchorComponent {
	...
	**/
	static public function set_geo_anchor_component_debug_mode(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
