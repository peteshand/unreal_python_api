...
package unreal;
@:pythonImport("unreal", "SoundWaveSpectralDataPerSound") extern class SoundWaveSpectralDataPerSound {
	/**
		Return self+value.
	**/
	...
	**/
	public var playback_time : Dynamic;
	/**
