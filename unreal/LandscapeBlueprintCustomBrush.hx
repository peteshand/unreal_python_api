...
package unreal;
@:pythonImport("unreal", "LandscapeBlueprintCustomBrush") extern class LandscapeBlueprintCustomBrush {
	...
	**/
	public var affect_heightmap : Dynamic;
	/**
		(bool):  [Read-Write] Affect Weightmap
	**/
	public var affect_weightmap : Dynamic;
	/**
		(Array(Name)):  [Read-Write] Affected Weightmap Layers
	**/
	public var affected_weightmap_layers : Dynamic;
	/**
	...
	**/
	public function get_blueprint_render_dependencies(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function request_landscape_update(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
