...
package unreal;
@:pythonImport("unreal", "PendingDelayedSpawn") extern class PendingDelayedSpawn {
	/**
		Return self+value.
	**/
	...
	**/
	public var behavior_tree : Dynamic;
	/**
	...
	**/
	public var number_to_spawn : Dynamic;
	/**
	...
	**/
	public var pre_spawn_delay : Dynamic;
	/**
	...
	**/
	public var spawn_delay : Dynamic;
	/**
		(Actor):  [Read-Write] Where should AI be spawned
	**/
	public var spawn_location : Dynamic;
	/**
