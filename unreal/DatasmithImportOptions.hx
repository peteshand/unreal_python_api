...
package unreal;
@:pythonImport("unreal", "DatasmithImportOptions") extern class DatasmithImportOptions {
	...
	**/
	public var base_options : Dynamic;
	/**
	...
	**/
	public var reimport_options : Dynamic;
	/**
