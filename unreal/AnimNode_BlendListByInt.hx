...
package unreal;
@:pythonImport("unreal", "AnimNode_BlendListByInt") extern class AnimNode_BlendListByInt {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		(int32):  [Read-Write] Active Child Index
	**/
	public var active_child_index : Dynamic;
	/**
	...
	**/
	public var blend_pose : Dynamic;
	/**
		(Array(float)):  [Read-Write] Blend Time
	**/
	public var blend_time : Dynamic;
	/**
	...
	**/
	public var transition_type : Dynamic;
}