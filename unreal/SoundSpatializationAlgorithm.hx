...
package unreal;
@:pythonImport("unreal", "SoundSpatializationAlgorithm") extern class SoundSpatializationAlgorithm {
	static public var SPATIALIZATION_DEFAULT : Dynamic;
	static public var SPATIALIZATION_HRTF : Dynamic;
	/**
