...
package unreal;
@:pythonImport("unreal", "AnimNode_CopyPoseFromMesh") extern class AnimNode_CopyPoseFromMesh {
	/**
		Return self+value.
	**/
	...
	**/
	public var copy_curves : Dynamic;
	/**
		(bool):  [Read-Write] Copy custom attributes from SouceMeshComponent
	**/
	public var copy_custom_attributes : Dynamic;
	/**
	...
	**/
	public var root_bone_to_copy : Dynamic;
	/**
	...
	**/
	public var source_mesh_component : Dynamic;
	/**
	...
	**/
	public var use_attached_parent : Dynamic;
	/**
	...
	**/
	public var use_mesh_pose : Dynamic;
}