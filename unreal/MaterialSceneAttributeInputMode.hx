...
package unreal;
@:pythonImport("unreal", "MaterialSceneAttributeInputMode") extern class MaterialSceneAttributeInputMode {
	static public var COORDINATES : Dynamic;
	static public var OFFSET_FRACTION : Dynamic;
	/**
