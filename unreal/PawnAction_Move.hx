...
package unreal;
@:pythonImport("unreal", "PawnAction_Move") extern class PawnAction_Move {
	...
	**/
	public var acceptable_radius : Dynamic;
	/**
	...
	**/
	public var goal_actor : Dynamic;
	/**
		(Vector):  [Read-Write] Goal Location
	**/
	public var goal_location : Dynamic;
	/**
