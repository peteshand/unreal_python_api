...
package unreal;
@:pythonImport("unreal", "JsonViewpoint") extern class JsonViewpoint {
	...
	**/
	public function build_from_json_string(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		x.build_json() -> str
		Build JSON
		...
		Returns:
		    str:
	**/
	public function build_json(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public var callback_delegate : Dynamic;
	/**
	...
	**/
	public var invert : Dynamic;
	/**
		(Vector):  [Read-Write] Max Limits
	**/
	public var max_limits : Dynamic;
	/**
		(Vector):  [Read-Write] Min Limits
	**/
	public var min_limits : Dynamic;
	/**
	...
	**/
	public var offset_applied : Dynamic;
	/**
