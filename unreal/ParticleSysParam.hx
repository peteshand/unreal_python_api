...
package unreal;
@:pythonImport("unreal", "ParticleSysParam") extern class ParticleSysParam {
	/**
		Return self+value.
	**/
	...
	**/
	public var param_type : Dynamic;
	/**
		(float):  [Read-Write] Scalar
	**/
	public var scalar : Dynamic;
	/**
		(float):  [Read-Write] Scalar Low
	**/
	public var scalar_low : Dynamic;
	/**
