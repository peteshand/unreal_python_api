...
package unreal;
@:pythonImport("unreal", "CameraAnimInst") extern class CameraAnimInst {
	...
	**/
	...
	/**
		...
		Args:
		    new_duration (float):
	**/
	public function set_duration(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Args:
		    new_duration (float):
	**/
	public function set_scale(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
