...
package unreal;
@:pythonImport("unreal", "AnimNode_MakeDynamicAdditive") extern class AnimNode_MakeDynamicAdditive {
	/**
		Return self+value.
	**/
	...
	**/
	public var mesh_space_additive : Dynamic;
	/**
