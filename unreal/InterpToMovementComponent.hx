...
package unreal;
@:pythonImport("unreal", "InterpToMovementComponent") extern class InterpToMovementComponent {
	...
	**/
	public var behaviour_type : Dynamic;
	/**
	...
	**/
	public var check_if_still_in_world : Dynamic;
	/**
	...
	**/
	public function finalise_control_points(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public var pause_on_impact : Dynamic;
	/**
	...
	**/
	public function restart_movement(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public var sweep : Dynamic;
	/**
		(TeleportType):  [Read-Write] Physics teleport type.
	**/
	public var teleport_type : Dynamic;
	/**
