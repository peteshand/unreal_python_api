...
package unreal;
@:pythonImport("unreal", "SoundClassAdjuster") extern class SoundClassAdjuster {
	/**
		Return self+value.
	**/
	...
	**/
	public var apply_to_children : Dynamic;
	/**
	...
	**/
	public var pitch_adjuster : Dynamic;
	/**
	...
	**/
	public var sound_class_object : Dynamic;
	/**
	...
	**/
	public var voice_center_channel_volume_adjuster : Dynamic;
	/**
		(float):  [Read-Only] A multiplier applied to the volume.
	**/
	public var volume_adjuster : Dynamic;
}