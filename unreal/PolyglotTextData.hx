...
package unreal;
@:pythonImport("unreal", "PolyglotTextData") extern class PolyglotTextData {
	/**
		Return self+value.
	**/
	...
	**/
	public var is_minimal_patch : Dynamic;
	/**
	...
	**/
	public var native_culture : Dynamic;
	/**
	...
	**/
	public var native_string : Dynamic;
	/**
