...
package unreal;
@:pythonImport("unreal", "ArrowComponent") extern class ArrowComponent {
	...
	**/
	public var is_screen_size_scaled : Dynamic;
	/**
	...
	**/
	public function set_arrow_color(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		deprecated: 'set_arrow_color_new' was renamed to 'set_arrow_color'.
	**/
	public function set_arrow_color_new(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public var treat_as_a_sprite : Dynamic;
	/**
	...
	**/
	public var use_in_editor_scaling : Dynamic;
	/**
