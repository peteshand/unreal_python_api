...
package unreal;
@:pythonImport("unreal", "ViewTargetTransitionParams") extern class ViewTargetTransitionParams {
	/**
		Return self+value.
	**/
	...
	**/
	public var lock_outgoing : Dynamic;
	/**
