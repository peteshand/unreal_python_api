...
package unreal;
@:pythonImport("unreal", "AnimAssetCurveFlags") extern class AnimAssetCurveFlags {
	static public var AACF_EDITABLE : Dynamic;
	static public var AACF_METADATA : Dynamic;
	/**
