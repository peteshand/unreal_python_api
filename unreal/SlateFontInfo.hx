...
package unreal;
@:pythonImport("unreal", "SlateFontInfo") extern class SlateFontInfo {
	/**
		Return self+value.
	**/
	...
	**/
	public var typeface_font_name : Dynamic;
}