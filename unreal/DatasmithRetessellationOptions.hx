...
package unreal;
@:pythonImport("unreal", "DatasmithRetessellationOptions") extern class DatasmithRetessellationOptions {
	/**
		Return self+value.
	**/
	...
	**/
	public var chord_tolerance : Dynamic;
	/**
	...
	**/
	public var stitching_technique : Dynamic;
	/**
