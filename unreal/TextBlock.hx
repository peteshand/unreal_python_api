...
package unreal;
@:pythonImport("unreal", "TextBlock") extern class TextBlock {
	...
	**/
	...
	/**
		(bool):  [Read-Write] Whether the text should automatically wrap
		deprecated: bAutoWrapText is deprecated. Please use AutoWrapText instead.
	**/
	public var auto_wrap_text : Dynamic;
	/**
	...
	**/
	public function get_dynamic_font_material(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Returns:
		    MaterialInstanceDynamic:
	**/
	public function get_dynamic_outline_material(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function get_text(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public var justification : Dynamic;
	/**
		(float):  [Read-Only] The amount to scale each lines height by.
	**/
	public var line_height_percentage : Dynamic;
	/**
	...
	**/
	public function set_auto_wrap_text(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function set_font(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function set_shadow_color_and_opacity(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function set_shadow_offset(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function set_strike_brush(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function set_text_transform_policy(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public var simple_text_mode : Dynamic;
	/**
