...
package unreal;
@:pythonImport("unreal", "LandscapeSplinesComponent") extern class LandscapeSplinesComponent {
	...
	**/
	public function get_spline_mesh_components(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
