...
package unreal;
@:pythonImport("unreal", "AnimNode_RotateRootBone") extern class AnimNode_RotateRootBone {
	/**
		Return self+value.
	**/
	...
	**/
	public var mesh_to_component : Dynamic;
	/**
	...
	**/
	public var pitch_scale_bias_clamp : Dynamic;
	/**
	...
	**/
	public var yaw_scale_bias_clamp : Dynamic;
}