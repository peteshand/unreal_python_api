...
package unreal;
@:pythonImport("unreal", "AnimNode_Trail") extern class AnimNode_Trail {
	/**
		Return self+value.
	**/
	...
	**/
	public var relaxation_speed_scale : Dynamic;
	/**
		(InputScaleBiasClamp):  [Read-Write] Relaxation Speed Scale Input Processor
	**/
	public var relaxation_speed_scale_input_processor : Dynamic;
	/**
		(Array(Vector)):  [Read-Write] Rotation Offsets
	**/
	public var rotation_offsets : Dynamic;
	/**
