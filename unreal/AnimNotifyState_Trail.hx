...
package unreal;
@:pythonImport("unreal", "AnimNotifyState_Trail") extern class AnimNotifyState_Trail {
	...
	**/
	public var first_socket_name : Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    str:
	**/
	public function get_notify_name(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public var notify_color : Dynamic;
	/**
		...
		Returns:
		    ParticleSystem:
	**/
	public function override_ps_template(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		(ParticleSystem):  [Read-Only] The particle system to use for this trail.
	**/
	public var ps_template : Dynamic;
	/**
		...
		Returns:
		    bool:
	**/
	public function received_notify_begin(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Returns:
		    bool:
	**/
	public function received_notify_end(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Returns:
		    bool:
	**/
	public function received_notify_tick(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		(bool):  [Read-Only] Recycle Spawned Systems
	**/
	public var recycle_spawned_systems : Dynamic;
	/**
	...
	**/
	public var second_socket_name : Dynamic;
	/**
	...
	**/
	public var width_scale_curve : Dynamic;
	/**
	...
	**/
	public var width_scale_mode : Dynamic;
}