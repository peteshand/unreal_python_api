...
package unreal;
@:pythonImport("unreal", "MovieScene3DPathSection_Axis") extern class MovieScene3DPathSection_Axis {
	static public var NEG_X : Dynamic;
	static public var NEG_Y : Dynamic;
	static public var NEG_Z : Dynamic;
