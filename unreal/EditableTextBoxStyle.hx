...
package unreal;
@:pythonImport("unreal", "EditableTextBoxStyle") extern class EditableTextBoxStyle {
	/**
		Return self+value.
	**/
	...
	**/
	public var h_scroll_bar_padding : Dynamic;
	/**
	...
	**/
	public var read_only_foreground_color : Dynamic;
	/**
		(ScrollBarStyle):  [Read-Write] Style used for the scrollbars
	**/
	public var scroll_bar_style : Dynamic;
	/**
	...
	**/
	public var v_scroll_bar_padding : Dynamic;
}