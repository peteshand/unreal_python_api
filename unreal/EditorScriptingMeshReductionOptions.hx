...
package unreal;
@:pythonImport("unreal", "EditorScriptingMeshReductionOptions") extern class EditorScriptingMeshReductionOptions {
	/**
		Return self+value.
	**/
	...
	**/
	public var auto_compute_lod_screen_size : Dynamic;
	/**
	...
	**/
	public var reduction_settings : Dynamic;
	/**
