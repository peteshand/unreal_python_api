...
package unreal;
@:pythonImport("unreal", "AtmosphericFog") extern class AtmosphericFog {
	...
	**/
	...
	/**
		(AtmosphericFogComponent):  [Read-Only] Main fog component
	**/
	public var atmospheric_fog_component : Dynamic;
	/**
