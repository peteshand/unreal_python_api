...
@:pythonImport("unreal", "AISense_Prediction") extern class AISense_Prediction {
	...
	**/
	public function request_controller_prediction_event(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Args:
		    ...
		    prediction_time (float):
	**/
	public function request_pawn_prediction_event(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
