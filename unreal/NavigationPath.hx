...
@:pythonImport("unreal", "NavigationPath") extern class NavigationPath extends unreal.Object {
	...
	**/
	public function enable_debug_drawing(should_draw_debug_data:Dynamic, path_color:Dynamic):Void;
	/**
	...
	**/
	public function enable_recalculation_on_invalidation(do_recalculation:Dynamic):Void;
	/**
