...
package unreal;
@:pythonImport("unreal", "NavigationPath") extern class NavigationPath {
	...
	**/
	public function enable_debug_drawing(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function enable_recalculation_on_invalidation(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    str:
	**/
	public function get_debug_string(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function get_path_lenght(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    bool:
	**/
	public function is_partial(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Returns:
		    bool:
	**/
	public function is_string_pulled(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		x.is_valid() -> bool
		Is Valid
	...
	**/
	public var path_points : Dynamic;
	/**
		(OnNavigationPathUpdated):  [Read-Write] Path Updated Notifier
	**/
	public var path_updated_notifier : Dynamic;
	/**
		(NavigationOptionFlag):  [Read-Only] Recalculate on Invalidation
	**/
	public var recalculate_on_invalidation : Dynamic;
	/**
