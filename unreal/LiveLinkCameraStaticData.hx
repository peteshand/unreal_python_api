...
package unreal;
@:pythonImport("unreal", "LiveLinkCameraStaticData") extern class LiveLinkCameraStaticData {
	/**
		Return self+value.
	**/
	...
	**/
	public var film_back_height : Dynamic;
	/**
		(float):  [Read-Write] Used with CinematicCamera. Values greater than 0 will be applied
	**/
	public var film_back_width : Dynamic;
	/**
