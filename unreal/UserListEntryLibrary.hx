...
package unreal;
@:pythonImport("unreal", "UserListEntryLibrary") extern class UserListEntryLibrary {
	...
	**/
	...
	/**
		...
		Returns:
		    ListViewBase:
	**/
	static public function get_owning_list_view(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    bool:
	**/
	static public function is_list_item_expanded(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Returns:
		    bool:
	**/
	static public function is_list_item_selected(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
