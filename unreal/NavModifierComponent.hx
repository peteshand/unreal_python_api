...
package unreal;
@:pythonImport("unreal", "NavModifierComponent") extern class NavModifierComponent {
	...
	**/
	public function set_area_class(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		x.set_navigation_relevancy(relevant) -> None
		Set Navigation Relevancy
		
		Args:
		    relevant (bool):
	**/
	public function set_navigation_relevancy(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
