...
package unreal;
@:pythonImport("unreal", "MediaAudioCaptureDeviceFilter") extern class MediaAudioCaptureDeviceFilter {
	static public var CARD : Dynamic;
	static public var MICROPHONE : Dynamic;
	static public var SOFTWARE : Dynamic;
