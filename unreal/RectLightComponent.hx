...
package unreal;
@:pythonImport("unreal", "RectLightComponent") extern class RectLightComponent {
	...
	**/
	public var barn_door_angle : Dynamic;
	/**
		(float):  [Read-Only] Length of barn door attached to the light source rect.
	**/
	public var barn_door_length : Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    float:
	**/
	public function get_units_conversion_factor(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Args:
		    new_value (float):
	**/
	public function set_barn_door_angle(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Args:
		    new_value (float):
	**/
	public function set_barn_door_length(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Args:
		    new_value (float):
	**/
	public function set_source_height(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Args:
		    new_value (Texture):
	**/
	public function set_source_texture(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Args:
		    new_value (float):
	**/
	public function set_source_width(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
