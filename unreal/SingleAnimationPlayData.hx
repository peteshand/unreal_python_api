...
package unreal;
@:pythonImport("unreal", "SingleAnimationPlayData") extern class SingleAnimationPlayData {
	/**
		Return self+value.
	**/
	...
	**/
	public var anim_to_play : Dynamic;
	/**
