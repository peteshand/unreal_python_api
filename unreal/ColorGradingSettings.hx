...
package unreal;
@:pythonImport("unreal", "ColorGradingSettings") extern class ColorGradingSettings {
	/**
		Return self+value.
	**/
	...
	**/
	public var shadows_max : Dynamic;
	/**
