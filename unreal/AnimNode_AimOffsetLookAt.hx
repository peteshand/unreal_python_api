...
package unreal;
@:pythonImport("unreal", "AnimNode_AimOffsetLookAt") extern class AnimNode_AimOffsetLookAt {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		...
		this node
	**/
	public var ignore_for_relevancy_test : Dynamic;
	/**
		(float):  [Read-Write] Accumulated time used to reference the asset in this node
	**/
	public var internal_time_accumulator : Dynamic;
	/**
	...
	**/
	public var look_at_location : Dynamic;
	/**
	...
	**/
	public var pivot_socket_name : Dynamic;
	/**
	...
	**/
	public var reset_play_time_when_blend_space_changes : Dynamic;
	/**
	...
	**/
	public var socket_axis : Dynamic;
	/**
		(Name):  [Read-Write] Socket to treat as the look at source
	**/
	public var source_socket_name : Dynamic;
	/**
	...
	**/
	public var start_position : Dynamic;
	/**
