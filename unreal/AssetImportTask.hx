...
package unreal;
@:pythonImport("unreal", "AssetImportTask") extern class AssetImportTask {
	...
	**/
	public var destination_name : Dynamic;
	/**
	...
	**/
	public var imported_object_paths : Dynamic;
	/**
	...
	**/
	public var replace_existing_settings : Dynamic;
	/**
