...
package unreal;
@:pythonImport("unreal", "EmitterCameraLensEffectBase") extern class EmitterCameraLensEffectBase {
	...
	**/
	public var particle_system_component : Dynamic;
	/**
	...
	**/
	public var post_update_tick_group : Dynamic;
	/**
