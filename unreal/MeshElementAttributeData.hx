...
package unreal;
@:pythonImport("unreal", "MeshElementAttributeData") extern class MeshElementAttributeData {
	/**
		Return self+value.
	**/
	...
	**/
	public var attribute_index : Dynamic;
	/**
		(Name):  [Read-Write] Name of the attribute
	**/
	public var attribute_name : Dynamic;
	/**
		(MeshElementAttributeValue):  [Read-Write] The value of this attribute
	**/
	public var attribute_value : Dynamic;
	/**
