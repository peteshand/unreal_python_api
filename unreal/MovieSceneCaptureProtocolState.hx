...
package unreal;
@:pythonImport("unreal", "MovieSceneCaptureProtocolState") extern class MovieSceneCaptureProtocolState {
	static public var CAPTURING : Dynamic;
	static public var FINALIZING : Dynamic;
	static public var IDLE : Dynamic;
