...
package unreal;
@:pythonImport("unreal", "QuartzTimeSignature") extern class QuartzTimeSignature {
	/**
		Return self+value.
	**/
	...
	**/
	public var num_beats : Dynamic;
	/**
		(Array(QuartzPulseOverrideStep)):  [Read-Write] beat override
	**/
	public var optional_pulse_override : Dynamic;
	/**
