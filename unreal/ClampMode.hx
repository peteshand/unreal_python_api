...
package unreal;
@:pythonImport("unreal", "ClampMode") extern class ClampMode {
	static public var CMODE_CLAMP : Dynamic;
	static public var CMODE_CLAMP_MAX : Dynamic;
	static public var CMODE_CLAMP_MIN : Dynamic;
	/**
