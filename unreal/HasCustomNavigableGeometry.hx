...
package unreal;
@:pythonImport("unreal", "HasCustomNavigableGeometry") extern class HasCustomNavigableGeometry {
	static public var DONT_EXPORT : Dynamic;
	static public var EVEN_IF_NOT_COLLIDABLE : Dynamic;
