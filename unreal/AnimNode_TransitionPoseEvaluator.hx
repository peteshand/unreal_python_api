...
package unreal;
@:pythonImport("unreal", "AnimNode_TransitionPoseEvaluator") extern class AnimNode_TransitionPoseEvaluator {
	/**
		Return self+value.
	**/
	...
	**/
	public var data_source : Dynamic;
	/**
		(EvaluatorMode):  [Read-Write] Evaluator Mode
	**/
	public var evaluator_mode : Dynamic;
	/**
		(int32):  [Read-Write] Frames to Cache Pose
	**/
	public var frames_to_cache_pose : Dynamic;
	/**
