...
package unreal;
@:pythonImport("unreal", "ARLifeCycleComponent") extern class ARLifeCycleComponent {
	...
	**/
	public var on_ar_actor_spawned_delegate : Dynamic;
	/**
		(InstanceARActorToBeDestroyedDelegate):  [Read-Write] On ARActor to be Destroyed Delegate
	**/
	public var on_ar_actor_to_be_destroyed_delegate : Dynamic;
	/**
