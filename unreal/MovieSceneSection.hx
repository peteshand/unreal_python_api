...
@:pythonImport("unreal", "MovieSceneSection") extern class MovieSceneSection extends unreal.MovieSceneSignedObject {
	...
	**/
	public function find_channels_by_type(channel_type:Dynamic):Dynamic;
	/**
	...
	**/
	public function set_blend_type(blend_type:Dynamic):Void;
	/**
	...
	**/
	public function set_completion_mode(completion_mode:Dynamic):Void;
	/**
	...
	**/
	public function set_end_frame(end_frame:Dynamic):Void;
	/**
		...
		Args:
		    is_bounded (bool):
	**/
	public function set_end_frame_bounded(is_bounded:Dynamic):Void;
	/**
	...
	**/
	public function set_end_frame_seconds(end_time:Dynamic):Void;
	/**
		...
		Args:
		    is_active (bool):
	**/
	public function set_is_active(is_active:Dynamic):Void;
	/**
		...
		Args:
		    is_locked (bool):
	**/
	public function set_is_locked(is_locked:Dynamic):Void;
	/**
		...
		Args:
		    new_priority (int32):
	**/
	public function set_overlap_priority(new_priority:Dynamic):Void;
	/**
	...
	**/
	public function set_post_roll_frames(post_roll_frames:Dynamic):Void;
	/**
	...
	**/
	public function set_pre_roll_frames(pre_roll_frames:Dynamic):Void;
	/**
	...
	**/
	public function set_range(start_frame:Dynamic, end_frame:Dynamic):Void;
	/**
	...
	**/
	public function set_range_seconds(start_time:Dynamic, end_time:Dynamic):Void;
	/**
		...
		Args:
		    new_row_index (int32):
	**/
	public function set_row_index(new_row_index:Dynamic):Void;
	/**
		...
		Args:
		    start_frame (int32): The desired start frame for this section
	**/
	public function set_start_frame(start_frame:Dynamic):Void;
	/**
		...
		Args:
		    is_bounded (bool):
	**/
	public function set_start_frame_bounded(is_bounded:Dynamic):Void;
	/**
	...
	**/
	public function set_start_frame_seconds(start_time:Dynamic):Void;
}