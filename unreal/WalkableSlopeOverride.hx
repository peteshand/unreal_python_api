...
package unreal;
@:pythonImport("unreal", "WalkableSlopeOverride") extern class WalkableSlopeOverride {
	/**
		Return self+value.
	**/
	...
	**/
	public var walkable_slope_angle : Dynamic;
	/**
	...
	**/
	public var walkable_slope_behavior : Dynamic;
}