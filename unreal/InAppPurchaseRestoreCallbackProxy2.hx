...
package unreal;
@:pythonImport("unreal", "InAppPurchaseRestoreCallbackProxy2") extern class InAppPurchaseRestoreCallbackProxy2 {
	...
	**/
	static public function create_proxy_object_for_in_app_purchase_restore(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
