...
package unreal;
@:pythonImport("unreal", "AnimationThumbnailSkeletalMeshActor") extern class AnimationThumbnailSkeletalMeshActor {
	...
	**/
	public var should_do_anim_notifies : Dynamic;
	/**
		(SkeletalMeshComponent):  [Read-Only] Skeletal Mesh Component
	**/
	public var skeletal_mesh_component : Dynamic;
	/**
