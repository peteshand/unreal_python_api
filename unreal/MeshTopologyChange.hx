...
package unreal;
@:pythonImport("unreal", "MeshTopologyChange") extern class MeshTopologyChange {
	static public var NO_TOPOLOGY_CHANGE : Dynamic;
	static public var TOPOLOGY_CHANGE : Dynamic;
	/**
