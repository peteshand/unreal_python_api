...
package unreal;
@:pythonImport("unreal", "ToolMenuEntryScriptDataAdvanced") extern class ToolMenuEntryScriptDataAdvanced {
	/**
		Return self+value.
	**/
	...
	**/
	public var is_sub_menu : Dynamic;
	/**
		(bool):  [Read-Write] Open Sub Menu on Click
	**/
	public var open_sub_menu_on_click : Dynamic;
	/**
	...
	**/
	public var simple_combo_box : Dynamic;
	/**
	...
	**/
	public var tutorial_highlight : Dynamic;
	/**
