...
package unreal;
@:pythonImport("unreal", "TimedDataInputEvaluationData") extern class TimedDataInputEvaluationData {
	/**
		Return self+value.
	**/
	...
	**/
	public var distance_to_newest_sample_seconds : Dynamic;
	/**
		(float):  [Read-Write] Distance between evaluation time and newest sample in seconds
	**/
	public var distance_to_oldest_sample_seconds : Dynamic;
	/**
