...
package unreal;
@:pythonImport("unreal", "InterpCurvePointLinearColor") extern class InterpCurvePointLinearColor {
	/**
		Return self+value.
	**/
	...
	**/
	public var arrive_tangent : Dynamic;
	/**
