...
package unreal;
@:pythonImport("unreal", "AIStimulus") extern class AIStimulus {
	/**
		Return self+value.
	**/
	...
	**/
	public var expiration_age : Dynamic;
	/**
	...
	**/
	public var receiver_location : Dynamic;
	/**
	...
	**/
	public var stimulus_location : Dynamic;
	/**
	...
	**/
	public var successfully_sensed : Dynamic;
	/**
		(Name):  [Read-Write] Tag
	**/
