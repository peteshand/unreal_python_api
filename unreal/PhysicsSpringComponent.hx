...
package unreal;
@:pythonImport("unreal", "PhysicsSpringComponent") extern class PhysicsSpringComponent {
	...
	**/
	...
	/**
		...
		Returns:
		    float:
	**/
	public function get_normalized_compression_scalar(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    Vector:
	**/
	public function get_spring_current_end_point(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Returns:
		    Vector:
	**/
	public function get_spring_direction(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Returns:
		    Vector:
	**/
	public function get_spring_resting_point(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public var ignore_self : Dynamic;
	/**
		x.is_active() -> bool
	...
	**/
	public var spring_damping : Dynamic;
	/**
	...
	**/
	public var spring_length_at_rest : Dynamic;
	/**
		(float):  [Read-Write] Determines the radius of the spring.
	**/
	public var spring_radius : Dynamic;
	/**
	...
	**/
	public var spring_stiffness : Dynamic;
	/**
