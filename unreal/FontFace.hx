...
package unreal;
@:pythonImport("unreal", "FontFace") extern class FontFace {
	...
	**/
	public var layout_method : Dynamic;
	/**
	...
	**/
	public var loading_policy : Dynamic;
	/**
	...
	**/
	public var source_filename : Dynamic;
	/**
