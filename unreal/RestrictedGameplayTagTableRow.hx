...
package unreal;
@:pythonImport("unreal", "RestrictedGameplayTagTableRow") extern class RestrictedGameplayTagTableRow {
	/**
		Return self+value.
	**/
	...
	**/
	public var allow_non_restricted_children : Dynamic;
	/**
	...
	**/
	public var dev_comment : Dynamic;
	/**
