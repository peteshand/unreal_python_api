...
package unreal;
@:pythonImport("unreal", "KinematicBonesUpdateToPhysics") extern class KinematicBonesUpdateToPhysics {
	static public var SKIP_ALL_BONES : Dynamic;
	static public var SKIP_SIMULATING_BONES : Dynamic;
	/**
