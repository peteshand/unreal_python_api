...
package unreal;
@:pythonImport("unreal", "CameraShakeSourceComponent") extern class CameraShakeSourceComponent {
	...
	**/
	public var attenuation : Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    float:
	**/
	public function get_attenuation_factor(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public var inner_attenuation_radius : Dynamic;
	/**
		x.is_active() -> bool
	...
	**/
	public var outer_attenuation_radius : Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Args:
		    ...
		    immediately (bool):
	**/
	public function stop_all_camera_shakes_of_type(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
