...
package unreal;
@:pythonImport("unreal", "PhysicalAnimationData") extern class PhysicalAnimationData {
	/**
		Return self+value.
	**/
	...
	**/
	public var angular_velocity_strength : Dynamic;
	/**
	...
	**/
	public var velocity_strength : Dynamic;
}