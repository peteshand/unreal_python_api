...
package unreal;
@:pythonImport("unreal", "SoundSubmixSpectralAnalysisBandSettings") extern class SoundSubmixSpectralAnalysisBandSettings {
	/**
		Return self+value.
	**/
	...
	**/
	public var band_frequency : Dynamic;
	/**
