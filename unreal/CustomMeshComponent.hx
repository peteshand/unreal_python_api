...
package unreal;
@:pythonImport("unreal", "CustomMeshComponent") extern class CustomMeshComponent {
	...
	**/
	public function add_custom_mesh_triangles(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function clear_custom_mesh_triangles(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    bool:
	**/
	public function set_custom_mesh_triangles(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
