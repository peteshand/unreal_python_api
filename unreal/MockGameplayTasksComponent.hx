...
package unreal;
@:pythonImport("unreal", "MockGameplayTasksComponent") extern class MockGameplayTasksComponent {
	...
	**/
	public var on_claimed_resources_change : Dynamic;
	/**
	...
	**/
	static public function run_gameplay_task(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
