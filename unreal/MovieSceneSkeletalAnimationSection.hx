...
package unreal;
@:pythonImport("unreal", "MovieSceneSkeletalAnimationSection") extern class MovieSceneSkeletalAnimationSection {
	...
	**/
	...
	/**
		(MovieSceneSkeletalAnimationParams):  [Read-Write] Params
	**/
