...
package unreal;
@:pythonImport("unreal", "TraceChannelTestBatchOptions") extern class TraceChannelTestBatchOptions {
	/**
		Return self+value.
	**/
	...
	**/
	public var box_trace : Dynamic;
	/**
		(bool):  [Read-Write] Whether to do capsule traces
	**/
	public var capsule_trace : Dynamic;
	/**
	...
	**/
	public var channel_trace : Dynamic;
	/**
	...
	**/
	public var line_trace : Dynamic;
	/**
		(bool):  [Read-Write] Whether to do object traces
	**/
	public var objects_trace : Dynamic;
	/**
		(bool):  [Read-Write] Whether to do profile traces
	**/
	public var profile_trace : Dynamic;
	/**
	...
	**/
	public var sphere_trace : Dynamic;
	/**
