...
package unreal;
@:pythonImport("unreal", "SkyAtmosphere") extern class SkyAtmosphere {
	...
	**/
	...
	/**
		(SkyAtmosphereComponent):  [Read-Only] Sky Atmosphere Component
	**/
	public var sky_atmosphere_component : Dynamic;
	/**
