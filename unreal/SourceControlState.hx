...
package unreal;
@:pythonImport("unreal", "SourceControlState") extern class SourceControlState {
	/**
		Return self+value.
	**/
	...
	**/
	public var checked_out_other : Dynamic;
	/**
