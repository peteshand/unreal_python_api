...
package unreal;
@:pythonImport("unreal", "RadialFalloff") extern class RadialFalloff {
	...
	**/
	public var max_range : Dynamic;
	/**
		(float):  [Read-Write] Min Range
	**/
	public var min_range : Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    RadialFalloff:
	**/
	public function set_radial_falloff(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
