...
package unreal;
@:pythonImport("unreal", "InAppPurchaseQueryCallbackProxy2") extern class InAppPurchaseQueryCallbackProxy2 {
	...
	**/
	static public function create_proxy_object_for_in_app_purchase_query(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
