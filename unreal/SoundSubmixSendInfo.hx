...
package unreal;
@:pythonImport("unreal", "SoundSubmixSendInfo") extern class SoundSubmixSendInfo {
	/**
		Return self+value.
	**/
	...
	**/
	public var custom_send_level_curve : Dynamic;
	/**
	...
	**/
	public var max_send_distance : Dynamic;
	/**
	...
	**/
	public var max_send_level : Dynamic;
	/**
		(float):  [Read-Write] The min distance to send to the master
	**/
	public var min_send_distance : Dynamic;
	/**
	...
	**/
	public var min_send_level : Dynamic;
	/**
		(float):  [Read-Write] The amount of audio to send
	**/
	public var send_level : Dynamic;
	/**
	...
	**/
	public var sound_submix : Dynamic;
	/**
