...
package unreal;
@:pythonImport("unreal", "CameraRig_Rail") extern class CameraRig_Rail {
	...
	**/
	public var current_position_on_rail : Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    SplineComponent:
	**/
	public function get_rail_spline_component(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public var lock_orientation_to_rail : Dynamic;
	/**
