...
package unreal;
@:pythonImport("unreal", "XRAssetFunctionLibrary") extern class XRAssetFunctionLibrary {
	...
	**/
	static public function add_device_visualization_component_blocking(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	static public function add_named_device_visualization_component_blocking(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
