...
@:pythonImport("unreal", "XRAssetFunctionLibrary") extern class XRAssetFunctionLibrary {
	...
	**/
	public function add_device_visualization_component_blocking(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function add_named_device_visualization_component_blocking(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
