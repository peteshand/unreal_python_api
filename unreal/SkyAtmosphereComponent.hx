...
package unreal;
@:pythonImport("unreal", "SkyAtmosphereComponent") extern class SkyAtmosphereComponent {
	...
	**/
	public var aerial_perspective_start_depth : Dynamic;
	/**
	...
	**/
	public var aerial_pespective_view_distance_scale : Dynamic;
	/**
		(float):  [Read-Only] The planet radius. (kilometers from the center to the ground level).
	**/
	public var atmosphere_height : Dynamic;
	/**
	...
	**/
	...
	/**
		(float):  [Read-Only] The planet radius. (kilometers from the center to the ground level).
	**/
	public var bottom_radius : Dynamic;
	/**
	...
	**/
	...
	/**
		(Color):  [Read-Only] The ground albedo that will tint the astmophere when the sun light will bounce on it. Only taken into account when MultiScattering>0.0.
	**/
	public var ground_albedo : Dynamic;
	/**
	...
	**/
	public var height_fog_contribution : Dynamic;
	/**
	...
	**/
	public var mie_absorption : Dynamic;
	/**
		(float):  [Read-Only] Mie absorption coefficient scale.
	**/
	public var mie_absorption_scale : Dynamic;
	/**
	...
	**/
	public var mie_anisotropy : Dynamic;
	/**
		(float):  [Read-Only] The altitude in kilometer at which Mie effects are reduced to 40%.
	**/
	public var mie_exponential_distribution : Dynamic;
	/**
	...
	**/
	public var mie_scattering : Dynamic;
	/**
		(float):  [Read-Only] Mie scattering coefficient scale.
	**/
	public var mie_scattering_scale : Dynamic;
	/**
	...
	**/
	public var multi_scattering_factor : Dynamic;
	/**
	...
	**/
	public var other_absorption : Dynamic;
	/**
	...
	**/
	public function override_atmosphere_light_direction(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public var rayleigh_exponential_distribution : Dynamic;
	/**
	...
	**/
	public var rayleigh_scattering : Dynamic;
	/**
		(float):  [Read-Only] Rayleigh scattering coefficient scale.
	**/
	public var rayleigh_scattering_scale : Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Args:
		    new_value (float):
	**/
	public function set_aerial_pespective_view_distance_scale(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Args:
		    new_value (float):
	**/
	public function set_height_fog_contribution(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function set_mie_absorption(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Args:
		    new_value (float):
	**/
	public function set_mie_absorption_scale(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Args:
		    new_value (float):
	**/
	public function set_mie_anisotropy(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Args:
		    new_value (float):
	**/
	public function set_mie_exponential_distribution(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Args:
		    new_value (LinearColor):
	**/
	public function set_mie_scattering(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Args:
		    new_value (float):
	**/
	public function set_mie_scattering_scale(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Args:
		    new_value (LinearColor):
	**/
	public function set_other_absorption(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Args:
		    new_value (float):
	**/
	public function set_other_absorption_scale(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Args:
		    new_value (float):
	**/
	public function set_rayleigh_exponential_distribution(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Args:
		    new_value (LinearColor):
	**/
	public function set_rayleigh_scattering(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Args:
		    new_value (float):
	**/
	public function set_rayleigh_scattering_scale(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Args:
		    new_value (LinearColor):
	**/
	public function set_sky_luminance_factor(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public var sky_luminance_factor : Dynamic;
	/**
	...
	**/
	public var trace_sample_count_scale : Dynamic;
	/**
		(SkyAtmosphereTransformMode):  [Read-Only] The ground albedo that will tint the astmophere when the sun light will bounce on it. Only taken into account when MultiScattering>0.0.
	**/
	public var transform_mode : Dynamic;
	/**
	...
	**/
	public var transmittance_min_light_elevation_angle : Dynamic;
	/**
