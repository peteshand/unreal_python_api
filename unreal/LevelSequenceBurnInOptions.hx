...
package unreal;
@:pythonImport("unreal", "LevelSequenceBurnInOptions") extern class LevelSequenceBurnInOptions {
	...
	**/
	public var burn_in_class : Dynamic;
	/**
	...
	**/
	public function set_burn_in(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public var use_burn_in : Dynamic;
}