...
package unreal;
@:pythonImport("unreal", "MenuAnchor") extern class MenuAnchor {
	...
	**/
	...
	/**
		...
		Args:
		    fit (bool):
	**/
	public function fit_in_window(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    Vector2D:
	**/
	public function get_menu_position(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    bool:
	**/
	public function has_open_sub_menus(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public var on_menu_open_changed : Dynamic;
	/**
	...
	**/
	public function set_placement(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public var should_defer_painting_after_window_content : Dynamic;
	/**
		(bool):  [Read-Only] Should the menu anchor attempt to fit the menu inside the window.
	**/
	public var should_fit_in_window : Dynamic;
	/**
		...
		Returns:
		    bool:
	**/
	public function should_open_due_to_click(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function toggle_open(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public var use_application_menu_stack : Dynamic;
}