...
package unreal;
@:pythonImport("unreal", "FontOutlineSettings") extern class FontOutlineSettings {
	/**
		Return self+value.
	**/
	...
	**/
	public var apply_outline_to_drop_shadows : Dynamic;
	/**
	...
	**/
	public var separate_fill_alpha : Dynamic;
	/**
