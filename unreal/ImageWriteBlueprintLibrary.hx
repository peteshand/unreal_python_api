...
package unreal;
@:pythonImport("unreal", "ImageWriteBlueprintLibrary") extern class ImageWriteBlueprintLibrary {
	...
	**/
	static public function export_to_disk(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
