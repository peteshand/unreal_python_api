...
package unreal;
@:pythonImport("unreal", "RefractionMode") extern class RefractionMode {
	static public var RM_INDEX_OF_REFRACTION : Dynamic;
	static public var RM_PIXEL_NORMAL_OFFSET : Dynamic;
	/**
