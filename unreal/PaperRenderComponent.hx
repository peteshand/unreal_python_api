...
package unreal;
@:pythonImport("unreal", "PaperRenderComponent") extern class PaperRenderComponent {
	...
	**/
	...
	/**
		...
		Returns:
		    PaperSprite:
	**/
	public function get_sprite(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public var source_sprite : Dynamic;
	/**
