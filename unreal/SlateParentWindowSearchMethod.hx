...
package unreal;
@:pythonImport("unreal", "SlateParentWindowSearchMethod") extern class SlateParentWindowSearchMethod {
	static public var ACTIVE_WINDOW : Dynamic;
	static public var MAIN_WINDOW : Dynamic;
	/**
