...
package unreal;
@:pythonImport("unreal", "MovieSceneLevelVisibilitySection") extern class MovieSceneLevelVisibilitySection {
	...
	**/
	...
	/**
		...
		Returns:
		    Array(Name):
	**/
	public function get_level_names(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function set_level_names(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
