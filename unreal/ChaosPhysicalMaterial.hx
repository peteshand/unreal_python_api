...
package unreal;
@:pythonImport("unreal", "ChaosPhysicalMaterial") extern class ChaosPhysicalMaterial {
	...
	**/
	public var angular_ether_drag : Dynamic;
	/**
	...
	**/
	public var linear_ether_drag : Dynamic;
	/**
	...
	**/
	public var sleeping_angular_velocity_threshold : Dynamic;
	/**
		(float):  [Read-Only] How much to scale the damage threshold by on any destructible we are applied to
	**/
	public var sleeping_linear_velocity_threshold : Dynamic;
	/**
