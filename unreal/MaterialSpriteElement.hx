...
package unreal;
@:pythonImport("unreal", "MaterialSpriteElement") extern class MaterialSpriteElement {
	/**
		Return self+value.
	**/
	...
	**/
	public var size_is_in_screen_space : Dynamic;
	/**
