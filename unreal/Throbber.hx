...
package unreal;
@:pythonImport("unreal", "Throbber") extern class Throbber {
	...
	**/
	public var animate_horizontally : Dynamic;
	/**
		(bool):  [Read-Only] Should the pieces animate their opacity?
	**/
	public var animate_opacity : Dynamic;
	/**
		(bool):  [Read-Only] Should the pieces animate vertically?
	**/
	public var animate_vertically : Dynamic;
	/**
	...
	**/
	public var number_of_pieces : Dynamic;
	/**
	...
	**/
	public function set_animate_horizontally(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function set_animate_opacity(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function set_animate_vertically(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function set_number_of_pieces(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
