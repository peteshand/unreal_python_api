...
package unreal;
@:pythonImport("unreal", "AnimSeqExportOption") extern class AnimSeqExportOption {
	...
	**/
	public var export_curves : Dynamic;
	/**
		(bool):  [Read-Write] If enabled, export the transforms from the animation
	**/
	public var export_transforms : Dynamic;
	/**
	...
	**/
	public var record_in_world_space : Dynamic;
	/**
