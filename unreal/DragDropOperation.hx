...
package unreal;
@:pythonImport("unreal", "DragDropOperation") extern class DragDropOperation {
	...
	**/
	...
	/**
		...
		temporary drag.
	**/
	public var default_drag_visual : Dynamic;
	/**
	...
	**/
	public function drag_cancelled(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Args:
		    pointer_event (PointerEvent):
	**/
	public function dragged(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public var on_drag_cancelled : Dynamic;
	/**
		(OnDragDropMulticast):  [Read-Write] On Dragged
	**/
	public var on_dragged : Dynamic;
	/**
		(OnDragDropMulticast):  [Read-Write] On Drop
	**/
	public var on_drop : Dynamic;
	/**
