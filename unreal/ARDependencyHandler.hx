...
@:pythonImport("unreal", "ARDependencyHandler") extern class ARDependencyHandler extends unreal.Object {
	...
	**/
	public function check_ar_service_availability(world_context_object:Dynamic, latent_info:Dynamic):unreal.ARServiceAvailability;
	/**
	...
	**/
	public function install_ar_service(world_context_object:Dynamic, latent_info:Dynamic):unreal.ARServiceInstallRequestResult;
	/**
	...
	**/
	public function request_ar_session_permission(world_context_object:Dynamic, session_config:Dynamic, latent_info:Dynamic):unreal.ARServicePermissionRequestResult;
	/**
		...
		Args:
		    ...
		    latent_info (LatentActionInfo):
	**/
	public function start_ar_session_latent(world_context_object:Dynamic, session_config:Dynamic, latent_info:Dynamic):Void;
}