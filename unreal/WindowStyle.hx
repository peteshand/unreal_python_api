...
package unreal;
@:pythonImport("unreal", "WindowStyle") extern class WindowStyle {
	/**
		Return self+value.
	**/
	...
	**/
	public var active_title_brush : Dynamic;
	/**
	...
	**/
	public var background_brush : Dynamic;
	/**
	...
	**/
	public var border_brush : Dynamic;
	/**
	...
	**/
	public var child_background_brush : Dynamic;
	/**
		(ButtonStyle):  [Read-Write] Style used to draw the window close button
	**/
	public var close_button_style : Dynamic;
	/**
	...
	**/
	public var flash_title_brush : Dynamic;
	/**
	...
	**/
	public var title_text_style : Dynamic;
	/**
