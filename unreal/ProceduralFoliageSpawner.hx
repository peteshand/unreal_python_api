...
package unreal;
@:pythonImport("unreal", "ProceduralFoliageSpawner") extern class ProceduralFoliageSpawner {
	...
	**/
	public var minimum_quad_tree_size : Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Args:
		    num_steps (int32):
	**/
	public function simulate(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
