...
package unreal;
@:pythonImport("unreal", "InteriorVisualSettingsTriggerVolume") extern class InteriorVisualSettingsTriggerVolume {
	...
	**/
	...
	/**
		...
		Args:
		    ...
		    other_actor (Actor):
	**/
	public function on_trigger_touched(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Args:
		    ...
		    other_actor (Actor):
	**/
	public function on_trigger_un_touched(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
