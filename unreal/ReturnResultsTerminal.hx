...
package unreal;
@:pythonImport("unreal", "ReturnResultsTerminal") extern class ReturnResultsTerminal {
	...
	**/
	...
	/**
		x.set_return_results_terminal() -> ReturnResultsTerminal
		Set Return Results Terminal
		
		Returns:
		    ReturnResultsTerminal:
	**/
	public function set_return_results_terminal(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
