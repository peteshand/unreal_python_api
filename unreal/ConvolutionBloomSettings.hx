...
package unreal;
@:pythonImport("unreal", "ConvolutionBloomSettings") extern class ConvolutionBloomSettings {
	/**
		Return self+value.
	**/
	...
	**/
	public var buffer_scale : Dynamic;
	/**
	...
	**/
	public var pre_filter_max : Dynamic;
	/**
		(float):  [Read-Write] Boost intensity of select pixels  prior to computing bloom convolution (Min, Max, Multiplier).  Max < Min disables
	**/
	public var pre_filter_min : Dynamic;
	/**
		(float):  [Read-Write] Boost intensity of select pixels  prior to computing bloom convolution (Min, Max, Multiplier).  Max < Min disables
	**/
	public var pre_filter_mult : Dynamic;
	/**
