...
package unreal;
@:pythonImport("unreal", "SubsurfaceProfileStruct") extern class SubsurfaceProfileStruct {
	/**
		Return self+value.
	**/
	...
	**/
	public var boundary_color_bleed : Dynamic;
	/**
	...
	**/
	public var enable_burley : Dynamic;
	/**
		(float):  [Read-Only] Extinction Scale
	**/
	public var extinction_scale : Dynamic;
	/**
	...
	**/
	public var falloff_color : Dynamic;
	/**
	...
	**/
	...
	/**
		(float):  [Read-Only] IOR
	**/
	public var ior : Dynamic;
	/**
		(float):  [Read-Only] Lobe Mix
	**/
	public var lobe_mix : Dynamic;
	/**
	...
	**/
	public var mean_free_path_color : Dynamic;
	/**
		(float):  [Read-Only] Subsurface mean free path distance in world/unreal units (cm)
	**/
	public var mean_free_path_distance : Dynamic;
	/**
		(float):  [Read-Only] Normal Scale
	**/
	public var normal_scale : Dynamic;
	/**
		(float):  [Read-Only] Roughness 0
	**/
	public var roughness0 : Dynamic;
	/**
		(float):  [Read-Only] Roughness 1
	**/
	public var roughness1 : Dynamic;
	/**
		(float):  [Read-Only] in world/unreal units (cm)
	**/
	public var scatter_radius : Dynamic;
	/**
		(float):  [Read-Only] Scattering Distribution
	**/
	public var scattering_distribution : Dynamic;
	/**
	...
	**/
	public var transmission_tint_color : Dynamic;
	/**
		(float):  [Read-Only] Control the scale of world/unreal units (cm)
	**/
	public var world_unit_scale : Dynamic;
}