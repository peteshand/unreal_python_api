...
package unreal;
@:pythonImport("unreal", "AutomationUtilsBlueprintLibrary") extern class AutomationUtilsBlueprintLibrary {
	...
	**/
	static public function take_gameplay_automation_screenshot(args:haxe.extern.Rest<Dynamic>):Dynamic;
}