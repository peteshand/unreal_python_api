...
package unreal;
@:pythonImport("unreal", "ToolMenuSection") extern class ToolMenuSection {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		...
		Args:
		    args (ToolMenuEntry):
	**/
	public function add_entry(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function add_entry_object(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public var tool_menu_section_dynamic : Dynamic;
}