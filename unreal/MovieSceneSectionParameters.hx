...
package unreal;
@:pythonImport("unreal", "MovieSceneSectionParameters") extern class MovieSceneSectionParameters {
	/**
		Return self+value.
	**/
	...
	**/
	public var hierarchical_bias : Dynamic;
	/**
