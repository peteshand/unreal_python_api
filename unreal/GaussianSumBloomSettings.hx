...
package unreal;
@:pythonImport("unreal", "GaussianSumBloomSettings") extern class GaussianSumBloomSettings {
	/**
		Return self+value.
	**/
	...
	**/
	public var filter1_size : Dynamic;
	/**
		(LinearColor):  [Read-Write] Bloom1 tint color
	**/
	public var filter1_tint : Dynamic;
	/**
		...
		>=0: can be clamped because of shader limitations
	**/
	public var filter2_size : Dynamic;
	/**
		(LinearColor):  [Read-Write] Bloom2 tint color
	**/
	public var filter2_tint : Dynamic;
	/**
		...
		>=0: can be clamped because of shader limitations
	**/
	public var filter3_size : Dynamic;
	/**
		(LinearColor):  [Read-Write] Bloom3 tint color
	**/
	public var filter3_tint : Dynamic;
	/**
		...
		>=0: can be clamped because of shader limitations
	**/
	public var filter4_size : Dynamic;
	/**
		(LinearColor):  [Read-Write] Bloom4 tint color
	**/
	public var filter4_tint : Dynamic;
	/**
		...
		>=0: can be clamped because of shader limitations
	**/
	public var filter5_size : Dynamic;
	/**
		(LinearColor):  [Read-Write] Bloom5 tint color
	**/
	public var filter5_tint : Dynamic;
	/**
		...
		>=0: can be clamped because of shader limitations
	**/
	public var filter6_size : Dynamic;
	/**
		(LinearColor):  [Read-Write] Bloom6 tint color
	**/
	public var filter6_tint : Dynamic;
	/**
