...
package unreal;
@:pythonImport("unreal", "Slider") extern class Slider {
	...
	**/
	...
	/**
		...
		Returns:
		    float:
	**/
	public function get_normalized_value(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public var indent_handle : Dynamic;
	/**
	...
	**/
	public var mouse_uses_step : Dynamic;
	/**
	...
	**/
	public var requires_controller_lock : Dynamic;
	/**
		x.reset_cursor() -> None
	...
	**/
	...
	/**
		...
		Args:
		    value (bool):
	**/
	public function set_indent_handle(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Args:
		    value (bool):
	**/
	public function set_locked(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Args:
		    value (LinearColor):
	**/
	public function set_slider_bar_color(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Args:
		    value (LinearColor):
	**/
	public function set_slider_handle_color(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Args:
		    value (float):
	**/
	public function set_step_size(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public var slider_bar_color : Dynamic;
	/**
		(LinearColor):  [Read-Only] The color to draw the slider handle in.
	**/
	public var slider_handle_color : Dynamic;
	/**
