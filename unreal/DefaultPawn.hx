...
@:pythonImport("unreal", "DefaultPawn") extern class DefaultPawn extends unreal.Pawn {
	...
	**/
	public function look_up_at_rate(rate:Dynamic):Void;
	/**
	...
	**/
	public function move_forward(val:Dynamic):Void;
	/**
	...
	**/
	public function move_right(val:Dynamic):Void;
	/**
	...
	**/
	public function move_up_world(val:Dynamic):Void;
	/**
	...
	**/
	...
	/**
		...
		Args:
		    rate (float): This is a normalized rate, i.e. 1.0 means 100% of desired turn rate
	**/
	public function turn_at_rate(rate:Dynamic):Void;
}