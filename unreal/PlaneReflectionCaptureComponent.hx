...
package unreal;
@:pythonImport("unreal", "PlaneReflectionCaptureComponent") extern class PlaneReflectionCaptureComponent {
	...
	**/
	public var capture_offset : Dynamic;
	/**
	...
	**/
	public var influence_radius_scale : Dynamic;
	/**
		x.is_active() -> bool
	...
	**/
	public var max_value_rgbm : Dynamic;
	/**
	...
	**/
	public var mobile_reflection_compression : Dynamic;
	/**
	...
	**/
	public var modify_max_value_rgbm : Dynamic;
	/**
	...
	**/
	public var reflection_source_type : Dynamic;
	/**
