...
package unreal;
@:pythonImport("unreal", "InteriorSettings") extern class InteriorSettings {
	/**
		Return self+value.
	**/
	...
	**/
	public var exterior_lpf : Dynamic;
	/**
	...
	**/
	public var exterior_lpf_time : Dynamic;
	/**
	...
	**/
	public var interior_lpf : Dynamic;
	/**
	...
	**/
	public var interior_lpf_time : Dynamic;
	/**
