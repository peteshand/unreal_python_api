...
package unreal;
@:pythonImport("unreal", "ReverbSettings") extern class ReverbSettings {
	/**
		Return self+value.
	**/
	...
	**/
	public var apply_reverb : Dynamic;
	/**
