...
package unreal;
@:pythonImport("unreal", "ScrollBoxStyle") extern class ScrollBoxStyle {
	/**
		Return self+value.
	**/
	...
	**/
	public var bottom_shadow_brush : Dynamic;
	/**
	...
	**/
	public var left_shadow_brush : Dynamic;
	/**
		(SlateBrush):  [Read-Write] Brush used to draw the right shadow of a scrollbox
	**/
	public var right_shadow_brush : Dynamic;
	/**
	...
	**/
	public var top_shadow_brush : Dynamic;
}