...
package unreal;
@:pythonImport("unreal", "EditableTextStyle") extern class EditableTextStyle {
	/**
		Return self+value.
	**/
	...
	**/
	public var background_image_composing : Dynamic;
	/**
		(SlateBrush):  [Read-Write] Background image for the selected text
	**/
	public var background_image_selected : Dynamic;
	/**
		(SlateBrush):  [Read-Write] Image brush used for the caret
	**/
	public var caret_image : Dynamic;
	/**
