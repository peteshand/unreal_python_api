...
package unreal;
@:pythonImport("unreal", "DefaultLevelSequenceInstanceData") extern class DefaultLevelSequenceInstanceData {
	...
	**/
	public var transform_origin : Dynamic;
	/**
	...
	**/
	public var transform_origin_actor : Dynamic;
}