...
package unreal;
@:pythonImport("unreal", "CurveSourceInterface") extern class CurveSourceInterface {
	...
	**/
	...
	/**
		...
		Returns:
		    Name:
	**/
	public function get_binding_name(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function get_curves(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
