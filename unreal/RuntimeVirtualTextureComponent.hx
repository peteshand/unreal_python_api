...
package unreal;
@:pythonImport("unreal", "RuntimeVirtualTextureComponent") extern class RuntimeVirtualTextureComponent {
	...
	**/
	public var build_debug_streaming_mips : Dynamic;
	/**
	...
	**/
	public var streaming_texture : Dynamic;
	/**
	...
	**/
	public var virtual_texture : Dynamic;
	/**
