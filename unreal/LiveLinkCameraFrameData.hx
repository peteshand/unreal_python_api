...
package unreal;
@:pythonImport("unreal", "LiveLinkCameraFrameData") extern class LiveLinkCameraFrameData {
	/**
		Return self+value.
	**/
	...
	**/
	public var property_values : Dynamic;
	/**
