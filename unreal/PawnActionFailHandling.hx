...
package unreal;
@:pythonImport("unreal", "PawnActionFailHandling") extern class PawnActionFailHandling {
	static public var IGNORE_FAILURE : Dynamic;
	static public var REQUIRE_SUCCESS : Dynamic;
	/**
