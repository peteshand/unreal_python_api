...
package unreal;
@:pythonImport("unreal", "ToolDynamicUIAction") extern class ToolDynamicUIAction {
	/**
		Return self+value.
	**/
	...
	**/
	public var can_execute_action : Dynamic;
	/**
	...
	**/
	public var execute_action : Dynamic;
	/**
		(ToolMenuDynamicGetActionCheckState):  [Read-Write] Get Action Check State
	**/
	public var get_action_check_state : Dynamic;
	/**
	...
	**/
	public var is_action_visible_delegate : Dynamic;
	/**
