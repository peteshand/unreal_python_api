...
package unreal;
@:pythonImport("unreal", "ConstraintDescription") extern class ConstraintDescription {
	/**
		Return self+value.
	**/
	...
	**/
	public var rotation_axes : Dynamic;
	/**
	...
	**/
	public var translation_axes : Dynamic;
}