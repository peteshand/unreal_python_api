...
@:pythonImport("unreal", "GameplayTask_ClaimResource") extern class GameplayTask_ClaimResource extends unreal.GameplayTask {
	...
	**/
	static public function claim_resource(task_owner:Dynamic, resource_class:Dynamic, priority:Dynamic, task_instance_name:Dynamic):unreal.GameplayTask_ClaimResource;
	/**
		...
		Returns:
		    GameplayTask_ClaimResource:
	**/
	static public function claim_resources(task_owner:Dynamic, resource_classes:Dynamic, priority:Dynamic, task_instance_name:Dynamic):unreal.GameplayTask_ClaimResource;
}