...
package unreal;
@:pythonImport("unreal", "NiagaraModuleDependencyScriptConstraint") extern class NiagaraModuleDependencyScriptConstraint {
	static public var ALL_SCRIPTS : Dynamic;
	static public var SAME_SCRIPT : Dynamic;
	/**
