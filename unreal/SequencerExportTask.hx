...
package unreal;
@:pythonImport("unreal", "SequencerExportTask") extern class SequencerExportTask {
	...
	**/
	public var ignore_object_list : Dynamic;
	/**
	...
	**/
	public var replace_identical : Dynamic;
	/**
	...
	**/
	public var sequencer_context : Dynamic;
	/**
	...
	**/
	public var use_file_archive : Dynamic;
	/**
		(bool):  [Read-Write] Write even if file empty
	**/
	public var write_empty_files : Dynamic;
}