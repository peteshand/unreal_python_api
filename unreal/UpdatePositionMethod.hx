...
package unreal;
@:pythonImport("unreal", "UpdatePositionMethod") extern class UpdatePositionMethod {
	static public var JUMP : Dynamic;
	static public var PLAY : Dynamic;
	static public var SCRUB : Dynamic;
	/**
