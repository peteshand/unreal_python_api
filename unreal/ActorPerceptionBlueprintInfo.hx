...
package unreal;
@:pythonImport("unreal", "ActorPerceptionBlueprintInfo") extern class ActorPerceptionBlueprintInfo {
	/**
		Return self+value.
	**/
	...
	**/
	public var is_hostile : Dynamic;
	/**
		(Array(AIStimulus)):  [Read-Write] Last Sensed Stimuli
	**/
	public var last_sensed_stimuli : Dynamic;
	/**
