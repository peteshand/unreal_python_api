...
package unreal;
@:pythonImport("unreal", "ScriptSlateIcon") extern class ScriptSlateIcon {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		(Name):  [Read-Write] Small Style Name
	**/
	public var small_style_name : Dynamic;
	/**
	...
	**/
	public var style_set_name : Dynamic;
	/**
