...
package unreal;
@:pythonImport("unreal", "MeshInstancingSettings") extern class MeshInstancingSettings {
	/**
		Return self+value.
	**/
	...
	**/
	public var instance_replacement_threshold : Dynamic;
	/**
	...
	**/
	public var mesh_replacement_method : Dynamic;
	/**
	...
	**/
	...
	/**
		...
		this data.
	**/
	public var skip_meshes_with_vertex_colors : Dynamic;
	/**
	...
	**/
	public var use_hlod_volumes : Dynamic;
}