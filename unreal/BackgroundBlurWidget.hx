...
package unreal;
@:pythonImport("unreal", "BackgroundBlurWidget") extern class BackgroundBlurWidget {
	...
	**/
	public var apply_alpha_to_blur : Dynamic;
	/**
	...
	**/
	public var blur_radius : Dynamic;
	/**
	...
	**/
	public var blur_strength : Dynamic;
	/**
	...
	**/
	public var low_quality_fallback_brush : Dynamic;
	/**
	...
	**/
	public function set_apply_alpha_to_blur(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Args:
		    blur_radius (int32):
	**/
	public function set_blur_radius(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Args:
		    strength (float):
	**/
	public function set_blur_strength(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Args:
		    brush (SlateBrush):
	**/
	public function set_low_quality_fallback_brush(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
