...
package unreal;
@:pythonImport("unreal", "ProcMeshVertex") extern class ProcMeshVertex {
	/**
		Return self+value.
	**/
	...
	**/
	public var uv0 : Dynamic;
	/**
		(Vector2D):  [Read-Write] Vertex texture co-ordinate
	**/
	public var uv1 : Dynamic;
	/**
		(Vector2D):  [Read-Write] Vertex texture co-ordinate
	**/
	public var uv2 : Dynamic;
	/**
		(Vector2D):  [Read-Write] Vertex texture co-ordinate
	**/
	public var uv3 : Dynamic;
}