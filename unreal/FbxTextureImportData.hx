...
package unreal;
@:pythonImport("unreal", "FbxTextureImportData") extern class FbxTextureImportData {
	...
	**/
	public var base_color_name : Dynamic;
	/**
		(str):  [Read-Write] Base Diffuse Texture Name
	**/
	public var base_diffuse_texture_name : Dynamic;
	/**
		(str):  [Read-Write] Base Emissive Color Name
	**/
	public var base_emissive_color_name : Dynamic;
	/**
		(str):  [Read-Write] Base Emmisive Texture Name
	**/
	public var base_emmisive_texture_name : Dynamic;
	/**
		(SoftObjectPath):  [Read-Write] Base material to instance from when importing materials.
	**/
	public var base_material_name : Dynamic;
	/**
		(str):  [Read-Write] Base Normal Texture Name
	**/
	public var base_normal_texture_name : Dynamic;
	/**
		(str):  [Read-Write] Base Opacity Texture Name
	**/
	public var base_opacity_texture_name : Dynamic;
	/**
		(str):  [Read-Write] Base Specular Texture Name
	**/
	public var base_specular_texture_name : Dynamic;
	/**
