...
package unreal;
@:pythonImport("unreal", "ReimportFbxSceneFactory") extern class ReimportFbxSceneFactory {
	...
	**/
	public function script_factory_can_import(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function script_factory_create_file(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Args:
		    obj (Object):
	**/
	public function script_reimport_helper(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
