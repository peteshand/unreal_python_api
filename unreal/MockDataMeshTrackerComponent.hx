...
package unreal;
@:pythonImport("unreal", "MockDataMeshTrackerComponent") extern class MockDataMeshTrackerComponent {
	...
	**/
	public var block_vertex_colors : Dynamic;
	/**
	...
	**/
	public function connect_mr_mesh(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		x.deactivate() -> None
	...
	**/
	public function disconnect_mr_mesh(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public var on_mesh_tracker_updated : Dynamic;
	/**
	...
	**/
	public var request_normals : Dynamic;
	/**
	...
	**/
	public var request_vertex_confidence : Dynamic;
	/**
	...
	**/
	public var update_interval : Dynamic;
	/**
