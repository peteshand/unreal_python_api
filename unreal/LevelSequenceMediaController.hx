...
package unreal;
@:pythonImport("unreal", "LevelSequenceMediaController") extern class LevelSequenceMediaController {
	...
	**/
	...
	/**
		...
		Returns:
		    MediaComponent:
	**/
	public function get_media_component(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public var media_component : Dynamic;
	/**
	...
	**/
	public var server_start_time_seconds : Dynamic;
	/**
	...
	**/
	public function synchronize_to_server(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
