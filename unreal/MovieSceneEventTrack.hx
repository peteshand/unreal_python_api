...
package unreal;
@:pythonImport("unreal", "MovieSceneEventTrack") extern class MovieSceneEventTrack {
	...
	**/
	public function add_event_repeater_section(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function add_event_trigger_section(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
