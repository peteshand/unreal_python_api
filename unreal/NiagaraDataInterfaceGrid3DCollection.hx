...
package unreal;
@:pythonImport("unreal", "NiagaraDataInterfaceGrid3DCollection") extern class NiagaraDataInterfaceGrid3DCollection {
	...
	**/
	...
	/**
		...
		Returns:
		    ...
		    tile_z (int32):
	**/
	public function fill_raw_volume_texture(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Returns:
		    bool:
	**/
	public function fill_volume_texture(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    ...
		    size_z (int32):
	**/
	public function get_raw_texture_size(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Returns:
		    ...
		    size_z (int32):
	**/
	public function get_texture_size(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
