...
package unreal;
@:pythonImport("unreal", "DatasmithImportScene") extern class DatasmithImportScene {
	static public var ASSETS_ONLY : Dynamic;
	static public var CURRENT_LEVEL : Dynamic;
	static public var NEW_LEVEL : Dynamic;
	/**
