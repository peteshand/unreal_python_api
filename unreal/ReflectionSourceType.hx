...
package unreal;
@:pythonImport("unreal", "ReflectionSourceType") extern class ReflectionSourceType {
	static public var CAPTURED_SCENE : Dynamic;
	static public var SPECIFIED_CUBEMAP : Dynamic;
	/**
