...
package unreal;
@:pythonImport("unreal", "MovieSceneEvaluationType") extern class MovieSceneEvaluationType {
	static public var FRAME_LOCKED : Dynamic;
	static public var WITH_SUB_FRAMES : Dynamic;
	/**
