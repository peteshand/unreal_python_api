...
package unreal;
@:pythonImport("unreal", "InputScaleBiasClamp") extern class InputScaleBiasClamp {
	/**
		Return self+value.
	**/
	...
	**/
	public var clamp_max : Dynamic;
	/**
		(float):  [Read-Write] Clamp Min
	**/
	public var clamp_min : Dynamic;
	/**
		(bool):  [Read-Write] Clamp Result
	**/
	public var clamp_result : Dynamic;
	/**
	...
	**/
	public var interp_result : Dynamic;
	/**
		(float):  [Read-Write] Interp Speed Decreasing
	**/
	public var interp_speed_decreasing : Dynamic;
	/**
		(float):  [Read-Write] Interp Speed Increasing
	**/
	public var interp_speed_increasing : Dynamic;
	/**
		(bool):  [Read-Write] Map Range
	**/
	public var map_range : Dynamic;
	/**
		(InputRange):  [Read-Write] Out Range
	**/
	public var out_range : Dynamic;
	/**
