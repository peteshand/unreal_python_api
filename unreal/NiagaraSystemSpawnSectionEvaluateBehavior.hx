...
package unreal;
@:pythonImport("unreal", "NiagaraSystemSpawnSectionEvaluateBehavior") extern class NiagaraSystemSpawnSectionEvaluateBehavior {
	static public var ACTIVATE_IF_INACTIVE : Dynamic;
