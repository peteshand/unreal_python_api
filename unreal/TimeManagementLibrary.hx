	...
	**/
	...
	/**
		...
		Returns:
		    FrameNumber:
	**/
	static public function add_frame_number_frame_number(a:Dynamic, b:Dynamic):unreal.FrameNumber;
	/**
		...
		Returns:
		    FrameNumber:
	**/
	static public function add_frame_number_integer(a:Dynamic, b:Dynamic):unreal.FrameNumber;
	/**
		...
		Returns:
		    float:
	**/
	static public function conv_frame_rate_to_seconds(frame_rate:Dynamic):Float;
	/**
		...
		Returns:
		    float:
	**/
	static public function conv_qualified_frame_time_to_seconds(frame_time:Dynamic):Float;
	/**
		...
		Returns:
		    str:
	**/
	static public function conv_timecode_to_string(timecode:Dynamic, force_sign_display:Dynamic):String;
	/**
		...
		Returns:
		    FrameNumber:
	**/
	static public function divide_frame_number_integer(a:Dynamic, b:Dynamic):unreal.FrameNumber;
	/**
		...
		Returns:
		    int32:
	**/
	static public function frame_number_to_integer(frame_number:Dynamic):Int;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    bool:
	**/
	static public function is_valid_framerate(frame_rate:Dynamic):Bool;
	/**
		...
		Returns:
		    bool:
	**/
	static public function is_valid_multiple_of(frame_rate:Dynamic, other_framerate:Dynamic):Bool;
	/**
		...
		Returns:
		    FrameNumber:
	**/
	static public function multiply_frame_number_integer(a:Dynamic, b:Dynamic):unreal.FrameNumber;
	/**
		...
		Returns:
		    FrameTime:
	**/
	static public function multiply_seconds_frame_rate(time_in_seconds:Dynamic, frame_rate:Dynamic):unreal.FrameTime;
	/**
		...
		Returns:
		    FrameTime:
	**/
	static public function snap_frame_time_to_rate(source_time:Dynamic, source_rate:Dynamic, snap_to_rate:Dynamic):unreal.FrameTime;
	/**
		...
		Returns:
		    FrameNumber:
	**/
	static public function subtract_frame_number_frame_number(a:Dynamic, b:Dynamic):unreal.FrameNumber;
	/**
		...
		Returns:
		    FrameNumber:
	**/
	static public function subtract_frame_number_integer(a:Dynamic, b:Dynamic):unreal.FrameNumber;
	/**
		...
		Returns:
		    FrameTime:
	**/
	static public function transform_time(source_time:Dynamic, source_rate:Dynamic, destination_rate:Dynamic):unreal.FrameTime;
}