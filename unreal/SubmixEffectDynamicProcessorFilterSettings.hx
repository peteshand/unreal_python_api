...
package unreal;
@:pythonImport("unreal", "SubmixEffectDynamicProcessorFilterSettings") extern class SubmixEffectDynamicProcessorFilterSettings {
	/**
		Return self+value.
	**/
