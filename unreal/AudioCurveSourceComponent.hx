...
package unreal;
@:pythonImport("unreal", "AudioCurveSourceComponent") extern class AudioCurveSourceComponent {
	...
	**/
	public var curve_source_binding_name : Dynamic;
	/**
		(float):  [Read-Write] Offset in time applied to audio position when evaluating curves
	**/
	public var curve_sync_offset : Dynamic;
	/**
		x.deactivate() -> None
