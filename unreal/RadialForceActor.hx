...
package unreal;
@:pythonImport("unreal", "RadialForceActor") extern class RadialForceActor {
	...
	**/
	public function disable_force(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function enable_force(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public var force_component : Dynamic;
	/**
	...
	**/
	public function toggle_force(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
