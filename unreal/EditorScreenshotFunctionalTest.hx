...
package unreal;
@:pythonImport("unreal", "EditorScreenshotFunctionalTest") extern class EditorScreenshotFunctionalTest {
	...
	**/
	public var camera_cut_on_screenshot_prep : Dynamic;
	/**
	...
	**/
	public var screenshot_camera : Dynamic;
	/**
		(AutomationScreenshotOptions):  [Read-Only] Screenshot Options
	**/
	public var screenshot_options : Dynamic;
	/**
