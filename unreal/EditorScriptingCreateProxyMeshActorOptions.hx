...
package unreal;
@:pythonImport("unreal", "EditorScriptingCreateProxyMeshActorOptions") extern class EditorScriptingCreateProxyMeshActorOptions {
	/**
		Return self+value.
	**/
	...
	**/
	public var mesh_proxy_settings : Dynamic;
	/**
