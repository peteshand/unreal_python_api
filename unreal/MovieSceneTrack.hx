...
@:pythonImport("unreal", "MovieSceneTrack") extern class MovieSceneTrack extends unreal.MovieSceneSignedObject {
	...
	**/
	public function get_sections():Dynamic;
	/**
	...
	**/
	public function remove_section(section:Dynamic):Void;
	/**
	...
	**/
	public function set_color_tint(color_tint:Dynamic):Void;
	/**
	...
	**/
	public function set_display_name(name:Dynamic):Void;
	/**
	...
	**/
	public function set_sorting_order(sorting_order:Dynamic):Void;
}