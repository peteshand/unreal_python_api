...
package unreal;
@:pythonImport("unreal", "MovieSceneSkeletalAnimationSectionTemplateParameters") extern class MovieSceneSkeletalAnimationSectionTemplateParameters {
	/**
		Return self+value.
	**/
