...
package unreal;
@:pythonImport("unreal", "UserObjectListEntryLibrary") extern class UserObjectListEntryLibrary {
	...
	**/
	...
	/**
		...
		Returns:
		    Object:
	**/
	static public function get_list_item_object(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
