...
package unreal;
@:pythonImport("unreal", "FbxExportOption") extern class FbxExportOption {
	...
	**/
	public var fbx_export_compatibility : Dynamic;
	/**
	...
	**/
	public var vertex_color : Dynamic;
}