...
package unreal;
@:pythonImport("unreal", "InputAlphaBoolBlend") extern class InputAlphaBoolBlend {
	/**
		Return self+value.
	**/
	...
	**/
	public var blend_in_time : Dynamic;
	/**
		(AlphaBlendOption):  [Read-Write] Blend Option
	**/
	public var blend_option : Dynamic;
	/**
		(float):  [Read-Write] Blend Out Time
	**/
	public var blend_out_time : Dynamic;
	/**
	...
	**/
	public var custom_curve : Dynamic;
	/**
