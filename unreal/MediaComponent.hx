...
package unreal;
@:pythonImport("unreal", "MediaComponent") extern class MediaComponent {
	...
	**/
	...
	/**
		...
		Returns:
		    MediaTexture:
	**/
	public function get_media_texture(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public var media_player : Dynamic;
	/**
