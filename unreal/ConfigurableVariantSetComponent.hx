...
package unreal;
@:pythonImport("unreal", "ConfigurableVariantSetComponent") extern class ConfigurableVariantSetComponent {
	...
	**/
	public var currently_visible : Dynamic;
	/**
		x.deactivate() -> None
	...
	**/
	public function hide_variant_set(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		x.is_active() -> bool
	...
	**/
	...
	/**
		...
		Returns:
		    bool:
	**/
	public function should_be_visible(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Show Variant Set
	**/
	public function show_variant_set(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public var variant_set_name : Dynamic;
	/**
