...
package unreal;
@:pythonImport("unreal", "RuntimeVirtualTextureParameterValue") extern class RuntimeVirtualTextureParameterValue {
	/**
		Return self+value.
	**/
	...
	**/
	public var parameter_info : Dynamic;
	/**
		(RuntimeVirtualTexture):  [Read-Write] Parameter Value
	**/
	public var parameter_value : Dynamic;
	/**
