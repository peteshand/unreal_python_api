...
package unreal;
@:pythonImport("unreal", "AnimNode_CopyBoneDelta") extern class AnimNode_CopyBoneDelta {
	/**
		Return self+value.
	**/
	...
	**/
	public var copy_rotation : Dynamic;
	/**
		(bool):  [Read-Write] Copy Scale
	**/
	public var copy_scale : Dynamic;
	/**
		(bool):  [Read-Write] Copy Translation
	**/
	public var copy_translation : Dynamic;
	/**
	...
	**/
	public var rotation_multiplier : Dynamic;
	/**
		(float):  [Read-Write] Scale Multiplier
	**/
	public var scale_multiplier : Dynamic;
	/**
	...
	**/
	public var translation_multiplier : Dynamic;
}