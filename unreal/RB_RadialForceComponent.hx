...
package unreal;
@:pythonImport("unreal", "RB_RadialForceComponent") extern class RB_RadialForceComponent {
	...
	**/
	public function add_object_type_to_affect(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public var destructible_damage : Dynamic;
	/**
	...
	**/
	public function fire_impulse(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		(float):  [Read-Write] How strong the force should be
	**/
	public var force_strength : Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Args:
		    object_type (ObjectTypeQuery):
	**/
	public function remove_object_type_to_affect(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
