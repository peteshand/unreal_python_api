...
package unreal;
@:pythonImport("unreal", "LevelSequencePlayer") extern class LevelSequencePlayer {
	...
	**/
	static public function create_level_sequence_player(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Returns:
		    CameraComponent:
	**/
	public function get_active_camera_component(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public var on_camera_cut : Dynamic;
	/**
