...
package unreal;
@:pythonImport("unreal", "ARSharedWorldReplicationState") extern class ARSharedWorldReplicationState {
	/**
		Return self+value.
	**/
	...
	**/
	public var ar_world_offset : Dynamic;
	/**
	...
	**/
	public var preview_image_offset : Dynamic;
	/**
