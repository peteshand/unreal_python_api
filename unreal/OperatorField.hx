...
package unreal;
@:pythonImport("unreal", "OperatorField") extern class OperatorField {
	...
	**/
	public var right_field : Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    OperatorField:
	**/
	public function set_operator_field(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
