...
package unreal;
@:pythonImport("unreal", "ARTrackedQRCode") extern class ARTrackedQRCode {
	...
	**/
	...
	/**
		...
		Returns:
		    ARCandidateImage:
	**/
	public function get_detected_image(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	/**
		...
		* ARKit will return the physical size of the ARCandidate image.
		...
		Returns:
		    Vector2D:
	**/
	public function get_estimate_size(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
