...
package unreal;
@:pythonImport("unreal", "LocationServicesData") extern class LocationServicesData {
	/**
		Return self+value.
	**/
	...
	**/
	public var horizontal_accuracy : Dynamic;
	/**
	...
	**/
	public var vertical_accuracy : Dynamic;
}