...
package unreal;
@:pythonImport("unreal", "MaterialOptions") extern class MaterialOptions {
	...
	**/
	public var lod_indices : Dynamic;
	/**
	...
	**/
	public var texture_coordinate_index : Dynamic;
	/**
	...
	**/
	public var use_mesh_data : Dynamic;
	/**
	...
	**/
	public var use_specific_uv_index : Dynamic;
}