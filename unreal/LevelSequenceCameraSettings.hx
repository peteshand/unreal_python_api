...
package unreal;
@:pythonImport("unreal", "LevelSequenceCameraSettings") extern class LevelSequenceCameraSettings {
	/**
		Return self+value.
	**/
	...
	**/
	public var aspect_ratio_axis_constraint : Dynamic;
	/**
	...
	**/
	public var override_aspect_ratio_axis_constraint : Dynamic;
	/**
