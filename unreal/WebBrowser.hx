...
package unreal;
@:pythonImport("unreal", "WebBrowser") extern class WebBrowser {
	...
	**/
	public function execute_javascript(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    Text:
	**/
	public function get_title_text(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function load_string(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function load_url(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public var on_before_popup : Dynamic;
	/**
		(OnUrlChanged):  [Read-Write] Called when the Url changes.
	**/
	public var on_url_changed : Dynamic;
	/**
