...
package unreal;
@:pythonImport("unreal", "ARSceneReconstruction") extern class ARSceneReconstruction {
	static public var MESH_ONLY : Dynamic;
	static public var MESH_WITH_CLASSIFICATION : Dynamic;
