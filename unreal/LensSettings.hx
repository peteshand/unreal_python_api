...
package unreal;
@:pythonImport("unreal", "LensSettings") extern class LensSettings {
	/**
		Return self+value.
	**/
	...
	**/
	public var chromatic_aberration : Dynamic;
	/**
	...
	**/
	public var imperfections : Dynamic;
	/**
