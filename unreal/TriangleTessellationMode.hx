...
package unreal;
@:pythonImport("unreal", "TriangleTessellationMode") extern class TriangleTessellationMode {
	static public var FOUR_TRIANGLES : Dynamic;
	static public var THREE_TRIANGLES : Dynamic;
	/**
