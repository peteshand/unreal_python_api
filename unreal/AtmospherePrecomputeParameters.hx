...
package unreal;
@:pythonImport("unreal", "AtmospherePrecomputeParameters") extern class AtmospherePrecomputeParameters {
	/**
		Return self+value.
	**/
	...
	**/
	public var density_height : Dynamic;
	/**
	...
	**/
	public var inscatter_altitude_sample_num : Dynamic;
	/**
		(int32):  [Read-Only] Maximum scattering order
	**/
	public var max_scattering_order : Dynamic;
	/**
