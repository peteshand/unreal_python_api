...
package unreal;
@:pythonImport("unreal", "GeometryCacheActor") extern class GeometryCacheActor {
	...
	**/
	public var geometry_cache_component : Dynamic;
	/**
	...
	**/
	public function get_geometry_cache_component(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
