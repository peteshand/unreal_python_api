...
package unreal;
@:pythonImport("unreal", "ARGeoAnchorUpdatePayload") extern class ARGeoAnchorUpdatePayload {
	/**
		Return self+value.
	**/
	...
	**/
	public var altitude_meters : Dynamic;
	/**
		(ARAltitudeSource):  [Read-Only] Altitude Source
	**/
	public var altitude_source : Dynamic;
	/**
		(str):  [Read-Only] Anchor Name
	**/
	public var anchor_name : Dynamic;
	/**
	...
	**/
	public var latitude : Dynamic;
	/**
		(float):  [Read-Only] Longitude
	**/
	public var longitude : Dynamic;
	/**
		(ARSessionPayload):  [Read-Only] Session Payload
	**/
	public var session_payload : Dynamic;
	/**
	...
	**/
	public var world_transform : Dynamic;
}