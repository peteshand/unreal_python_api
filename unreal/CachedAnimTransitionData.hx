...
package unreal;
@:pythonImport("unreal", "CachedAnimTransitionData") extern class CachedAnimTransitionData {
	/**
		Return self+value.
	**/
	...
	**/
	public var from_state_name : Dynamic;
	/**
	...
	**/
	public var state_machine_name : Dynamic;
	/**
	...
	**/
	public var to_state_name : Dynamic;
	/**
