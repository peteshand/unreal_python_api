...
package unreal;
@:pythonImport("unreal", "CameraLensSettings") extern class CameraLensSettings {
	/**
		Return self+value.
	**/
	...
	**/
	public var diaphragm_blade_count : Dynamic;
	/**
