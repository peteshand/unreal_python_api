...
package unreal;
@:pythonImport("unreal", "TransformConstraint") extern class TransformConstraint {
	/**
		Return self+value.
	**/
	...
	**/
	public var maintain_offset : Dynamic;
	/**
	...
	**/
	public var source_node : Dynamic;
	/**
	...
	**/
	public var target_node : Dynamic;
	/**
