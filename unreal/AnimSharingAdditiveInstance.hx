...
package unreal;
@:pythonImport("unreal", "AnimSharingAdditiveInstance") extern class AnimSharingAdditiveInstance {
	...
	**/
	public var additive_animation : Dynamic;
	/**
	...
	**/
	public var base_component : Dynamic;
	/**
