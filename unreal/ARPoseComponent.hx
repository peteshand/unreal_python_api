...
package unreal;
@:pythonImport("unreal", "ARPoseComponent") extern class ARPoseComponent {
	...
	**/
	static public function set_pose_component_debug_mode(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
