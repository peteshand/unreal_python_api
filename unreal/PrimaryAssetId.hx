...
package unreal;
@:pythonImport("unreal", "PrimaryAssetId") extern class PrimaryAssetId {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		...
		Returns:
		    Class:
	**/
	public function get_soft_class_reference(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Returns:
		    Object:
	**/
	public function get_soft_object_reference(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		x.is_valid() -> bool
