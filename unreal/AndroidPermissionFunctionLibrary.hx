...
package unreal;
@:pythonImport("unreal", "AndroidPermissionFunctionLibrary") extern class AndroidPermissionFunctionLibrary {
	...
	**/
	static public function acquire_permissions(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    bool:
	**/
	static public function check_permission(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
