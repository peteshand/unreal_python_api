...
package unreal;
@:pythonImport("unreal", "VolumetricCloud") extern class VolumetricCloud {
	...
	**/
	...
	/**
		(VolumetricCloudComponent):  [Read-Only] Volumetric Cloud Component
	**/
	public var volumetric_cloud_component : Dynamic;
	/**
