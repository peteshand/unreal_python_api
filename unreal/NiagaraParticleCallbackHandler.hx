...
package unreal;
@:pythonImport("unreal", "NiagaraParticleCallbackHandler") extern class NiagaraParticleCallbackHandler {
	...
	**/
	public function receive_particle_data(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
