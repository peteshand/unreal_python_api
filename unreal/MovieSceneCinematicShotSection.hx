...
package unreal;
@:pythonImport("unreal", "MovieSceneCinematicShotSection") extern class MovieSceneCinematicShotSection {
	...
	**/
	public function get_shot_display_name(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function set_shot_display_name(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
