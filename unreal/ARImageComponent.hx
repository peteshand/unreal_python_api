...
package unreal;
@:pythonImport("unreal", "ARImageComponent") extern class ARImageComponent {
	...
	**/
	static public function set_image_component_debug_mode(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
