...
package unreal;
@:pythonImport("unreal", "ProgressBarStyle") extern class ProgressBarStyle {
	/**
		Return self+value.
	**/
	...
	**/
	public var background_image : Dynamic;
	/**
	...
	**/
	public var marquee_image : Dynamic;
	/**
