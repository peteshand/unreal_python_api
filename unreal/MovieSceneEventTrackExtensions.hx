...
package unreal;
@:pythonImport("unreal", "MovieSceneEventTrackExtensions") extern class MovieSceneEventTrackExtensions {
	...
	**/
	static public function add_event_repeater_section(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	static public function add_event_trigger_section(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
