...
package unreal;
@:pythonImport("unreal", "AutomatedAssetImportData") extern class AutomatedAssetImportData {
	...
	**/
	public var destination_path : Dynamic;
	/**
	...
	**/
	public var factory_name : Dynamic;
	/**
		(Array(str)):  [Read-Write] Filenames to import
	**/
	public var filenames : Dynamic;
	/**
	...
	**/
	public var replace_existing : Dynamic;
	/**
	...
	**/
	public var skip_read_only : Dynamic;
	/**
