...
package unreal;
@:pythonImport("unreal", "VertexAndAttributes") extern class VertexAndAttributes {
	/**
		Return self+value.
	**/
	...
	**/
	public var polygon_vertex_attributes : Dynamic;
	/**
	...
	**/
	public var vertex_instance_id : Dynamic;
}