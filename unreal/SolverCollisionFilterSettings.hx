...
package unreal;
@:pythonImport("unreal", "SolverCollisionFilterSettings") extern class SolverCollisionFilterSettings {
	/**
		Return self+value.
	**/
	...
	**/
	public var filter_enabled : Dynamic;
	/**
