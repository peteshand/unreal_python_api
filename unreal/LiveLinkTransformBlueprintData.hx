...
package unreal;
@:pythonImport("unreal", "LiveLinkTransformBlueprintData") extern class LiveLinkTransformBlueprintData {
	/**
		Return self+value.
	**/
	...
	**/
	public var static_data : Dynamic;
	/**
