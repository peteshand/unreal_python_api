...
package unreal;
@:pythonImport("unreal", "LODSyncComponent") extern class LODSyncComponent {
	...
	**/
	public var components_to_sync : Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    str:
	**/
	public function get_lod_sync_debug_text(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
