...
package unreal;
@:pythonImport("unreal", "InAppPurchaseRestoreInfo2") extern class InAppPurchaseRestoreInfo2 {
	/**
		Return self+value.
	**/
	...
	**/
	public var item_id : Dynamic;
	/**
		(str):  [Read-Only] The item name
	**/
	public var item_name : Dynamic;
	/**
	...
	**/
	public var validation_info : Dynamic;
}