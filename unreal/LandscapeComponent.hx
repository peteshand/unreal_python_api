...
package unreal;
@:pythonImport("unreal", "LandscapeComponent") extern class LandscapeComponent {
	...
	**/
	...
	/**
		...
		Returns:
		    float:
	**/
	public function editor_get_paint_layer_weight_at_location(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Returns:
		    float:
	**/
	public function editor_get_paint_layer_weight_by_name_at_location(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    MaterialInstanceDynamic:
	**/
	public function get_material_instance_dynamic(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public var gi_baked_base_color_texture : Dynamic;
	/**
	...
	**/
	public var override_hole_material : Dynamic;
	/**
		(MaterialInterface):  [Read-Write] Override Material
	**/
	public var override_material : Dynamic;
	/**
