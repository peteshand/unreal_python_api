...
package unreal;
@:pythonImport("unreal", "CanvasRenderTarget2D") extern class CanvasRenderTarget2D {
	...
	**/
	public var auto_generate_mips : Dynamic;
	/**
	...
	**/
	public var clear_color : Dynamic;
	/**
	...
	**/
	static public function create_canvas_render_target2d(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public var gpu_shared_flag : Dynamic;
	/**
	...
	**/
	public var on_canvas_render_target_update : Dynamic;
	/**
	...
	**/
	public var render_target_format : Dynamic;
	/**
	...
	**/
	public var size_x : Dynamic;
	/**
		(int32):  [Read-Only] The height of the texture.
	**/
	public var size_y : Dynamic;
	/**
	...
	**/
	...
	/**
		(float):  [Read-Write] Will override FTextureRenderTarget2DResource::GetDisplayGamma if > 0.
	**/
	public var target_gamma : Dynamic;
	/**
	...
	**/
	public function update_resource(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
