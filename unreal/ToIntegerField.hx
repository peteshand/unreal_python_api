...
package unreal;
@:pythonImport("unreal", "ToIntegerField") extern class ToIntegerField {
	...
	**/
	public var float_field : Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    ToIntegerField:
	**/
	public function set_to_integer_field(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
