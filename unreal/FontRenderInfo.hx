...
package unreal;
@:pythonImport("unreal", "FontRenderInfo") extern class FontRenderInfo {
	/**
		Return self+value.
	**/
	...
	**/
	public var enable_shadow : Dynamic;
	/**
