	...
	**/
	...
	/**
		...
		Args:
		    ...
		    update_mesh (bool):
	**/
	public function set_boundary_max(boundary_max:Dynamic, update_mesh:Dynamic):Void;
	/**
		...
		Args:
		    ...
		    update_mesh (bool):
	**/
	public function set_boundary_min(boundary_min:Dynamic, update_mesh:Dynamic):Void;
	/**
		...
		Args:
		    ...
		    update_mesh (bool):
	**/
	public function set_end_offset(end_offset:Dynamic, update_mesh:Dynamic):Void;
	/**
		...
		Args:
		    ...
		    update_mesh (bool):
	**/
	public function set_end_position(end_pos:Dynamic, update_mesh:Dynamic):Void;
	/**
		...
		Args:
		    ...
		    update_mesh (bool):
	**/
	public function set_end_roll(end_roll:Dynamic, update_mesh:Dynamic):Void;
	/**
		...
		Args:
		    ...
		    update_mesh (bool):
	**/
	public function set_end_scale(end_scale:Dynamic, update_mesh:Dynamic):Void;
	/**
		...
		Args:
		    ...
		    update_mesh (bool):
	**/
	public function set_end_tangent(end_tangent:Dynamic, update_mesh:Dynamic):Void;
	/**
		...
		Args:
		    ...
		    update_mesh (bool):
	**/
	public function set_forward_axis(forward_axis:Dynamic, update_mesh:Dynamic):Void;
	/**
		...
		Args:
		    ...
		    update_mesh (bool):
	**/
	public function set_spline_up_dir(spline_up_dir:Dynamic, update_mesh:Dynamic):Void;
	/**
		...
		Args:
		    ...
		    update_mesh (bool):
	**/
	public function set_start_and_end(start_pos:Dynamic, start_tangent:Dynamic, end_pos:Dynamic, end_tangent:Dynamic, update_mesh:Dynamic):Void;
	/**
		...
		Args:
		    ...
		    update_mesh (bool):
	**/
	public function set_start_offset(start_offset:Dynamic, update_mesh:Dynamic):Void;
	/**
		...
		Args:
		    ...
		    update_mesh (bool):
	**/
	public function set_start_position(start_pos:Dynamic, update_mesh:Dynamic):Void;
	/**
		...
		Args:
		    ...
		    update_mesh (bool):
	**/
	public function set_start_roll(start_roll:Dynamic, update_mesh:Dynamic):Void;
	/**
		...
		Args:
		    ...
		    update_mesh (bool):
	**/
	public function set_start_scale(start_scale:Dynamic, update_mesh:Dynamic):Void;
	/**
		...
		Args:
		    ...
		    update_mesh (bool):
	**/
	public function set_start_tangent(start_tangent:Dynamic, update_mesh:Dynamic):Void;
	/**
		x.update_mesh() -> None
