...
package unreal;
@:pythonImport("unreal", "NativeStatusBarHUD") extern class NativeStatusBarHUD {
	...
	**/
	public function add_hit_box(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Args:
		    ...
		    scale_position (bool): Whether the "Scale" parameter should also scale the position of this draw call.
	**/
	public function draw_material_simple(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function draw_material_triangle(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Args:
		    ...
		    screen_h (float): Screen-space height of the quad (in pixels).
	**/
	public function draw_rect(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Args:
		    ...
		    scale_position (bool): Whether the "Scale" parameter should also scale the position of this draw call.
	**/
	public function draw_texture_simple(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public var enable_debug_text_shadow : Dynamic;
	/**
	...
	**/
	public function get_actors_in_selection_rectangle(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    Pawn:
	**/
	public function get_owning_pawn(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function get_text_size(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public var lost_focus_paused : Dynamic;
	/**
	...
	**/
	public var player_owner : Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Args:
		    ...
		    size_y (int32):
	**/
	public function receive_draw_hud(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Args:
		    box_name (Name):
	**/
	public function receive_hit_box_begin_cursor_over(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Args:
		    box_name (Name):
	**/
	public function receive_hit_box_click(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Args:
		    box_name (Name):
	**/
	public function receive_hit_box_end_cursor_over(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Args:
		    box_name (Name):
	**/
	public function receive_hit_box_release(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public var show_debug_info : Dynamic;
	/**
		(bool):  [Read-Write] If true, show hitbox debugging info.
	**/
	public var show_hit_box_debug_info : Dynamic;
	/**
	...
	**/
	public var show_overlays : Dynamic;
	/**
