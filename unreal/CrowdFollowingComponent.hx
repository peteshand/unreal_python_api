...
package unreal;
@:pythonImport("unreal", "CrowdFollowingComponent") extern class CrowdFollowingComponent {
	...
	**/
	...
	/**
		...
		Returns:
		    PathFollowingAction:
	**/
	public function get_path_action_type(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Returns:
		    Vector:
	**/
	public function get_path_destination(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Args:
		    suspend (bool):
	**/
	public function suspend_crowd_steering(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
