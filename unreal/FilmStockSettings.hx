...
package unreal;
@:pythonImport("unreal", "FilmStockSettings") extern class FilmStockSettings {
	/**
		Return self+value.
	**/
	...
	**/
	public var toe : Dynamic;
	/**
		(float):  [Read-Write] White Clip
	**/
	public var white_clip : Dynamic;
}