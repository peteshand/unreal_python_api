...
package unreal;
@:pythonImport("unreal", "RotatingMovementComponent") extern class RotatingMovementComponent {
	...
	**/
	public var pivot_translation : Dynamic;
	/**
	...
	**/
	public var rotation_in_local_space : Dynamic;
	/**
