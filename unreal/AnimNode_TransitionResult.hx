...
package unreal;
@:pythonImport("unreal", "AnimNode_TransitionResult") extern class AnimNode_TransitionResult {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		(bool):  [Read-Write] Can Enter Transition
	**/
	public var can_enter_transition : Dynamic;
	/**
