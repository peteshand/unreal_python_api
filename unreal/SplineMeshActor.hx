...
package unreal;
@:pythonImport("unreal", "SplineMeshActor") extern class SplineMeshActor {
	...
	**/
	...
	/**
		(SplineMeshComponent):  [Read-Only] Spline Mesh Component
	**/
	public var spline_mesh_component : Dynamic;
	/**
