...
package unreal;
@:pythonImport("unreal", "FieldSystemMetaDataIteration") extern class FieldSystemMetaDataIteration {
	...
	**/
	public function set_meta_data_iteration(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
