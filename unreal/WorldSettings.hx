...
package unreal;
@:pythonImport("unreal", "WorldSettings") extern class WorldSettings {
	...
	**/
	public var default_color_scale : Dynamic;
	/**
	...
	**/
	public var enable_ai_system : Dynamic;
	/**
	...
	**/
	public var enable_navigation_system : Dynamic;
	/**
		(bool):  [Read-Only] If true, enables CheckStillInWorld checks
	**/
	public var enable_world_bounds_checks : Dynamic;
	/**
	...
	**/
	public var mono_culling_distance : Dynamic;
	/**
	...
	**/
	public var navigation_system_config : Dynamic;
	/**
	...
	**/
	public var use_client_side_level_streaming_volumes : Dynamic;
	/**
	...
	**/
	public var world_to_meters : Dynamic;
}