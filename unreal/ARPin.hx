...
package unreal;
@:pythonImport("unreal", "ARPin") extern class ARPin {
	...
	**/
	public function get_pinned_component(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public var on_ar_tracking_state_changed : Dynamic;
	/**
		(OnARTransformUpdated):  [Read-Write] On ARTransform Updated
	**/
	public var on_ar_transform_updated : Dynamic;
	/**
