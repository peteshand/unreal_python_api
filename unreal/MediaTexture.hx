...
package unreal;
@:pythonImport("unreal", "MediaTexture") extern class MediaTexture {
	...
	**/
	public var current_aspect_ratio : Dynamic;
	/**
		(MediaTextureOrientation):  [Read-Only] Current media orientation
	**/
	public var current_orientation : Dynamic;
	/**
	...
	**/
	public var enable_gen_mips : Dynamic;
	/**
	...
	**/
	public function get_aspect_ratio(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function get_height(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function get_width(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public var new_style_output : Dynamic;
	/**
