...
package unreal;
@:pythonImport("unreal", "FunctionalTestLogHandling") extern class FunctionalTestLogHandling {
	static public var OUTPUT_IGNORED : Dynamic;
	static public var OUTPUT_IS_ERROR : Dynamic;
