...
package unreal;
@:pythonImport("unreal", "DirectionalLightComponent") extern class DirectionalLightComponent {
	...
	**/
	public var atmosphere_sun_disk_color_scale : Dynamic;
	/**
		(int32):  [Read-Only] Two atmosphere lights are supported. For instance: a sun and a moon, or two suns.
	**/
	public var atmosphere_sun_light_index : Dynamic;
	/**
	...
	**/
	public var cascade_distribution_exponent : Dynamic;
	/**
	...
	**/
	public var cascade_transition_fraction : Dynamic;
	/**
	...
	**/
	public var cast_cloud_shadows : Dynamic;
	/**
	...
	**/
	public var cast_modulated_shadows : Dynamic;
	/**
	...
	**/
	public var cast_shadows_on_atmosphere : Dynamic;
	/**
	...
	**/
	public var cast_shadows_on_clouds : Dynamic;
	/**
	...
	**/
	public var cloud_shadow_ray_sample_count_scale : Dynamic;
	/**
		(float):  [Read-Only] The overall strength of the cloud shadow, higher value will block more light.
	**/
	public var cloud_shadow_strength : Dynamic;
	/**
	...
	**/
	public var distance_field_shadow_distance : Dynamic;
	/**
	...
	**/
	public var dynamic_shadow_cascades : Dynamic;
	/**
	...
	**/
	public var enable_light_shaft_occlusion : Dynamic;
	/**
	...
	**/
	public var far_shadow_cascade_count : Dynamic;
	/**
	...
	**/
	public var far_shadow_distance : Dynamic;
	/**
	...
	**/
	public var light_shaft_override_direction : Dynamic;
	/**
	...
	**/
	public var light_source_angle : Dynamic;
	/**
		(float):  [Read-Only] Angle subtended by soft light source in degrees.
	**/
	public var light_source_soft_angle : Dynamic;
	/**
	...
	**/
	public var modulated_shadow_color : Dynamic;
	/**
	...
	**/
	public var per_pixel_atmosphere_transmittance : Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Args:
		    new_value (bool):
	**/
	public function set_atmosphere_sun_light(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Args:
		    new_value (int32):
	**/
	public function set_atmosphere_sun_light_index(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Args:
		    new_value (float):
	**/
	public function set_cascade_distribution_exponent(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Args:
		    new_value (float):
	**/
	public function set_cascade_transition_fraction(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Args:
		    new_value (int32):
	**/
	public function set_dynamic_shadow_cascades(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Args:
		    new_value (float):
	**/
	public function set_dynamic_shadow_distance_movable_light(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Args:
		    new_value (float):
	**/
	public function set_dynamic_shadow_distance_stationary_light(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Args:
		    new_value (bool):
	**/
	public function set_enable_light_shaft_occlusion(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Args:
		    new_value (Vector):
	**/
	public function set_light_shaft_override_direction(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Args:
		    new_value (float):
	**/
	public function set_occlusion_mask_darkness(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Args:
		    new_value (float):
	**/
	public function set_shadow_amount(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Args:
		    new_value (float):
	**/
	public function set_shadow_distance_fadeout_fraction(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public var shadow_amount : Dynamic;
	/**
	...
	**/
	public var shadow_cascade_bias_distribution : Dynamic;
	/**
	...
	**/
	public var shadow_distance_fadeout_fraction : Dynamic;
	/**
	...
	**/
	public var shadow_source_angle_factor : Dynamic;
	/**
	...
	**/
	public var trace_distance : Dynamic;
	/**
	...
	**/
	public var use_inset_shadows_for_movable_objects : Dynamic;
	/**
	...
	**/
	public var used_as_atmosphere_sun_light : Dynamic;
	/**
