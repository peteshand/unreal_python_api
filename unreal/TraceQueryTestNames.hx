...
package unreal;
@:pythonImport("unreal", "TraceQueryTestNames") extern class TraceQueryTestNames {
	/**
		Return self+value.
	**/
	...
	**/
	public var component_name : Dynamic;
	/**
	...
	**/
	public var physical_material_name : Dynamic;
	/**
