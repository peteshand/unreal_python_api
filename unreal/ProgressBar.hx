...
package unreal;
@:pythonImport("unreal", "ProgressBar") extern class ProgressBar {
	...
	**/
	public var bar_fill_type : Dynamic;
	/**
		(Vector2D):  [Read-Only] Border Padding
	**/
	public var border_padding : Dynamic;
	/**
	...
	**/
	public var fill_color_and_opacity : Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Args:
		    color (LinearColor):
	**/
	public function set_fill_color_and_opacity(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		x.set_focus() -> None
	...
	**/
	...
	/**
		...
		Args:
		    inb_is_marquee (bool):
	**/
	public function set_is_marquee(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Args:
		    percent (float):
	**/
	public function set_percent(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
