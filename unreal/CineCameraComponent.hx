...
@:pythonImport("unreal", "CineCameraComponent") extern class CineCameraComponent {
	...
	**/
	public function get_filmback_presets_copy(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function get_lens_presets_copy(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
