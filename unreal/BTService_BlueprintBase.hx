...
package unreal;
@:pythonImport("unreal", "BTService_BlueprintBase") extern class BTService_BlueprintBase {
	...
	**/
	...
	/**
		...
		Returns:
		    bool:
	**/
	public function is_service_active(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Args:
		    owner_actor (Actor):
	**/
	public function receive_activation(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function receive_activation_ai(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Args:
		    owner_actor (Actor):
	**/
	public function receive_deactivation(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Args:
		    ...
		    controlled_pawn (Pawn):
	**/
	public function receive_deactivation_ai(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Args:
		    owner_actor (Actor):
	**/
	public function receive_search_start(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Args:
		    ...
		    controlled_pawn (Pawn):
	**/
	public function receive_search_start_ai(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
