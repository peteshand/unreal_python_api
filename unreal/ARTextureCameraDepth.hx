...
package unreal;
@:pythonImport("unreal", "ARTextureCameraDepth") extern class ARTextureCameraDepth {
	...
	**/
	public var external_texture_guid : Dynamic;
	/**
	...
	**/
	public var is_temporally_smoothed : Dynamic;
	/**
	...
	**/
	public var texture_type : Dynamic;
	/**
