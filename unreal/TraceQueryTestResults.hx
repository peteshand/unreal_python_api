...
package unreal;
@:pythonImport("unreal", "TraceQueryTestResults") extern class TraceQueryTestResults {
	...
	**/
	public var batch_options : Dynamic;
	/**
	...
	**/
	public var channel_results : Dynamic;
	/**
	...
	**/
	public var object_results : Dynamic;
	/**
		(TraceQueryTestResultsInner):  [Read-Write] Results for profile trace
	**/
	public var profile_results : Dynamic;
	/**
