...
package unreal;
@:pythonImport("unreal", "BodyCollisionResponse") extern class BodyCollisionResponse {
	static public var BODY_COLLISION_DISABLED : Dynamic;
	static public var BODY_COLLISION_ENABLED : Dynamic;
	/**
