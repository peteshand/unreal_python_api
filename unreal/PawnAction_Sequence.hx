...
package unreal;
@:pythonImport("unreal", "PawnAction_Sequence") extern class PawnAction_Sequence {
	...
	**/
	...
	/**
		(PawnActionFailHandling):  [Read-Only] Child Failure Handling Mode
	**/
	public var child_failure_handling_mode : Dynamic;
	/**
