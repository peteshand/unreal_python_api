...
package unreal;
@:pythonImport("unreal", "NavigationTestingActor") extern class NavigationTestingActor {
	...
	**/
	public var path_cost : Dynamic;
	/**
		(bool):  [Read-Only] Path Exist
	**/
	public var path_exist : Dynamic;
	/**
		(bool):  [Read-Only] Path Is Partial
	**/
	public var path_is_partial : Dynamic;
	/**
		(bool):  [Read-Only] Path Search Out Of Nodes
	**/
	public var path_search_out_of_nodes : Dynamic;
	/**
		(int32):  [Read-Only] Pathfinding Steps
	**/
	public var pathfinding_steps : Dynamic;
	/**
		(float):  [Read-Only] Time in micro seconds
	**/
	public var pathfinding_time : Dynamic;
	/**
	...
	**/
	public var projected_location : Dynamic;
	/**
		(bool):  [Read-Only] Projected Location Valid
	**/
	public var projected_location_valid : Dynamic;
	/**
