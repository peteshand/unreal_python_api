...
package unreal;
@:pythonImport("unreal", "MovieSceneScriptingObjectPathChannel") extern class MovieSceneScriptingObjectPathChannel {
	...
	**/
	...
	/**
		x.add_key(time, new_value, sub_frame=0.000000, time_unit=SequenceTimeUnit.DISPLAY_RATE) -> MovieSceneScriptingObjectPathKey
