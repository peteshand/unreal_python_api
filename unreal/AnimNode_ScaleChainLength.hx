...
package unreal;
@:pythonImport("unreal", "AnimNode_ScaleChainLength") extern class AnimNode_ScaleChainLength {
	/**
		Return self+value.
	**/
	...
	**/
	public var default_chain_length : Dynamic;
	/**
	...
	**/
	public var target_location : Dynamic;
	/**
