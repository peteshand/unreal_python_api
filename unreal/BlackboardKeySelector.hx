...
package unreal;
@:pythonImport("unreal", "BlackboardKeySelector") extern class BlackboardKeySelector {
	/**
		Return self+value.
	**/
	...
	**/
	public var allowed_types : Dynamic;
	/**
	...
	**/
	public var none_is_allowed_value : Dynamic;
	/**
	...
	**/
	public var selected_key_name : Dynamic;
	/**
