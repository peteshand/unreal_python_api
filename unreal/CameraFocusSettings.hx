...
package unreal;
@:pythonImport("unreal", "CameraFocusSettings") extern class CameraFocusSettings {
	/**
		Return self+value.
	**/
	...
	**/
	public var focus_smoothing_interp_speed : Dynamic;
	/**
	...
	**/
	public var manual_focus_distance : Dynamic;
	/**
	...
	**/
	public var smooth_focus_changes : Dynamic;
	/**
	...
	**/
	public var tracking_focus_settings : Dynamic;
}