...
package unreal;
@:pythonImport("unreal", "InterpControlPoint") extern class InterpControlPoint {
	/**
		Return self+value.
	**/
	...
	**/
	public var position_control_point : Dynamic;
	/**
		(bool):  [Read-Write] Is the location relative to the root components initial location
	**/
	public var position_is_relative : Dynamic;
	/**
