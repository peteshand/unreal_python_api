...
package unreal;
@:pythonImport("unreal", "MovieScene3DPathSection") extern class MovieScene3DPathSection {
	...
	**/
	public var force_upright : Dynamic;
	/**
		(MovieScene3DPathSection_Axis):  [Read-Write] Front Axis
	**/
	public var front_axis_enum : Dynamic;
	/**
	...
	**/
	public var up_axis_enum : Dynamic;
}