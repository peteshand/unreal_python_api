...
package unreal;
@:pythonImport("unreal", "CurveEditorBakeFilter") extern class CurveEditorBakeFilter {
	...
	**/
	public var bake_interval : Dynamic;
	/**
	...
	**/
	public var use_snap_rate_for_interval : Dynamic;
}