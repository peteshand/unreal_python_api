...
package unreal;
@:pythonImport("unreal", "AnimSharingStateInstance") extern class AnimSharingStateInstance {
	...
	**/
	public var animation_to_play : Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    ...
		    actors (Array(Actor)):
	**/
	public function get_instanced_actors(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public var permutation_time_offset : Dynamic;
	/**
