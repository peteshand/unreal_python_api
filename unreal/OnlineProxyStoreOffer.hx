...
package unreal;
@:pythonImport("unreal", "OnlineProxyStoreOffer") extern class OnlineProxyStoreOffer {
	/**
		Return self+value.
	**/
	...
	**/
	public var discount_type : Dynamic;
	/**
	...
	**/
	public var expiration_date : Dynamic;
	/**
