...
package unreal;
@:pythonImport("unreal", "AttenuationSubmixSendSettings") extern class AttenuationSubmixSendSettings {
	/**
		Return self+value.
	**/
	...
	**/
	public var custom_submix_send_curve : Dynamic;
	/**
	...
	**/
	public var manual_submix_send_level : Dynamic;
	/**
	...
	**/
	public var submix : Dynamic;
	/**
		(float):  [Read-Write] The max distance to send to the Submix.
	**/
	public var submix_send_distance_max : Dynamic;
	/**
		(float):  [Read-Write] The min distance to send to the Submix.
	**/
	public var submix_send_distance_min : Dynamic;
	/**
	...
	**/
	public var submix_send_level_max : Dynamic;
	/**
	...
	**/
	public var submix_send_level_min : Dynamic;
	/**
		(SubmixSendMethod):  [Read-Write] What method to use to use for submix sends.
	**/
	public var submix_send_method : Dynamic;
	/**
