...
package unreal;
@:pythonImport("unreal", "FFTPeakInterpolationMethod") extern class FFTPeakInterpolationMethod {
	static public var CONSTANT_Q : Dynamic;
	static public var LINEAR : Dynamic;
	static public var NEAREST_NEIGHBOR : Dynamic;
