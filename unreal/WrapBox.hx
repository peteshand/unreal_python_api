...
package unreal;
@:pythonImport("unreal", "WrapBox") extern class WrapBox {
	...
	**/
	...
	/**
		...
		Returns:
		    WrapBoxSlot:
	**/
	public function add_child_to_wrap_box(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		deprecated: 'add_child_wrap_box' was renamed to 'add_child_to_wrap_box'.
	**/
	public function add_child_wrap_box(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public var explicit_wrap_size : Dynamic;
	/**
	...
	**/
	public var inner_slot_padding : Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Args:
		    padding (Vector2D):
	**/
	public function set_inner_slot_padding(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
