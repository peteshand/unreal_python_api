...
package unreal;
@:pythonImport("unreal", "InAppPurchaseProductInfo2") extern class InAppPurchaseProductInfo2 {
	/**
		Return self+value.
	**/
	...
	**/
	public var display_price : Dynamic;
	/**
	...
	**/
	public var grouping_separator : Dynamic;
	/**
	...
	**/
	public var raw_price : Dynamic;
	/**
		(str):  [Read-Only] Opaque receipt data for the transaction
	**/
	public var receipt_data : Dynamic;
	/**
	...
	**/
	public var transaction_identifier : Dynamic;
}