...
package unreal;
@:pythonImport("unreal", "EdgeToCreate") extern class EdgeToCreate {
	/**
		Return self+value.
	**/
	...
	**/
	public var edge_attributes : Dynamic;
	/**
	...
	**/
	public var original_edge_id : Dynamic;
	/**
	...
	**/
	public var vertex_id0 : Dynamic;
	/**
		(VertexID):  [Read-Write] The second vertex this edge connects
	**/
	public var vertex_id1 : Dynamic;
}