...
package unreal;
@:pythonImport("unreal", "PredictProjectilePathParams") extern class PredictProjectilePathParams {
	/**
		Return self+value.
	**/
	...
	**/
	public var actors_to_ignore : Dynamic;
	/**
	...
	**/
	public var draw_debug_time : Dynamic;
	/**
		(DrawDebugTrace):  [Read-Write] Debug drawing duration option.
	**/
	public var draw_debug_type : Dynamic;
	/**
	...
	**/
	public var sim_frequency : Dynamic;
	/**
		(Vector):  [Read-Write] Location of the start of the trace.
	**/
	public var start_location : Dynamic;
	/**
