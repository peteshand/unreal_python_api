...
package unreal;
@:pythonImport("unreal", "PhasedAutomationActorBase") extern class PhasedAutomationActorBase {
	...
	**/
	public function on_functional_testing_begin(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		x.on_functional_testing_complete() -> None
		On Functional Testing Complete
	**/
	public function on_functional_testing_complete(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
