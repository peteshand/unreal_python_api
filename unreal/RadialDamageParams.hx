...
package unreal;
@:pythonImport("unreal", "RadialDamageParams") extern class RadialDamageParams {
	/**
		Return self+value.
	**/
	...
	**/
	public var base_damage : Dynamic;
	/**
