...
package unreal;
@:pythonImport("unreal", "DatasmithImportBaseOptions") extern class DatasmithImportBaseOptions {
	/**
		Return self+value.
	**/
	...
	**/
	public var asset_options : Dynamic;
	/**
	...
	**/
	public var static_mesh_options : Dynamic;
	/**
