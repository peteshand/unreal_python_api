...
package unreal;
@:pythonImport("unreal", "FbxStaticMeshImportData") extern class FbxStaticMeshImportData {
	...
	**/
	public var auto_generate_collision : Dynamic;
	/**
	...
	**/
	public var bake_pivot_in_vertex : Dynamic;
	/**
	...
	**/
	public var combine_meshes : Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    str:
	**/
	public function get_first_filename(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public var import_mesh_lo_ds : Dynamic;
	/**
		(Rotator):  [Read-Write] Import Rotation
	**/
	public var import_rotation : Dynamic;
	/**
		(Vector):  [Read-Write] Import Translation
	**/
	public var import_translation : Dynamic;
	/**
		(float):  [Read-Write] Import Uniform Scale
	**/
	public var import_uniform_scale : Dynamic;
	/**
	...
	**/
	public var normal_generation_method : Dynamic;
	/**
	...
	**/
	public var normal_import_method : Dynamic;
	/**
	...
	**/
	public var one_convex_hull_per_ucx : Dynamic;
	/**
	...
	**/
	public var reorder_material_to_fbx_order : Dynamic;
	/**
	...
	**/
	public function scripted_add_filename(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public var static_mesh_lod_group : Dynamic;
	/**
