...
package unreal;
@:pythonImport("unreal", "LevelStreamingVolume") extern class LevelStreamingVolume {
	...
	**/
	public var editor_pre_vis_only : Dynamic;
	/**
	...
	**/
	public var streaming_level_names : Dynamic;
	/**
	...
	**/
	public var streaming_usage : Dynamic;
	/**
