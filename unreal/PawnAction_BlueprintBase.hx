...
package unreal;
@:pythonImport("unreal", "PawnAction_BlueprintBase") extern class PawnAction_BlueprintBase {
	...
	**/
	public function action_finished(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Args:
		    controlled_pawn (Pawn):
	**/
	public function action_pause(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Args:
		    controlled_pawn (Pawn):
	**/
	public function action_resume(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Args:
		    controlled_pawn (Pawn):
	**/
	public function action_start(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Args:
		    ...
		    delta_seconds (float):
	**/
	public function action_tick(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public var allow_new_same_class_instance : Dynamic;
	/**
		(bool):  [Read-Write] if set, action will call OnFinished notify even when ending as FailedToStart
	**/
	public var always_notify_on_finished : Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    PawnAction:
	**/
	static public function create_action_instance(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    AIRequestPriority:
	**/
	public function get_action_priority(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public var replace_active_same_class_instance : Dynamic;
	/**
	...
	**/
	public var should_pause_movement : Dynamic;
	/**
