...
package unreal;
@:pythonImport("unreal", "ImportLODType") extern class ImportLODType {
	static public var ILT_INDIVIDUAL_ACTORS : Dynamic;
	static public var ILT_PAINTED_FOLIAGE : Dynamic;
	/**
