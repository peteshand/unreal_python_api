...
package unreal;
@:pythonImport("unreal", "RuntimeVirtualTexture") extern class RuntimeVirtualTexture {
	...
	**/
	public var compress_textures : Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    int32:
	**/
	public function get_page_table_size(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public var material_type : Dynamic;
	/**
	...
	**/
	public var tile_border_size : Dynamic;
	/**
