...
package unreal;
@:pythonImport("unreal", "PaperTileMap") extern class PaperTileMap {
	...
	**/
	public var collision_thickness : Dynamic;
	/**
	...
	**/
	public var map_height : Dynamic;
	/**
		(int32):  [Read-Only] Width of map (in tiles)
	**/
	public var map_width : Dynamic;
	/**
	...
	**/
	public var separation_per_layer : Dynamic;
	/**
	...
	**/
	public var sprite_collision_domain : Dynamic;
	/**
