...
package unreal;
@:pythonImport("unreal", "VariantManagerTestActor") extern class VariantManagerTestActor {
	...
	**/
	public var captured_bool_property : Dynamic;
	/**
	...
	**/
	public var captured_color_property : Dynamic;
	/**
		(float):  [Read-Write] Captured float property
	**/
	public var captured_float_property : Dynamic;
	/**
		(IntPoint):  [Read-Write] Captured FIntPoint property
	**/
	public var captured_int_point_property : Dynamic;
	/**
		(int32):  [Read-Write] Captured int32 property
	**/
	public var captured_int_property : Dynamic;
	/**
		(Interface):  [Read-Write] Captured UInterface property
	**/
	public var captured_interface_property : Dynamic;
	/**
		(LinearColor):  [Read-Write] Captured FLinearColor property
	**/
	public var captured_linear_color_property : Dynamic;
	/**
		(Name):  [Read-Write] Captured FName property
	**/
	public var captured_name_property : Dynamic;
	/**
		(Object):  [Read-Write] Captured UObject property
	**/
	public var captured_object_property : Dynamic;
	/**
		(Quat):  [Read-Write] Captured FQuat property
	**/
	public var captured_quat_property : Dynamic;
	/**
		(Rotator):  [Read-Write] Captured FRotator property
	**/
	public var captured_rotator_property : Dynamic;
	/**
		(str):  [Read-Write] Captured FString property
	**/
	public var captured_str_property : Dynamic;
	/**
		(Text):  [Read-Write] Captured FText property
	**/
	public var captured_text_property : Dynamic;
	/**
		(Array(Object)):  [Read-Write] Captured UObject array property
	**/
	public var captured_u_object_array_property : Dynamic;
	/**
		(Vector2D):  [Read-Write] Captured FVector2D property
	**/
	public var captured_vector2d_property : Dynamic;
	/**
		(Vector4):  [Read-Write] Captured FVector4 property
	**/
	public var captured_vector4_property : Dynamic;
	/**
		(Array(Vector)):  [Read-Write] Captured FVector array property
	**/
	public var captured_vector_array_property : Dynamic;
	/**
		(Vector):  [Read-Write] Captured FVector property
	**/
	public var captured_vector_property : Dynamic;
	/**
	...
	**/
	public var enum_with_no_default : Dynamic;
	/**
		(VariantManagerTestEnum):  [Read-Write] Captured byte property
	**/
	public var enum_with_second_default : Dynamic;
	/**
