...
package unreal;
@:pythonImport("unreal", "MediaWebcamCaptureDeviceFilter") extern class MediaWebcamCaptureDeviceFilter {
	static public var DEPTH_SENSOR : Dynamic;
	static public var FRONT : Dynamic;
	static public var REAR : Dynamic;
