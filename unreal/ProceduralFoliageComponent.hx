...
package unreal;
@:pythonImport("unreal", "ProceduralFoliageComponent") extern class ProceduralFoliageComponent {
	...
	**/
	public var foliage_spawner : Dynamic;
	/**
	...
	**/
	public var show_debug_tiles : Dynamic;
	/**
	...
	**/
	public var tile_overlap : Dynamic;
	/**
