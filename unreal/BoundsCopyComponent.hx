...
package unreal;
@:pythonImport("unreal", "BoundsCopyComponent") extern class BoundsCopyComponent {
	...
	**/
	public function set_rotation(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function set_transform_to_bounds(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
