...
package unreal;
@:pythonImport("unreal", "PlayerReplicationInfo") extern class PlayerReplicationInfo {
	...
	**/
	public var is_spectator : Dynamic;
	/**
	...
	**/
	public var pawn_private : Dynamic;
	/**
	...
	**/
	public function receive_copy_properties(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function receive_override_with(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
