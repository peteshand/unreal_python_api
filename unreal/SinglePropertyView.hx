...
package unreal;
@:pythonImport("unreal", "SinglePropertyView") extern class SinglePropertyView {
	...
	**/
	public var on_property_changed : Dynamic;
	/**
	...
	**/
	public function set_property_name(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
