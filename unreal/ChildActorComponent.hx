...
package unreal;
@:pythonImport("unreal", "ChildActorComponent") extern class ChildActorComponent {
	...
	**/
	public var child_actor : Dynamic;
	/**
	...
	**/
	public function set_child_actor_class(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
