...
package unreal;
@:pythonImport("unreal", "RandomPlayerSequenceEntry") extern class RandomPlayerSequenceEntry {
	/**
		Return self+value.
	**/
	...
	**/
	public var chance_to_play : Dynamic;
	/**
