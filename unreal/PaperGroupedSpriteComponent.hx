...
package unreal;
@:pythonImport("unreal", "PaperGroupedSpriteComponent") extern class PaperGroupedSpriteComponent {
	...
	**/
	public function sort_instances_along_axis(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    bool:
	**/
	public function update_instance_color(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
