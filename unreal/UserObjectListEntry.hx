...
package unreal;
@:pythonImport("unreal", "UserObjectListEntry") extern class UserObjectListEntry {
	...
	**/
	public function bp_on_entry_released(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Args:
		    is_expanded (bool):
	**/
	public function bp_on_item_expansion_changed(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Args:
		    is_selected (bool):
	**/
	public function bp_on_item_selection_changed(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function on_list_item_object_set(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
