...
package unreal;
@:pythonImport("unreal", "MediaTextureOutputFormat") extern class MediaTextureOutputFormat {
	static public var MTOF_DEFAULT : Dynamic;
	static public var MTOF_SRGB_LINOUT : Dynamic;
	/**
