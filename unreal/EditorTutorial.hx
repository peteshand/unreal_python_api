...
package unreal;
@:pythonImport("unreal", "EditorTutorial") extern class EditorTutorial {
	...
	**/
	public function on_tutorial_closed(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		x.on_tutorial_launched() -> None
		Event fired when a tutorial is launched
	**/
	public function on_tutorial_launched(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Args:
		    stage_name (Name):
	**/
	public function on_tutorial_stage_ended(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Args:
		    stage_name (Name):
	**/
	public function on_tutorial_stage_started(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
