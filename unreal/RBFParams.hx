...
package unreal;
@:pythonImport("unreal", "RBFParams") extern class RBFParams {
	/**
		Return self+value.
	**/
	...
	**/
	public var automatic_radius : Dynamic;
	/**
	...
	**/
	public var distance_method : Dynamic;
	/**
	...
	**/
	public var solver_type : Dynamic;
	/**
