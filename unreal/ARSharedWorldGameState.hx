...
package unreal;
@:pythonImport("unreal", "ARSharedWorldGameState") extern class ARSharedWorldGameState {
	...
	**/
	public var authority_game_mode : Dynamic;
	/**
	...
	**/
	public var elapsed_time : Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    float:
	**/
	public function get_player_respawn_delay(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Returns:
		    float:
	**/
	public function get_player_start_time(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    float:
	**/
	public function get_server_world_time_seconds(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    bool:
	**/
	public function has_begun_play(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public var match_state : Dynamic;
	/**
	...
	**/
	public function on_ar_world_map_is_ready(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public var player_array : Dynamic;
	/**
	...
	**/
	public var preview_image_bytes_delivered : Dynamic;
	/**
		(int32):  [Read-Only] The size of the image that will be replicated to each client
	**/
	public var preview_image_bytes_total : Dynamic;
	/**
