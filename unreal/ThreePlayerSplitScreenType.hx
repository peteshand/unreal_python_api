...
package unreal;
@:pythonImport("unreal", "ThreePlayerSplitScreenType") extern class ThreePlayerSplitScreenType {
	static public var FAVOR_BOTTOM : Dynamic;
	static public var FAVOR_TOP : Dynamic;
