...
package unreal;
@:pythonImport("unreal", "MaterialExpressionTextureCoordinate") extern class MaterialExpressionTextureCoordinate {
	...
	**/
	public var coordinate_index : Dynamic;
	/**
