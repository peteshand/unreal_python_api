...
package unreal;
@:pythonImport("unreal", "DepthFieldGlowInfo") extern class DepthFieldGlowInfo {
	/**
		Return self+value.
	**/
	...
	**/
	public var enable_glow : Dynamic;
	/**
	...
	**/
	public var glow_inner_radius : Dynamic;
	/**
	...
	**/
	public var glow_outer_radius : Dynamic;
	/**
