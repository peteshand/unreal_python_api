...
package unreal;
@:pythonImport("unreal", "SolverIterations") extern class SolverIterations {
	/**
		Return self+value.
	**/
	...
	**/
	public var fixed_time_step : Dynamic;
	/**
	...
	**/
	public var joint_iterations : Dynamic;
	/**
		(int32):  [Read-Write] [Chaos Only]
		The recommended number of joint sub-push-out iterations.
	**/
	public var joint_push_out_iterations : Dynamic;
	/**
	...
	**/
	public var solver_push_out_iterations : Dynamic;
	/**
