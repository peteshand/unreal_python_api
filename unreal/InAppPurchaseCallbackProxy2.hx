...
@:pythonImport("unreal", "InAppPurchaseCallbackProxy2") extern class InAppPurchaseCallbackProxy2 {
	...
	**/
	public function create_proxy_object_for_in_app_purchase(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Returns:
		    InAppPurchaseCallbackProxy2:
	**/
	public function create_proxy_object_for_in_app_purchase_query_owned(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Returns:
		    InAppPurchaseCallbackProxy2:
	**/
	public function create_proxy_object_for_in_app_purchase_unprocessed_purchases(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
