...
package unreal;
@:pythonImport("unreal", "TimelineLengthMode") extern class TimelineLengthMode {
	static public var TL_LAST_KEY_FRAME : Dynamic;
	static public var TL_TIMELINE_LENGTH : Dynamic;
	/**
