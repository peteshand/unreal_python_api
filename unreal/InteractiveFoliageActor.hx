...
package unreal;
@:pythonImport("unreal", "InteractiveFoliageActor") extern class InteractiveFoliageActor {
	...
	**/
	public var foliage_damage_impulse_scale : Dynamic;
	/**
	...
	**/
	public var foliage_stiffness_quadratic : Dynamic;
	/**
		(float):  [Read-Write] Scales forces applied from touch events.
	**/
	public var foliage_touch_impulse_scale : Dynamic;
	/**
	...
	**/
	public var static_mesh_component : Dynamic;
	/**
