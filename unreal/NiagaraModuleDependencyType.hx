...
package unreal;
@:pythonImport("unreal", "NiagaraModuleDependencyType") extern class NiagaraModuleDependencyType {
	static public var POST_DEPENDENCY : Dynamic;
	static public var PRE_DEPENDENCY : Dynamic;
	/**
