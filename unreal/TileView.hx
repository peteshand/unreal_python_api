...
package unreal;
@:pythonImport("unreal", "TileView") extern class TileView {
	...
	**/
	...
	/**
		...
		Returns:
		    float:
	**/
	public function get_entry_height(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Returns:
		    float:
	**/
	public function get_entry_width(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Args:
		    new_height (float):
	**/
	public function set_entry_height(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Args:
		    new_width (float):
	**/
	public function set_entry_width(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		x.set_focus() -> None
