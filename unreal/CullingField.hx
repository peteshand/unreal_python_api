...
package unreal;
@:pythonImport("unreal", "CullingField") extern class CullingField {
	...
	**/
	...
	/**
		...
		Returns:
		    CullingField:
	**/
	public function set_culling_field(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
