...
package unreal;
@:pythonImport("unreal", "ARFilter") extern class ARFilter {
	/**
		Return self+value.
	**/
	...
	**/
	public var class_names : Dynamic;
	/**
	...
	**/
	public var recursive_paths : Dynamic;
	/**
