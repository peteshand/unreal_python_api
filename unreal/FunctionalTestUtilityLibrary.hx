...
package unreal;
@:pythonImport("unreal", "FunctionalTestUtilityLibrary") extern class FunctionalTestUtilityLibrary {
	...
	**/
	static public function trace_channel_test_util(args:haxe.extern.Rest<Dynamic>):Dynamic;
}