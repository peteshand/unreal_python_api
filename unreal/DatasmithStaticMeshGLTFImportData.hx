...
package unreal;
@:pythonImport("unreal", "DatasmithStaticMeshGLTFImportData") extern class DatasmithStaticMeshGLTFImportData {
	...
	**/
	...
	/**
		(DatasmithAssetImportOptions):  [Read-Write] Asset Import Options
	**/
	public var asset_import_options : Dynamic;
	/**
