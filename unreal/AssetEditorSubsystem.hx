...
package unreal;
@:pythonImport("unreal", "AssetEditorSubsystem") extern class AssetEditorSubsystem {
	...
	**/
	...
	/**
		...
		Returns:
		    int32:
	**/
	public function close_all_editors_for_asset(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
