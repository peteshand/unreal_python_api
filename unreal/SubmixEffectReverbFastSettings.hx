...
package unreal;
@:pythonImport("unreal", "SubmixEffectReverbFastSettings") extern class SubmixEffectReverbFastSettings {
	/**
		Return self+value.
	**/
	...
	**/
	public var air_absorption_gain_hf : Dynamic;
	/**
	...
	**/
	public var bypass : Dynamic;
	/**
		(bool):  [Read-Write] Bypasses early reflections
	**/
	public var bypass_early_reflections : Dynamic;
	/**
		(bool):  [Read-Write] Bypasses late reflections.
	**/
	public var bypass_late_reflections : Dynamic;
	/**
