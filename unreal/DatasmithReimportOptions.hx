...
package unreal;
@:pythonImport("unreal", "DatasmithReimportOptions") extern class DatasmithReimportOptions {
	/**
		Return self+value.
	**/
	...
	**/
	public var respawn_deleted_actors : Dynamic;
	/**
	...
	**/
	public var update_actors : Dynamic;
}