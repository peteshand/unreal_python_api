...
package unreal;
@:pythonImport("unreal", "SafeZone") extern class SafeZone {
	...
	**/
	...
	/**
		...
		Args:
		    ...
		    pad_bottom (bool):
	**/
	public function set_sides_to_pad(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
