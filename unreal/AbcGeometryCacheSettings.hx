...
package unreal;
@:pythonImport("unreal", "AbcGeometryCacheSettings") extern class AbcGeometryCacheSettings {
	/**
		Return self+value.
	**/
	...
	**/
	public var apply_constant_topology_optimizations : Dynamic;
	/**
	...
	**/
	public var compressed_position_precision : Dynamic;
	/**
	...
	**/
	public var compressed_texture_coordinates_number_of_bits : Dynamic;
	/**
	...
	**/
	public var flatten_tracks : Dynamic;
	/**
	...
	**/
	public var motion_vectors : Dynamic;
	/**
	...
	**/
	public var optimize_index_buffers : Dynamic;
	/**
