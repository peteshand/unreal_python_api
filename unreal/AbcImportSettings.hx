...
package unreal;
@:pythonImport("unreal", "AbcImportSettings") extern class AbcImportSettings {
	...
	**/
	public var conversion_settings : Dynamic;
	/**
		(AbcGeometryCacheSettings):  [Read-Write] Geometry Cache Settings
	**/
	public var geometry_cache_settings : Dynamic;
	/**
	...
	**/
	public var import_type : Dynamic;
	/**
	...
	**/
	public var normal_generation_settings : Dynamic;
	/**
	...
	**/
	public var sampling_settings : Dynamic;
	/**
	...
	**/
	public var static_mesh_settings : Dynamic;
}