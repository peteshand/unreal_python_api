...
package unreal;
@:pythonImport("unreal", "BillboardComponent") extern class BillboardComponent {
	...
	**/
	public function set_sprite(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Args:
		    ...
		    new_vl (int32):
	**/
	public function set_sprite_and_uv(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Args:
		    ...
		    new_vl (int32):
	**/
	public function set_uv(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
