...
package unreal;
@:pythonImport("unreal", "EditorScriptingMergeStaticMeshActorsOptions") extern class EditorScriptingMergeStaticMeshActorsOptions {
	/**
		Return self+value.
	**/
	...
	**/
	public var base_package_name : Dynamic;
	/**
	...
	**/
	public var destroy_source_actors : Dynamic;
	/**
	...
	**/
	public var spawn_merged_actor : Dynamic;
	/**
