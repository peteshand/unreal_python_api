...
package unreal;
@:pythonImport("unreal", "TemplateSequencePlayer") extern class TemplateSequencePlayer {
	...
	**/
	static public function create_template_sequence_player(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
