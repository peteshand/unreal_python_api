...
package unreal;
@:pythonImport("unreal", "AnimNode_SequencePlayer") extern class AnimNode_SequencePlayer {
	/**
		Return self+value.
	**/
	...
	**/
	public var loop_animation : Dynamic;
	/**
