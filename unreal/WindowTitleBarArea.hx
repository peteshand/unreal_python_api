...
package unreal;
@:pythonImport("unreal", "WindowTitleBarArea") extern class WindowTitleBarArea {
	...
	**/
	public var double_click_toggles_fullscreen : Dynamic;
	/**
	...
	**/
	public var window_buttons_enabled : Dynamic;
}