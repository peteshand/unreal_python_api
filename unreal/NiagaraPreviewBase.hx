...
package unreal;
@:pythonImport("unreal", "NiagaraPreviewBase") extern class NiagaraPreviewBase {
	...
	**/
	...
	/**
		...
		Args:
		    ...
		    y_axis_text (Text):
	**/
	public function set_label_text(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function set_system(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
