...
package unreal;
@:pythonImport("unreal", "SoundAttenuationPluginSettings") extern class SoundAttenuationPluginSettings {
	/**
		Return self+value.
	**/
	...
	**/
	public var occlusion_plugin_settings_array : Dynamic;
	/**
	...
	**/
	public var reverb_plugin_settings_array : Dynamic;
	/**
	...
	**/
	public var spatialization_plugin_settings_array : Dynamic;
	/**
