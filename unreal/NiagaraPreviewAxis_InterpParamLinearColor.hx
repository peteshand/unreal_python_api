...
package unreal;
@:pythonImport("unreal", "NiagaraPreviewAxis_InterpParamLinearColor") extern class NiagaraPreviewAxis_InterpParamLinearColor {
	...
	**/
	...
	/**
		...
		Returns:
		    ...
		    out_label_text (str):
	**/
	public function apply_to_preview(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
