...
package unreal;
@:pythonImport("unreal", "SoundConcurrencySettings") extern class SoundConcurrencySettings {
	/**
		Return self+value.
	**/
	...
	**/
	public var retrigger_time : Dynamic;
	/**
	...
	**/
	public var voice_steal_release_time : Dynamic;
	/**
		(float):  [Read-Write] Time taken to apply duck using volume scalar.
	**/
	public var volume_scale_attack_time : Dynamic;
	/**
	...
	**/
	public var volume_scale_can_release : Dynamic;
	/**
	...
	**/
	public var volume_scale_mode : Dynamic;
	/**
		(float):  [Read-Write] Time taken to recover volume scalar duck.
	**/
	public var volume_scale_release_time : Dynamic;
}