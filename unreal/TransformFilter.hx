...
package unreal;
@:pythonImport("unreal", "TransformFilter") extern class TransformFilter {
	/**
		Return self+value.
	**/
	...
	**/
	public var rotation_filter : Dynamic;
	/**
		(FilterOptionPerAxis):  [Read-Write] Scale Filter
	**/
	public var scale_filter : Dynamic;
	/**
	...
	**/
	public var translation_filter : Dynamic;
}