...
package unreal;
@:pythonImport("unreal", "AssetActionUtility") extern class AssetActionUtility {
	...
	**/
	...
	/**
		...
		Returns:
		    type(Class):
	**/
	public function get_supported_class(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    bool:
	**/
	public function is_action_for_blueprints(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function run(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
