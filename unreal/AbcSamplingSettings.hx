...
package unreal;
@:pythonImport("unreal", "AbcSamplingSettings") extern class AbcSamplingSettings {
	/**
		Return self+value.
	**/
	...
	**/
	public var sampling_type : Dynamic;
	/**
