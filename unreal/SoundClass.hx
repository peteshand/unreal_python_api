...
package unreal;
@:pythonImport("unreal", "SoundClass") extern class SoundClass {
	...
	**/
	public var child_classes : Dynamic;
	/**
	...
	**/
	public var parent_class : Dynamic;
	/**
	...
	**/
	public var passive_sound_mix_modifiers : Dynamic;
	/**
