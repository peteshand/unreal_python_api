...
package unreal;
@:pythonImport("unreal", "AnimNode_SequenceEvaluator") extern class AnimNode_SequenceEvaluator {
	/**
		Return self+value.
	**/
	...
	**/
	public var explicit_time : Dynamic;
	/**
	...
	**/
	public var reinitialization_behavior : Dynamic;
	/**
	...
	**/
	public var should_loop : Dynamic;
	/**
	...
	**/
	public var teleport_to_explicit_time : Dynamic;
	/**
