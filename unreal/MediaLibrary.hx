...
@:pythonImport("unreal", "MediaLibrary") extern class MediaLibrary {
	...
	**/
	public function enumerate_audio_capture_devices(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Returns:
		    ...
		    out_devices (Array(MediaCaptureDevice)): Will contain the available capture devices.
	**/
	public function enumerate_video_capture_devices(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Returns:
		    ...
		    out_devices (Array(MediaCaptureDevice)): Will contain the available capture devices.
	**/
	public function enumerate_webcam_capture_devices(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
