...
package unreal;
@:pythonImport("unreal", "MediaLibrary") extern class MediaLibrary {
	...
	**/
	static public function enumerate_audio_capture_devices(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Returns:
		    ...
		    out_devices (Array(MediaCaptureDevice)): Will contain the available capture devices.
	**/
	static public function enumerate_video_capture_devices(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Returns:
		    ...
		    out_devices (Array(MediaCaptureDevice)): Will contain the available capture devices.
	**/
	static public function enumerate_webcam_capture_devices(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
