...
package unreal;
@:pythonImport("unreal", "LensImperfectionSettings") extern class LensImperfectionSettings {
	/**
		Return self+value.
	**/
	...
	**/
	public var dirt_mask : Dynamic;
	/**
		(float):  [Read-Write] BloomDirtMask intensity
	**/
	public var dirt_mask_intensity : Dynamic;
	/**
		(LinearColor):  [Read-Write] BloomDirtMask tint color
	**/
	public var dirt_mask_tint : Dynamic;
	/**
