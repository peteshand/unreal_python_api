...
package unreal;
@:pythonImport("unreal", "ARFaceTrackingDirection") extern class ARFaceTrackingDirection {
	static public var FACE_MIRRORED : Dynamic;
	static public var FACE_RELATIVE : Dynamic;
	/**
