...
package unreal;
@:pythonImport("unreal", "SkeletalMeshSocket") extern class SkeletalMeshSocket {
	...
	**/
	public var force_always_animated : Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Args:
		    ...
		    world_normal (Vector):
	**/
	public function initialize_socket_from_location(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public var relative_scale : Dynamic;
	/**
