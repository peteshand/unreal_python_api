...
package unreal;
@:pythonImport("unreal", "FunctionalTestLevelScript") extern class FunctionalTestLevelScript {
	...
	**/
	...
	/**
		...
		document:
	**/
	public function level_reset(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    bool:
	**/
	public function remote_event(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function world_origin_location_changed(args:haxe.extern.Rest<Dynamic>):Dynamic;
}