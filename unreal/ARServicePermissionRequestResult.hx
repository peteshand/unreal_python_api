...
package unreal;
@:pythonImport("unreal", "ARServicePermissionRequestResult") extern class ARServicePermissionRequestResult {
	static public var DENIED : Dynamic;
	static public var GRANTED : Dynamic;
	/**
