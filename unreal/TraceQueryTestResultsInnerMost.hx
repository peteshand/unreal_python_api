...
package unreal;
@:pythonImport("unreal", "TraceQueryTestResultsInnerMost") extern class TraceQueryTestResultsInnerMost {
	/**
		Return self+value.
	**/
