...
@:pythonImport("unreal", "ARPlaneComponent") extern class ARPlaneComponent {
	...
	**/
	public function get_object_classification_debug_colors(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function set_object_classification_debug_colors(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function set_plane_component_debug_mode(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
