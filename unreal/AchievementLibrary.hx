...
package unreal;
@:pythonImport("unreal", "AchievementLibrary") extern class AchievementLibrary {
	...
	**/
	...
	/**
		...
		Returns:
		    ...
		    hidden (bool):
	**/
	static public function get_cached_achievement_description(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Returns:
		    ...
		    progress (float):
	**/
	static public function get_cached_achievement_progress(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
