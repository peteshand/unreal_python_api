	...
	**/
	...
	/**
		...
		Returns:
		    ...
		    hidden (bool):
	**/
	public function get_cached_achievement_description(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Returns:
		    ...
		    progress (float):
	**/
	public function get_cached_achievement_progress(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
