...
package unreal;
@:pythonImport("unreal", "AISenseAffiliationFilter") extern class AISenseAffiliationFilter {
	/**
		Return self+value.
	**/
	...
	**/
	public var detect_enemies : Dynamic;
	/**
		(bool):  [Read-Only] Detect Friendlies
	**/
	public var detect_friendlies : Dynamic;
	/**
		(bool):  [Read-Only] Detect Neutrals
	**/
	public var detect_neutrals : Dynamic;
	/**
