...
package unreal;
@:pythonImport("unreal", "QuartzQuantizationBoundary") extern class QuartzQuantizationBoundary {
	/**
		Return self+value.
	**/
	...
	**/
	public var counting_reference_point : Dynamic;
	/**
	...
	**/
	public var quantization : Dynamic;
	/**
