...
package unreal;
@:pythonImport("unreal", "FieldSystemMetaDataProcessingResolution") extern class FieldSystemMetaDataProcessingResolution {
	...
	**/
	public var resolution_type : Dynamic;
	/**
	...
	**/
	public function set_meta_dataa_processing_resolution_type(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
