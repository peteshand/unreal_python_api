...
package unreal;
@:pythonImport("unreal", "MaterialExpressionFunctionInput") extern class MaterialExpressionFunctionInput {
	...
	**/
	public var preview_value : Dynamic;
	/**
	...
	**/
	public var sort_priority : Dynamic;
	/**
	...
	**/
	public var use_preview_value_as_default : Dynamic;
}