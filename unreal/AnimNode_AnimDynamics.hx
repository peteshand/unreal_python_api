...
package unreal;
@:pythonImport("unreal", "AnimNode_AnimDynamics") extern class AnimNode_AnimDynamics {
	/**
		Return self+value.
	**/
	...
	**/
	public var angular_spring_constant : Dynamic;
	/**
	...
	**/
	public var gravity_override : Dynamic;
	/**
	...
	**/
	public var linear_damping_override : Dynamic;
	/**
	...
	**/
	public var linear_spring_constant : Dynamic;
	/**
	...
	**/
	public var simulation_space : Dynamic;
	/**
	...
	**/
	public var use_gravity_override : Dynamic;
}