...
package unreal;
@:pythonImport("unreal", "SliderStyle") extern class SliderStyle {
	/**
		Return self+value.
	**/
	...
	**/
	public var bar_thickness : Dynamic;
	/**
	...
	**/
	public var hovered_bar_image : Dynamic;
	/**
	...
	**/
	public var normal_bar_image : Dynamic;
	/**
