...
package unreal;
@:pythonImport("unreal", "AIPerceptionStimuliSourceComponent") extern class AIPerceptionStimuliSourceComponent {
	...
	**/
	public var auto_register_as_source : Dynamic;
	/**
	...
	**/
	public var register_as_source_for_senses : Dynamic;
	/**
	...
	**/
	public function register_for_sense(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function register_with_perception_system(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function unregister_from_perception_system(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Args:
		    sense_class (type(Class)):
	**/
	public function unregister_from_sense(args:haxe.extern.Rest<Dynamic>):Dynamic;
}