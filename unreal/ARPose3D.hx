...
package unreal;
@:pythonImport("unreal", "ARPose3D") extern class ARPose3D {
	/**
		Return self+value.
	**/
	...
	**/
	public var skeleton_definition : Dynamic;
	/**
