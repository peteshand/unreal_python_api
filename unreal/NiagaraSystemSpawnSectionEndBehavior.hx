...
package unreal;
@:pythonImport("unreal", "NiagaraSystemSpawnSectionEndBehavior") extern class NiagaraSystemSpawnSectionEndBehavior {
	static public var DEACTIVATE : Dynamic;
	static public var NONE : Dynamic;
	static public var SET_SYSTEM_INACTIVE : Dynamic;
	/**
