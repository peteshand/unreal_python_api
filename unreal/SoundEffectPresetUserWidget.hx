...
package unreal;
@:pythonImport("unreal", "SoundEffectPresetUserWidget") extern class SoundEffectPresetUserWidget {
	...
	**/
	...
	/**
		...
		Args:
		    property_name (Name):
	**/
	public function on_preset_changed(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
