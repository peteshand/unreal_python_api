...
package unreal;
@:pythonImport("unreal", "WidgetCarouselNavigationBarStyle") extern class WidgetCarouselNavigationBarStyle {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		(ButtonStyle):  [Read-Write] Center Button Style
	**/
	public var center_button_style : Dynamic;
	/**
	...
	**/
	...
	/**
		(SlateBrush):  [Read-Write] Highlight Brush
	**/
	public var highlight_brush : Dynamic;
	/**
		(ButtonStyle):  [Read-Write] Left Button Style
	**/
	public var left_button_style : Dynamic;
	/**
		(ButtonStyle):  [Read-Write] Right Button Style
	**/
	public var right_button_style : Dynamic;
	/**
