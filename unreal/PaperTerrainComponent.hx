...
package unreal;
@:pythonImport("unreal", "PaperTerrainComponent") extern class PaperTerrainComponent {
	...
	**/
	public var closed_spline : Dynamic;
	/**
	...
	**/
	public var filled_spline : Dynamic;
	/**
	...
	**/
	public function set_terrain_color(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public var terrain_color : Dynamic;
	/**
	...
	**/
	public var terrain_material : Dynamic;
	/**
