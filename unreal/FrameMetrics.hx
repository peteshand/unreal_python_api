...
package unreal;
@:pythonImport("unreal", "FrameMetrics") extern class FrameMetrics {
	/**
		Return self+value.
	**/
	...
	**/
	public var num_dropped_frames : Dynamic;
	/**
	...
	**/
	public var total_elapsed_time : Dynamic;
}