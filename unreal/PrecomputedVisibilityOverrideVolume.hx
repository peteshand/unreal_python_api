...
package unreal;
@:pythonImport("unreal", "PrecomputedVisibilityOverrideVolume") extern class PrecomputedVisibilityOverrideVolume {
	...
	**/
	public var override_invisible_actors : Dynamic;
	/**
	...
	**/
	public var override_invisible_levels : Dynamic;
	/**
	...
	**/
	public var override_visible_actors : Dynamic;
	/**
