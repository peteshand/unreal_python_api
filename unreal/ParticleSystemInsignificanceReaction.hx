...
package unreal;
@:pythonImport("unreal", "ParticleSystemInsignificanceReaction") extern class ParticleSystemInsignificanceReaction {
	static public var AUTO : Dynamic;
	static public var COMPLETE : Dynamic;
	static public var DISABLE_TICK : Dynamic;
	/**
