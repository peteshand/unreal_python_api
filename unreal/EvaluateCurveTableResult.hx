...
package unreal;
@:pythonImport("unreal", "EvaluateCurveTableResult") extern class EvaluateCurveTableResult {
	static public var ROW_FOUND : Dynamic;
	static public var ROW_NOT_FOUND : Dynamic;
	/**
