...
package unreal;
@:pythonImport("unreal", "EditorValidatorSubsystem") extern class EditorValidatorSubsystem {
	...
	**/
	public function add_validator(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function is_asset_valid(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Returns:
		    ...
		    validation_warnings (Array(Text)):
	**/
	public function is_object_valid(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function validate_assets(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public var validate_on_save : Dynamic;
}