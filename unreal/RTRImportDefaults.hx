...
package unreal;
@:pythonImport("unreal", "RTRImportDefaults") extern class RTRImportDefaults {
	...
	**/
	public function get_static_mesh_component_defaults(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    RTRStaticMeshComponentDefaults:
	**/
	public function static_mesh_component_defaults(args:haxe.extern.Rest<Dynamic>):Dynamic;
}