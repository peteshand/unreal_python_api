...
package unreal;
@:pythonImport("unreal", "MovieSceneVectorTrackExtensions") extern class MovieSceneVectorTrackExtensions {
	...
	**/
	static public function get_num_channels_used(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	static public function set_num_channels_used(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
