...
package unreal;
@:pythonImport("unreal", "PaperSpriteAtlasPadding") extern class PaperSpriteAtlasPadding {
	static public var DILATE_BORDER : Dynamic;
	static public var PAD_WITH_ZERO : Dynamic;
	/**
