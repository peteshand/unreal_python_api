...
package unreal;
@:pythonImport("unreal", "SceneCaptureComponent2D") extern class SceneCaptureComponent2D {
	...
	**/
	public var camera_cut_this_frame : Dynamic;
	/**
	...
	**/
	public var clip_plane_base : Dynamic;
	/**
		(Vector):  [Read-Write] Normal for the plane.
	**/
	public var clip_plane_normal : Dynamic;
	/**
	...
	**/
	public var composite_mode : Dynamic;
	/**
	...
	**/
	public var consider_unrendered_opaque_pixel_as_fully_translucent : Dynamic;
	/**
	...
	**/
	public var custom_near_clipping_plane : Dynamic;
	/**
		(Matrix):  [Read-Write] The custom projection matrix to use
	**/
	public var custom_projection_matrix : Dynamic;
	/**
		x.deactivate() -> None
	...
	**/
	public var disable_flip_copy_gles : Dynamic;
	/**
	...
	**/
	public var enable_clip_plane : Dynamic;
	/**
		(float):  [Read-Write] Camera field of view (in degrees).
	**/
	public var fov_angle : Dynamic;
	/**
	...
	**/
	public var projection_type : Dynamic;
	/**
	...
	**/
	public var use_custom_projection_matrix : Dynamic;
	/**
