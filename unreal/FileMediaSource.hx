...
package unreal;
@:pythonImport("unreal", "FileMediaSource") extern class FileMediaSource {
	...
	**/
	public var precache_file : Dynamic;
	/**
	...
	**/
	public function set_file_path(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
