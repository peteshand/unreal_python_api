...
package unreal;
@:pythonImport("unreal", "TraceQueryTestResultsInner") extern class TraceQueryTestResultsInner {
	/**
		Return self+value.
	**/
	...
	**/
	public var line_results : Dynamic;
	/**
	...
	**/
	public var sphere_results : Dynamic;
	/**
