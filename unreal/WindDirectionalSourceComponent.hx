...
package unreal;
@:pythonImport("unreal", "WindDirectionalSourceComponent") extern class WindDirectionalSourceComponent {
	...
	**/
	public var max_gust_amount : Dynamic;
	/**
		(float):  [Read-Only] Min Gust Amount
	**/
	public var min_gust_amount : Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Args:
		    new_max_gust (float):
	**/
	public function set_maximum_gust_amount(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Args:
		    new_min_gust (float):
	**/
	public function set_minimum_gust_amount(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Args:
		    new_radius (float):
	**/
	public function set_radius(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Args:
		    new_speed (float):
	**/
	public function set_speed(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Args:
		    new_strength (float):
	**/
	public function set_strength(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function set_wind_type(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
