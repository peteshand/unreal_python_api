...
package unreal;
@:pythonImport("unreal", "AudioRecordingExportType") extern class AudioRecordingExportType {
	static public var SOUND_WAVE : Dynamic;
	static public var WAV_FILE : Dynamic;
	/**
