...
package unreal;
@:pythonImport("unreal", "ARQRCodeComponent") extern class ARQRCodeComponent {
	...
	**/
	static public function set_qr_code_component_debug_mode(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
