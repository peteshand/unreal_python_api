...
package unreal;
@:pythonImport("unreal", "VertexAttributesForPolygon") extern class VertexAttributesForPolygon {
	/**
		Return self+value.
	**/
	...
	**/
	public var perimeter_vertex_attribute_lists : Dynamic;
	/**
	...
	**/
	public var vertex_attribute_lists_for_each_hole : Dynamic;
}