...
package unreal;
@:pythonImport("unreal", "PaperTileLayer") extern class PaperTileLayer {
	...
	**/
	public var layer_collides : Dynamic;
	/**
	...
	**/
	public var layer_color : Dynamic;
	/**
	...
	**/
	public var layer_name : Dynamic;
	/**
		(int32):  [Read-Only] Width of the layer (in tiles)
	**/
	public var layer_width : Dynamic;
	/**
	...
	**/
	public var override_collision_offset : Dynamic;
	/**
	...
	**/
	public var override_collision_thickness : Dynamic;
	/**
