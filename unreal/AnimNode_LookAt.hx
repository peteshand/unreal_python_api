...
package unreal;
@:pythonImport("unreal", "AnimNode_LookAt") extern class AnimNode_LookAt {
	/**
		Return self+value.
	**/
	...
	**/
	public var interpolation_time : Dynamic;
	/**
		(float):  [Read-Write] Interpolation Trigger Threashold
	**/
	public var interpolation_trigger_threashold : Dynamic;
	/**
		(InterpolationBlend):  [Read-Write] Interpolation Type
	**/
	public var interpolation_type : Dynamic;
	/**
	...
	**/
	public var look_at_clamp : Dynamic;
	/**
