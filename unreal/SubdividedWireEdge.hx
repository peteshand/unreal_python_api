...
package unreal;
@:pythonImport("unreal", "SubdividedWireEdge") extern class SubdividedWireEdge {
	/**
		Return self+value.
	**/
	...
	**/
	public var edge_vertex0_position_index : Dynamic;
	/**
		(int32):  [Read-Write] Edge Vertex 1Position Index
	**/
	public var edge_vertex1_position_index : Dynamic;
	/**
