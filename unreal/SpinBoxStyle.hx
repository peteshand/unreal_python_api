...
package unreal;
@:pythonImport("unreal", "SpinBoxStyle") extern class SpinBoxStyle {
	/**
		Return self+value.
	**/
	...
	**/
	public var active_fill_brush : Dynamic;
	/**
		(SlateBrush):  [Read-Write] Image used to draw the spinbox arrows
	**/
	public var arrows_image : Dynamic;
	/**
	...
	**/
	public var hovered_background_brush : Dynamic;
	/**
		(SlateBrush):  [Read-Write] Brush used to fill the spinbox when it's inactive
	**/
	public var inactive_fill_brush : Dynamic;
	/**
	...
	**/
	public var text_padding : Dynamic;
	/**
