...
package unreal;
@:pythonImport("unreal", "PhysicalMaterial") extern class PhysicalMaterial {
	...
	**/
	public var destructible_damage_threshold_scale : Dynamic;
	/**
	...
	**/
	public var friction_combine_mode : Dynamic;
	/**
	...
	**/
	public var override_friction_combine_mode : Dynamic;
	/**
	...
	**/
	public var override_restitution_combine_mode : Dynamic;
	/**
	...
	**/
	public var raise_mass_to_power : Dynamic;
	/**
