...
@:pythonImport("unreal", "VirtualTextureBuilderExporterBMP") extern class VirtualTextureBuilderExporterBMP {
	...
	**/
	public function run_asset_export_task(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function run_asset_export_tasks(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
