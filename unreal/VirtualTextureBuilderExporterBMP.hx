...
package unreal;
@:pythonImport("unreal", "VirtualTextureBuilderExporterBMP") extern class VirtualTextureBuilderExporterBMP {
	...
	**/
	static public function run_asset_export_task(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	static public function run_asset_export_tasks(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function script_run_asset_export_task(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
