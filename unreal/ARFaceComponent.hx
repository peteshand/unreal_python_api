...
package unreal;
@:pythonImport("unreal", "ARFaceComponent") extern class ARFaceComponent {
	...
	**/
	public var face_out_of_screen : Dynamic;
	/**
	...
	**/
	static public function set_face_component_debug_mode(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
