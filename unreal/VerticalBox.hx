...
package unreal;
@:pythonImport("unreal", "VerticalBox") extern class VerticalBox {
	...
	**/
	...
	/**
		...
		Returns:
		    VerticalBoxSlot:
	**/
	public function add_child_to_vertical_box(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		deprecated: 'add_child_vertical_box' was renamed to 'add_child_to_vertical_box'.
	**/
	public function add_child_vertical_box(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
