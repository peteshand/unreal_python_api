...
package unreal;
@:pythonImport("unreal", "MovieSceneVectorTrack") extern class MovieSceneVectorTrack {
	...
	**/
	public function get_num_channels_used(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function set_num_channels_used(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
