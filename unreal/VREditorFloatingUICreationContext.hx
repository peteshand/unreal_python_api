...
package unreal;
@:pythonImport("unreal", "VREditorFloatingUICreationContext") extern class VREditorFloatingUICreationContext {
	/**
		Return self+value.
	**/
	...
	**/
	public var editor_ui_size : Dynamic;
	/**
	...
	**/
	public var panel_spawn_offset : Dynamic;
	/**
		(Actor):  [Read-Write] Parent Actor
	**/
	public var parent_actor : Dynamic;
	/**
