...
package unreal;
@:pythonImport("unreal", "SubUVBoundingVertexCount") extern class SubUVBoundingVertexCount {
	static public var BVC_EIGHT_VERTICES : Dynamic;
	static public var BVC_FOUR_VERTICES : Dynamic;
	/**
