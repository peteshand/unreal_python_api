...
package unreal;
@:pythonImport("unreal", "MaterialImportHelpers") extern class MaterialImportHelpers {
	...
	**/
	...
	/**
		...
		Returns:
		    ...
		    out_error (Text):
	**/
	static public function find_existing_material(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		Returns:
		    ...
		    out_error (Text):
	**/
	static public function find_existing_material_from_search_location(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
