...
@:pythonImport("unreal", "MovieSceneBindingExtensions") extern class MovieSceneBindingExtensions extends unreal.BlueprintFunctionLibrary {
	...
	**/
	static public function add_track(binding:Dynamic, track_type:Dynamic):unreal.MovieSceneTrack;
	/**
	...
	**/
	static public function find_tracks_by_exact_type(binding:Dynamic, track_type:Dynamic):Dynamic;
	/**
	...
	**/
	static public function find_tracks_by_type(binding:Dynamic, track_type:Dynamic):Dynamic;
	/**
	...
	**/
	static public function get_child_possessables(binding:Dynamic):Dynamic;
	/**
	...
	**/
	static public function get_display_name(binding:Dynamic):unreal.Text;
	/**
	...
	**/
	static public function get_id(binding:Dynamic):unreal.Guid;
	/**
	...
	**/
	static public function get_object_template(binding:Dynamic):unreal.Object;
	/**
	...
	**/
	static public function get_parent(binding:Dynamic):unreal.SequencerBindingProxy;
	/**
	...
	**/
	static public function get_possessed_object_class(binding:Dynamic):Dynamic;
	/**
	...
	**/
	static public function get_tracks(binding:Dynamic):Dynamic;
	/**
		...
		Returns:
		    bool:
	**/
	static public function is_valid(binding:Dynamic):Bool;
	/**
	...
	**/
	static public function move_binding_contents(source_binding_id:Dynamic, destination_binding_id:Dynamic):Void;
	/**
	...
	**/
	static public function remove(binding:Dynamic):Void;
	/**
	...
	**/
	static public function remove_track(binding:Dynamic, track_to_remove:Dynamic):Void;
	/**
		...
		Args:
		    ...
		    display_name (Text):
	**/
	static public function set_display_name(binding:Dynamic, display_name:Dynamic):Void;
	/**
	...
	**/
	static public function set_name(binding:Dynamic, name:Dynamic):Void;
	/**
	...
	**/
	static public function set_parent(binding:Dynamic, parent_binding:Dynamic):Void;
}