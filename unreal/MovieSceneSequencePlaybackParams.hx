...
package unreal;
@:pythonImport("unreal", "MovieSceneSequencePlaybackParams") extern class MovieSceneSequencePlaybackParams {
	/**
		Return self+value.
	**/
	...
	**/
	public var marked_frame : Dynamic;
	/**
		(MovieScenePositionType):  [Read-Write] Position Type
	**/
	public var position_type : Dynamic;
	/**
	...
	**/
	public var update_method : Dynamic;
}