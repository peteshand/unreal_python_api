...
package unreal;
@:pythonImport("unreal", "SoundWaveFFTSize") extern class SoundWaveFFTSize {
	static public var LARGE_1024 : Dynamic;
	static public var MEDIUM_512 : Dynamic;
	static public var SMALL_256 : Dynamic;
	static public var VERY_LARGE_2048 : Dynamic;
	static public var VERY_SMALL_64 : Dynamic;
	/**
