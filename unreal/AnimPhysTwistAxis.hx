...
package unreal;
@:pythonImport("unreal", "AnimPhysTwistAxis") extern class AnimPhysTwistAxis {
	static public var AXIS_X : Dynamic;
	static public var AXIS_Y : Dynamic;
	static public var AXIS_Z : Dynamic;
	/**
