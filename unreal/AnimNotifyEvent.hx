...
package unreal;
@:pythonImport("unreal", "AnimNotifyEvent") extern class AnimNotifyEvent {
	/**
		Return self+value.
	**/
	...
	**/
	public var montage_tick_type : Dynamic;
	/**
	...
	**/
	public var notify_filter_lod : Dynamic;
	/**
	...
	**/
	public var notify_filter_type : Dynamic;
	/**
	...
	**/
	public var trigger_on_dedicated_server : Dynamic;
	/**
	...
	**/
	public var trigger_on_follower : Dynamic;
	/**
		(float):  [Read-Write] Trigger Weight Threshold
	**/
	public var trigger_weight_threshold : Dynamic;
}