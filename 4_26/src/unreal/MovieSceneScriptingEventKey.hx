...
package unreal;
@:pythonImport("unreal", "MovieSceneScriptingEventKey") extern class MovieSceneScriptingEventKey extends unreal.MovieSceneScriptingKey {
	/**
	...
	**/
	public function get_value():unreal.MovieSceneEvent;
	/**
	...
	**/
	public function set_value(new_value:unreal.MovieSceneEvent):Void;
}