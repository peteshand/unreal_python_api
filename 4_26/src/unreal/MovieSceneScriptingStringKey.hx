...
package unreal;
@:pythonImport("unreal", "MovieSceneScriptingStringKey") extern class MovieSceneScriptingStringKey extends unreal.MovieSceneScriptingKey {
	/**
	...
	**/
	public function set_value(new_value:String):Void;
}