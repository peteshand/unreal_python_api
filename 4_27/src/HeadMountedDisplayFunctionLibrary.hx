...
@:pythonImport("unreal", "HeadMountedDisplayFunctionLibrary") extern class HeadMountedDisplayFunctionLibrary extends unreal.BlueprintFunctionLibrary {
	...
	**/
	...
	/**
		X.get_play_area_bounds(origin=HMDTrackingOrigin.STAGE) -> Vector2D
		...
		Returns:
		    Vector2D:
	**/
	static public function get_play_area_bounds(?origin:unreal.HMDTrackingOrigin):unreal.Vector2D;
	/**
