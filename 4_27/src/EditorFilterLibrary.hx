...
@:pythonImport("unreal", "EditorFilterLibrary") extern class EditorFilterLibrary extends unreal.BlueprintFunctionLibrary {
	...
	**/
	static public function by_actor_label(target_array:Array<Actor>, name_sub_string:String, ?string_match:unreal.EditorScriptingStringMatchType, ?filter_type:unreal.EditorScriptingFilterType, ignore_case:Bool = true):Array<Actor>;
	/**
		...
		Returns:
		    Array(Actor): The filtered list.
	**/
	static public function by_actor_tag(target_array:Array<Actor>, tag:unreal.Name, ?filter_type:unreal.EditorScriptingFilterType):Array<Actor>;
	/**
	...
	**/
	static public function by_class(target_array:Array<Object>, object_class:Dynamic, ?filter_type:unreal.EditorScriptingFilterType):Array<Object>;
	/**
		...
		Returns:
		    Array(Object): The filtered list.
	**/
	static public function by_id_name(target_array:Array<Object>, name_sub_string:String, ?string_match:unreal.EditorScriptingStringMatchType, ?filter_type:unreal.EditorScriptingFilterType):Array<Object>;
	/**
		...
		Returns:
		    Array(Actor): The filtered list.
	**/
	static public function by_layer(target_array:Array<Actor>, layer_name:unreal.Name, ?filter_type:unreal.EditorScriptingFilterType):Array<Actor>;
	/**
		...
		Returns:
		    Array(Actor): The filtered list.
	**/
	static public function by_level_name(target_array:Array<Actor>, level_name:unreal.Name, ?filter_type:unreal.EditorScriptingFilterType):Array<Actor>;
	/**
		...
		Returns:
		    Array(Actor): The filtered list.
	**/
	static public function by_selection(target_array:Array<Actor>, ?filter_type:unreal.EditorScriptingFilterType):Array<Actor>;
}