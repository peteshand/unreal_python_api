...
@:pythonImport("unreal", "Actor") extern class Actor extends unreal.Object {
	...
	**/
	...
	/**
		...
		Returns:
		    float:
	**/
	public function get_squared_horizontal_distance_to(other_actor:unreal.Actor):Float;
	/**
	...
	**/
	public function make_noise(loudness:Float = 1.000000, ?noise_instigator:unreal.Pawn, ?noise_location:unreal.Vector, max_range:Float = 0.000000, ?tag:unreal.Name):Void;
	/**
