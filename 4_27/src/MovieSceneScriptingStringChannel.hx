...
@:pythonImport("unreal", "MovieSceneScriptingStringChannel") extern class MovieSceneScriptingStringChannel extends unreal.MovieSceneScriptingChannel {
	...
	**/
	public function add_key(time:unreal.FrameNumber, new_value:String, sub_frame:Float = 0.000000, ?time_unit:unreal.SequenceTimeUnit):unreal.MovieSceneScriptingStringKey;
	/**
		x.get_default() -> str
	...
	**/
	...
	/**
		...
		Args:
		    default_value (str):
	**/
	public function set_default(default_value:String):Void;
}