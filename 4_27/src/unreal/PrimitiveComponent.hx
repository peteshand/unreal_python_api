...
@:pythonImport("unreal", "PrimitiveComponent") extern class PrimitiveComponent extends unreal.SceneComponent {
	...
	**/
	public var hidden_in_scene_capture : Bool;
	/**
	...
	**/
	public function set_cast_hidden_shadow(new_cast_hidden_shadow:Bool):Void;
	/**
	...
	**/
	...
	/**
		...
		Args:
		    value (bool):
	**/
	public function set_hidden_in_scene_capture(value:Bool):Void;
	/**
	...
	**/
	public function set_material(element_index:Int, material:unreal.MaterialInterface):Void;
	/**
		...
		Args:
		    ...
		    material (MaterialInterface):
	**/
	public function set_material_by_name(material_slot_name:unreal.Name, material:unreal.MaterialInterface):Void;
	/**
	...
	**/
	public function set_translucency_sort_distance_offset(new_translucency_sort_distance_offset:Float):Void;
	/**
	...
	**/
	...
	/**
		...
		Args:
		    value (bool):
	**/
	public function set_visible_in_scene_capture_only(value:Bool):Void;
	/**
	...
	**/
	public var translucency_sort_distance_offset : Float;
	/**
	...
	**/
	public var visible_in_scene_capture_only : Bool;
	/**
