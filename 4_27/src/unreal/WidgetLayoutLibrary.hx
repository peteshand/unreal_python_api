...
@:pythonImport("unreal", "WidgetLayoutLibrary") extern class WidgetLayoutLibrary extends unreal.BlueprintFunctionLibrary {
	...
	**/
	...
	/**
		...
		Returns:
		    Vector2D:
	**/
	static public function get_mouse_position_on_viewport(world_context_object:unreal.Object):unreal.Vector2D;
	/**
		...
		Returns:
		    ...
		    location_y (float):
	**/
	static public function get_mouse_position_scaled_by_dpi(player:unreal.PlayerController):Dynamic;
	/**
		...
		Returns:
		    Geometry:
	**/
	static public function get_player_screen_widget_geometry(player_controller:unreal.PlayerController):unreal.Geometry;
	/**
		...
		Returns:
		    float:
	**/
	static public function get_viewport_scale(world_context_object:unreal.Object):Float;
	/**
		...
		Returns:
		    Vector2D:
	**/
	static public function get_viewport_size(world_context_object:unreal.Object):unreal.Vector2D;
	/**
		...
		Returns:
		    Geometry:
	**/
	static public function get_viewport_widget_geometry(world_context_object:unreal.Object):unreal.Geometry;
	/**
	...
	**/
	static public function project_world_location_to_widget_position(player_controller:unreal.PlayerController, world_location:unreal.Vector, player_viewport_relative:Bool):Dynamic;
	/**
		...
		Args:
		    world_context_object (Object):
	**/
	static public function remove_all_widgets(world_context_object:unreal.Object):Void;
	/**
		...
		Returns:
		    BorderSlot:
	**/
	static public function slot_as_border_slot(widget:unreal.Widget):unreal.BorderSlot;
	/**
		...
		Returns:
		    CanvasPanelSlot:
	**/
	static public function slot_as_canvas_slot(widget:unreal.Widget):unreal.CanvasPanelSlot;
	/**
		...
		Returns:
		    GridSlot:
	**/
	static public function slot_as_grid_slot(widget:unreal.Widget):unreal.GridSlot;
	/**
		...
		Returns:
		    HorizontalBoxSlot:
	**/
	static public function slot_as_horizontal_box_slot(widget:unreal.Widget):unreal.HorizontalBoxSlot;
	/**
		...
		Returns:
		    OverlaySlot:
	**/
	static public function slot_as_overlay_slot(widget:unreal.Widget):unreal.OverlaySlot;
	/**
		...
		Returns:
		    SafeZoneSlot:
	**/
	static public function slot_as_safe_box_slot(widget:unreal.Widget):unreal.SafeZoneSlot;
	/**
		...
		Returns:
		    ScaleBoxSlot:
	**/
	static public function slot_as_scale_box_slot(widget:unreal.Widget):unreal.ScaleBoxSlot;
	/**
		...
		Returns:
		    ScrollBoxSlot:
	**/
	static public function slot_as_scroll_box_slot(widget:unreal.Widget):unreal.ScrollBoxSlot;
	/**
		...
		Returns:
		    SizeBoxSlot:
	**/
	static public function slot_as_size_box_slot(widget:unreal.Widget):unreal.SizeBoxSlot;
	/**
		...
		Returns:
		    UniformGridSlot:
	**/
	static public function slot_as_uniform_grid_slot(widget:unreal.Widget):unreal.UniformGridSlot;
	/**
		...
		Returns:
		    VerticalBoxSlot:
	**/
	static public function slot_as_vertical_box_slot(widget:unreal.Widget):unreal.VerticalBoxSlot;
	/**
		...
		Returns:
		    WidgetSwitcherSlot:
	**/
	static public function slot_as_widget_switcher_slot(widget:unreal.Widget):unreal.WidgetSwitcherSlot;
	/**
		...
		Returns:
		    WrapBoxSlot:
	**/
	static public function slot_as_wrap_box_slot(widget:unreal.Widget):unreal.WrapBoxSlot;
}