...
@:pythonImport("unreal", "SoundSubmix") extern class SoundSubmix extends unreal.SoundSubmixWithParentBase {
	...
	**/
	...
	/**
		(SoundModulationDestinationSettings):  [Read-Write] Modulation to apply to the submix Dry Level (in dB)
	**/
	public var dry_level_modulation : unreal.SoundModulationDestinationSettings;
	/**
	...
	**/
	...
	/**
		(SoundModulationDestinationSettings):  [Read-Write] Modulation to apply to the submix Output Volume (in dB)
	**/
	public var output_volume_modulation : unreal.SoundModulationDestinationSettings;
	/**
	...
	**/
	...
	/**
		(SoundModulationDestinationSettings):  [Read-Write] Modulation to apply to the submix Wet Level (in dB)
	**/
	public var wet_level_modulation : unreal.SoundModulationDestinationSettings;
}