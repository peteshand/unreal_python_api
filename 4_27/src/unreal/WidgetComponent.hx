...
@:pythonImport("unreal", "WidgetComponent") extern class WidgetComponent extends unreal.MeshComponent {
	...
	**/
	public function request_render_update():Void;
	/**
	...
	**/
	public function set_background_color(new_background_color:unreal.LinearColor):Void;
	/**
	...
	**/
	public function set_cylinder_arc_angle(cylinder_arc_angle:Float):Void;
	/**
	...
	**/
	public function set_draw_at_desired_size(draw_at_desired_size:Bool):Void;
	/**
		...
		Args:
		    size (Vector2D):
	**/
	public function set_draw_size(size:unreal.Vector2D):Void;
	/**
	...
	**/
	public function set_geometry_mode(geometry_mode:unreal.WidgetGeometryMode):Void;
	/**
	...
	**/
	public function set_manually_redraw(use_manual_redraw:Bool):Void;
	/**
	...
	**/
	public function set_owner_player(local_player:unreal.LocalPlayer):Void;
	/**
		...
		Args:
		    pivot (Vector2D):
	**/
	public function set_pivot(pivot:unreal.Vector2D):Void;
	/**
		...
		Args:
		    redraw_time (float):
	**/
	public function set_redraw_time(redraw_time:Float):Void;
	/**
		...
		Args:
		    tick_mode (TickMode):
	**/
	public function set_tick_mode(tick_mode:unreal.TickMode):Void;
	/**
	...
	**/
	public function set_tick_when_offscreen(want_tick_when_offscreen:Bool):Void;
	/**
	...
	**/
	public function set_tint_color_and_opacity(new_tint_color_and_opacity:unreal.LinearColor):Void;
	/**
		...
		Args:
		    want_two_sided (bool):
	**/
	public function set_two_sided(want_two_sided:Bool):Void;
	/**
		...
		Args:
		    widget (UserWidget):
	**/
	public function set_widget(widget:unreal.UserWidget):Void;
	/**
	...
	**/
	public function set_widget_space(new_space:unreal.WidgetSpace):Void;
	/**
	...
	**/
	public function set_window_focusable(window_focusable:Bool):Void;
	/**
	...
	**/
	public function set_window_visibility(visibility:unreal.WindowVisibility):Void;
}