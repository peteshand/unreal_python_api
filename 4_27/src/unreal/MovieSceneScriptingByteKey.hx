...
package unreal;
@:pythonImport("unreal", "MovieSceneScriptingByteKey") extern class MovieSceneScriptingByteKey extends unreal.MovieSceneScriptingKey {
	/**
	...
	**/
	public function set_value(new_value:UInt):Void;
}