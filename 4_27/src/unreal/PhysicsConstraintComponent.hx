...
@:pythonImport("unreal", "PhysicsConstraintComponent") extern class PhysicsConstraintComponent extends unreal.SceneComponent {
	...
	**/
	public function set_angular_plasticity(angular_plasticity:Bool, angular_plasticity_threshold:Float):Void;
	/**
	...
	**/
	...
	/**
		x.set_linear_plasticity(linear_plasticity, linear_plasticity_threshold) -> None
	...
	**/
	public function set_linear_plasticity(linear_plasticity:Bool, linear_plasticity_threshold:Float):Void;
	/**
