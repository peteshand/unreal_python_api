...
package unreal;
@:pythonImport("unreal", "MovieSceneScriptingObjectPathChannel") extern class MovieSceneScriptingObjectPathChannel extends unreal.MovieSceneScriptingChannel {
	/**
	...
	**/
	public function add_key(time:unreal.FrameNumber, new_value:unreal.Object, sub_frame:Float = 0.000000, ?time_unit:unreal.SequenceTimeUnit):unreal.MovieSceneScriptingObjectPathKey;
	/**
		...
		Returns:
		    Object:
	**/
	public function get_default():unreal.Object;
	/**
	...
	**/
	public function set_default(default_value:unreal.Object):Void;
}