...
@:pythonImport("unreal", "ScaleBox") extern class ScaleBox extends unreal.ContentWidget {
	...
	**/
	public function set_ignore_inherited_scale(ignore_inherited_scale:Bool):Void;
	/**
		...
		Args:
		    stretch (Stretch):
	**/
	public function set_stretch(stretch:unreal.Stretch):Void;
	/**
	...
	**/
	public function set_stretch_direction(stretch_direction:unreal.StretchDirection):Void;
	/**
	...
	**/
	public function set_user_specified_scale(user_specified_scale:Float):Void;
	/**
