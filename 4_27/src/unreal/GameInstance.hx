...
@:pythonImport("unreal", "GameInstance") extern class GameInstance extends unreal.Object {
	...
	**/
	...
	/**
		...
		Args:
		    ...
		    is_server (bool):
	**/
	public function handle_network_error(failure_type:unreal.NetworkFailure, is_server:Bool):Void;
	/**
	...
	**/
	public function handle_travel_error(failure_type:unreal.TravelFailure):Void;
	/**
