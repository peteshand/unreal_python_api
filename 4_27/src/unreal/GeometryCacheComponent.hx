...
@:pythonImport("unreal", "GeometryCacheComponent") extern class GeometryCacheComponent extends unreal.MeshComponent {
	...
	**/
	...
	/**
		...
		Returns:
		    float:
	**/
	public function get_motion_vector_scale():Float;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    bool:
	**/
	public function is_extrapolating_frames():Bool;
	/**
		x.is_looping() -> bool
	...
	**/
	public var motion_vector_scale : Float;
	/**
		x.pause() -> None
	...
	**/
	public function set_extrapolate_frames(new_extrapolating:Bool):Void;
	/**
	...
	**/
	public function set_motion_vector_scale(new_motion_vector_scale:Float):Void;
	/**
