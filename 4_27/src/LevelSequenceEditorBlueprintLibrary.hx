...
@:pythonImport("unreal", "LevelSequenceEditorBlueprintLibrary") extern class LevelSequenceEditorBlueprintLibrary extends unreal.BlueprintFunctionLibrary {
	...
	**/
	...
	/**
		...
		Returns:
		    int32:
	**/
	static public function get_current_local_time():Int;
	/**
	...
	/**
		...
		* Get the currently focused/viewed level sequence asset if there is a hierarchy of sequences.
		...
		Returns:
		    LevelSequence:
	**/
	static public function get_focused_level_sequence():unreal.LevelSequence;
	/**
	...
	**/
	static public function play_to(playback_params:unreal.MovieSceneSequencePlaybackParams):Void;
	/**
	...
	**/
	...
	/**
		...
		Args:
		    new_frame (int32):
	**/
	static public function set_current_local_time(new_frame:Int):Void;
	/**
