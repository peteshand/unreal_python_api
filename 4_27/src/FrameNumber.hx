	...
	**/
	...
	/**
		...
		Returns:
		    FrameNumber:
	**/
	public function add_frame_number_frame_number(b:unreal.FrameNumber):unreal.FrameNumber;
	/**
		...
		Returns:
		    FrameNumber:
	**/
	public function add_frame_number_integer(b:Int):unreal.FrameNumber;
	/**
		...
		Returns:
		    FrameNumber:
	**/
	public function divide_frame_number_integer(b:Int):unreal.FrameNumber;
	/**
		...
		Returns:
		    FrameNumber:
	**/
	public function multiply_frame_number_integer(b:Int):unreal.FrameNumber;
	/**
		...
		Returns:
		    FrameNumber:
	**/
	public function subtract_frame_number_frame_number(b:unreal.FrameNumber):unreal.FrameNumber;
	/**
		...
		Returns:
		    FrameNumber:
	**/
	public function subtract_frame_number_integer(b:Int):unreal.FrameNumber;
	/**
