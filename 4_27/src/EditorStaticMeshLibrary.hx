...
@:pythonImport("unreal", "EditorStaticMeshLibrary") extern class EditorStaticMeshLibrary extends unreal.BlueprintFunctionLibrary {
	...
	**/
	static public function get_lod_material_slot(static_mesh:unreal.StaticMesh, lod_index:Int, section_index:Int):Int;
	/**
	...
	**/
	...
	/**
		...
		Args:
		    ...
		    section_index (int32): Index of the StaticMesh Section.
	**/
	static public function set_lod_material_slot(static_mesh:unreal.StaticMesh, material_slot_index:Int, lod_index:Int, section_index:Int):Void;
	/**
