...
@:pythonImport("unreal", "SceneCaptureComponent") extern class SceneCaptureComponent extends unreal.SceneComponent {
	...
	**/
	public function hide_component(component:unreal.PrimitiveComponent):Void;
	/**
	...
	**/
	...
	/**
		...
		Args:
		    component (PrimitiveComponent):
	**/
	public function remove_show_only_component(component:unreal.PrimitiveComponent):Void;
	/**
	...
	**/
	public function set_capture_sort_priority(new_capture_sort_priority:Int):Void;
	/**
	...
	**/
	...
	/**
		...
		Args:
		    component (PrimitiveComponent):
	**/
	public function show_only_component(component:unreal.PrimitiveComponent):Void;
	/**
