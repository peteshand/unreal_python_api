...
@:pythonImport("unreal", "MovieSceneSequence") extern class MovieSceneSequence extends unreal.MovieSceneSignedObject {
	...
	**/
	public function add_marked_frame(marked_frame:unreal.MovieSceneMarkedFrame):Int;
	/**
	...
	**/
	public function add_possessable(object_to_possess:unreal.Object):unreal.SequencerBindingProxy;
	/**
	...
	**/
	public function add_root_folder_to_sequence(new_folder_name:String):unreal.MovieSceneFolder;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    SequencerBindingProxy: A unique identifier for the new binding
	**/
	public function add_spawnable_from_instance(object_to_spawn:unreal.Object):unreal.SequencerBindingProxy;
	/**
		...
		*
		...
		Args:
		    delete_index (int32):
	**/
	public function delete_marked_frame(delete_index:Int):Void;
	/**
	...
	**/
	public function find_binding_by_id(binding_id:unreal.Guid):unreal.SequencerBindingProxy;
	/**
		...
		Returns:
		    SequencerBindingProxy: A unique identifier for the binding, or invalid
	**/
	public function find_binding_by_name(name:String):unreal.SequencerBindingProxy;
	/**
	...
	/**
		...
		*
		...
		Returns:
		    int32:
	**/
	public function find_marked_frame_by_frame_number(frame_number:unreal.FrameNumber):Int;
	/**
		...
		*
		...
		Returns:
		    int32:
	**/
	public function find_marked_frame_by_label(label:String):Int;
	/**
	...
	**/
	public function find_master_tracks_by_exact_type(track_type:Dynamic):Array<MovieSceneTrack>;
	/**
	...
	**/
	public function find_master_tracks_by_type(track_type:Dynamic):Array<MovieSceneTrack>;
	/**
		...
		*
		...
		Returns:
		    int32:
	**/
	public function find_next_marked_frame(frame_number:unreal.FrameNumber, forward:Bool):Int;
	/**
	...
	**/
	public function get_bindings():Array<SequencerBindingProxy>;
	/**
	...
	**/
	public function get_marked_frames():Array<MovieSceneMarkedFrame>;
	/**
	...
	**/
	public function get_master_tracks():Array<MovieSceneTrack>;
	/**
	...
	**/
	public function get_portable_binding_id(destination_sequence:unreal.MovieSceneSequence, binding:unreal.SequencerBindingProxy):unreal.MovieSceneObjectBindingID;
	/**
	...
	**/
	public function get_possessables():Array<SequencerBindingProxy>;
	/**
	...
	**/
	public function get_root_folders_in_sequence():Array<MovieSceneFolder>;
	/**
	...
	**/
	public function get_spawnables():Array<SequencerBindingProxy>;
	/**
	...
	**/
	public function locate_bound_objects(binding:unreal.SequencerBindingProxy, context:unreal.Object):Array<Object>;
	/**
	...
	**/
	@:deprecated
	public function make_binding_id(binding:unreal.SequencerBindingProxy, ?space:unreal.MovieSceneObjectBindingSpace):unreal.MovieSceneObjectBindingID;
	/**
	...
	**/
	public function make_range(start_frame:Int, duration:Int):unreal.SequencerScriptingRange;
	/**
		...
		Returns:
		    SequencerScriptingRange: Specified sequencer range
	**/
	public function make_range_seconds(start_time:Float, duration:Float):unreal.SequencerScriptingRange;
	/**
	...
	**/
	public function remove_master_track(master_track:unreal.MovieSceneTrack):Bool;
	/**
	...
	**/
	public function resolve_binding_id(object_binding_id:unreal.MovieSceneObjectBindingID):unreal.SequencerBindingProxy;
	/**
	...
	**/
	public function set_clock_source(clock_source:unreal.UpdateClockSource):Void;
	/**
	...
	**/
	public function set_display_rate(display_rate:unreal.FrameRate):Void;
	/**
	...
	**/
	public function set_evaluation_type(evaluation_type:unreal.MovieSceneEvaluationType):Void;
	/**
		...
		*
		...
		Args:
		    ...
		    frame_number (FrameNumber):
	**/
	public function set_marked_frame(mark_index:Int, frame_number:unreal.FrameNumber):Void;
	/**
	...
	**/
	public function set_playback_end(end_frame:Int):Void;
	/**
	...
	**/
	public function set_playback_end_seconds(end_time:Float):Void;
	/**
	...
	**/
	public function set_playback_start(start_frame:Int):Void;
	/**
	...
	**/
	public function set_playback_start_seconds(start_time:Float):Void;
	/**
	...
	**/
	public function set_tick_resolution(tick_resolution:unreal.FrameRate):Void;
	/**
		...
		Args:
		    tick_resolution (FrameRate): The tick resolution of the sequence, defining the smallest unit of time representable on this sequence
	**/
	public function set_tick_resolution_directly(tick_resolution:unreal.FrameRate):Void;
	/**
	...
	**/
	public function set_view_range_end(end_time_in_seconds:Float):Void;
	/**
	...
	**/
	public function set_view_range_start(start_time_in_seconds:Float):Void;
	/**
		...
		Args:
		    end_time_in_seconds (float):
	**/
	public function set_work_range_end(end_time_in_seconds:Float):Void;
	/**
	...
	**/
	public function set_work_range_start(start_time_in_seconds:Float):Void;
	/**
