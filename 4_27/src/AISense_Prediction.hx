...
@:pythonImport("unreal", "AISense_Prediction") extern class AISense_Prediction extends unreal.AISense {
	...
	**/
	static public function request_controller_prediction_event(requestor:unreal.AIController, predicted_actor:unreal.Actor, prediction_time:Float):Void;
	/**
		...
		Args:
		    ...
		    prediction_time (float):
	**/
	static public function request_pawn_prediction_event(requestor:unreal.Pawn, predicted_actor:unreal.Actor, prediction_time:Float):Void;
}