...
@:pythonImport("unreal", "VolumetricCloudComponent") extern class VolumetricCloudComponent extends unreal.SceneComponent {
	...
	**/
	...
	/**
		...
		Args:
		    new_value (float):
	**/
	public function set_stop_tracing_transmittance_threshold(new_value:Float):Void;
	/**
	...
	**/
	...
	/**
		(float):  [Read-Only] When the mean transmittance is below this threashold, we stop tracing. This is an good way to reduce the ray marched sample count, and thus to increase performance.
	**/
	public var stop_tracing_transmittance_threshold : Float;
	/**
