...
package unreal;
@:pythonImport("unreal", "MovieSceneScriptingBoolKey") extern class MovieSceneScriptingBoolKey extends unreal.MovieSceneScriptingKey {
	/**
	...
	**/
	public function set_value(new_value:Bool):Void;
}