...
@:pythonImport("unreal", "AudioMixerLibrary") extern class AudioMixerLibrary extends unreal.BlueprintFunctionLibrary {
	...
	**/
	...
	/**
		...
		Args:
		    ...
		    submix_effect_preset (SoundEffectSubmixPreset):
	**/
	static public function remove_submix_effect(world_context_object:unreal.Object, sound_submix:unreal.SoundSubmix, submix_effect_preset:unreal.SoundEffectSubmixPreset):Void;
	/**
	...
	**/
	static public function remove_submix_effect_at_index(world_context_object:unreal.Object, sound_submix:unreal.SoundSubmix, submix_chain_index:Int):Void;
	/**
	...
	**/
	...
	/**
		...
		Args:
		    ...
		    submix_effect_preset (SoundEffectSubmixPreset):
	**/
	static public function replace_submix_effect(world_context_object:unreal.Object, sound_submix:unreal.SoundSubmix, submix_chain_index:Int, submix_effect_preset:unreal.SoundEffectSubmixPreset):Void;
	/**
